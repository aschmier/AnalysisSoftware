...
then
    ...
    ##################   Data   #############################
    ##### new Trains v6  with recalib and MBW
    ...
    ### Photon QA
    ### LHC16 Data 938
    bash DownScript.sh 1181 -Name_LHC16Data_PhotonQA3 GA_pp_AOD ?_AnalysisResults -onlyrunwise -childsareperiods  -RL_listDPGIncTPC -RL_listDPGIncTPC -totalLog $1
    ### LHC17 Data 939
    ...
    ### LHC16 MC
    bash DownScript.sh 2139 2144 2145 -Name_LHC16MC_v6 GA_pp_MC_AOD ?_GammaConvCalo_204 -mergechilds -mergetrains -childsareperiods  -RL_listPCMEDC -totalLog $1
    ### LHC17 MC

...
void Grid_CopyFiles_Runwise_MCAOD_anch18_LowB(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString TrainTag;
    TString TrainStart;
    TString AODString="/AOD213";
    if (TrainNumberChoice == 13){
        TrainNumber=Form("2746");
        TrainTag=Form("20200515");
        TrainStart=Form("20200515-2136");
    } else if (TrainNumberChoice == 16){
        TrainNumber=Form("2789");
    ...
    TString DataSets[nSets]={
        "FILTER_p-p_213_LHC18h1_cent_woSDD",
        "FILTER_p-p_213_LHC18h1_fast",
        "FILTER_p-p_213_LHC18h1_cent",
        "FILTER_p-p_213_LHC18h1_cent_woSDD_extra",
        "FILTER_p-p_213_LHC18h1_fast_extra"
    };
    ...
    TString PrefixDataSets[nSets]={
        "/alice/sim/2018/LHC18h1_cent_woSDD/",
        "/alice/sim/2018/LHC18h1_fast/",
        "/alice/sim/2018/LHC18h1_cent/",
        "/alice/sim/2018/LHC18h1_cent_woSDD_extra/",
        "/alice/sim/2018/LHC18h1_fast_extra/"
    };

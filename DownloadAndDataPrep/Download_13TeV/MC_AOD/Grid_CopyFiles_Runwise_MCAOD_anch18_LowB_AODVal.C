...
void Grid_CopyFiles_Runwise_MCAOD_anch18_LowB_AODVal(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    if (TrainNumberChoice == 14){
        TrainNumber=Form("2743");
        TrainTag=Form("20200511");
        TrainStart=Form("20200511-2137");
        AODString="/AOD237";
    } else if (TrainNumberChoice == 16){
        TrainNumber=Form("2790");
    ...
    TString DataSets[nSets]={
        "FILTER_p-p_237_LHC18h1_cent_woSDD",
        "FILTER_p-p_237_LHC18h1_fast",
        "FILTER_p-p_237_LHC18h1_cent"
    };

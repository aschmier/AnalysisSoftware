...
void Grid_CopyFiles_Runwise_MCAOD_anch17_LowB(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString DataSets[nSets]={
        "FILTER_p-p_213_LHC17h3"
    };
    TString DataSetsFolder[nSets]={
        "FILTER_p-p_213_LHC17h3"
    };
    TString PrefixDataSets[nSets]={
        "/alice/sim/2017/LHC17h3/"
    };
    TString SuffixDataSets[nSets]={
        Form("%s/PWGGA/GA_pp_MC_AOD/%s_%s/", AODString.Data(), TrainNumber.Data(), TrainStart.Data())
    };

...
void Grid_CopyFiles_Runwise_MCAOD_anch16_LowB(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    if (TrainNumberChoice == 13){
        TrainNumber=Form("2744");
        TrainTag=Form("20200515");
        TrainStart=Form("20200515-2135");
    } else {

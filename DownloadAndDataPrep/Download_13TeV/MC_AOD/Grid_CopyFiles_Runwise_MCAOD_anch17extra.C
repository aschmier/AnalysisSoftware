...
void Grid_CopyFiles_Runwise_MCAOD_anch17extra(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString PrefixDataSets[nSets]={
        "/alice/sim/2017/LHC17h1_extra/",
        "/alice/sim/2018/LHC18d3_extra/",
        "/alice/sim/2018/LHC18c12_extra/",
        "/alice/sim/2017/LHC17k4_extra/",
        "/alice/sim/2017/LHC17h11_extra/",
        "/alice/sim/2018/LHC18c13_extra/",
        "/alice/sim/2018/LHC18a8_extra/",
        "/alice/sim/2017/LHC17l5_extra/",
        "/alice/sim/2018/LHC18a9_extra/",
        "/alice/sim/2018/LHC18a1_extra/",
    };
    ...
    for(Int_t i=nSetsStart; i<nSetsEnd; i++)
    {
        ...
        for(Int_t j=0; j<(Int_t)vecRuns.size(); j++)
        {
            ...
            if (TrainNumber.Contains("2475")){
                if (vecRuns.at(j).Contains("256366")) continue;
            }

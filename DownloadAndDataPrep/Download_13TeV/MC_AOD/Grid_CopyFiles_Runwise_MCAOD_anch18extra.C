...
void Grid_CopyFiles_Runwise_MCAOD_anch18extra(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString PrefixDataSets[nSets]={
        "/alice/sim/2018/LHC18g4_extra/",
        "/alice/sim/2018/LHC18g5_extra/",
        "/alice/sim/2018/LHC18g6_extra/",
        "/alice/sim/2018/LHC18h2_extra/",
        "/alice/sim/2018/LHC18h4_extra/",
        "/alice/sim/2018/LHC18j1_extra/",
        "/alice/sim/2018/LHC18j4_extra/",
        "/alice/sim/2018/LHC18k1_extra/",
        "/alice/sim/2018/LHC18k2_extra/",
        "/alice/sim/2018/LHC18k3_extra/"
    };
    ...
    for(Int_t i=nSetsStart; i<nSetsEnd; i++)
    {
        ...
        for(Int_t j=0; j<(Int_t)vecRuns.size(); j++)
        {
            ...
            if (TrainNumber.Contains("2473")){
                ;
                //if (vecRuns.at(j).Contains("290944")) continue;
            }

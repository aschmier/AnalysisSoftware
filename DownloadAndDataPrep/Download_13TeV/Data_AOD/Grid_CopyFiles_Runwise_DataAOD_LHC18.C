...
void Grid_CopyFiles_Runwise_DataAOD_LHC18(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    /*TString DataSets[nSets]={
        "LHC18b_pass1_DPGTrack",
        "LHC18d_pass1_DPGTrack",
        "LHC18e_pass1_DPGTrack",
        "LHC18f_pass1_DPGTrack",
        "LHC18g_pass1_DPGTrack",
        "LHC18h_pass1_DPGTrack",
        "LHC18i_pass1_DPGTrack",
        "LHC18j_pass1_DPGTrack",
        "LHC18k_pass1_DPGTrack",
        "LHC18l_pass1_DPGTrack",
        "LHC18m_pass1_DPGTrack",
        "LHC18n_pass1_DPGTrack",
        "LHC18o_pass1_DPGTrack",
        "LHC18p_pass1_DPGTrack"
    };*/
    /*TString DataSets[nSets]={
        "LHC18b_pass1_DPGTrackIncAccTPC",
        "LHC18d_pass1_DPGTrackIncAccTPC",
        "LHC18e_pass1_DPGTrackIncAccTPC",
        "LHC18f_pass1_DPGTrackIncAccTPC",
        "LHC18g_pass1_DPGTrackIncAccTPC",
        "LHC18h_pass1_DPGTrackIncAccTPC",
        "LHC18i_pass1_DPGTrackIncAccTPC",
        "LHC18j_pass1_DPGTrackIncAccTPC",
        "LHC18k_pass1_DPGTrackIncAccTPC",
        "LHC18l_pass1_DPGTrackIncAccTPC",
        "LHC18m_pass1_withTRDtracking_DPGTrackIncAccTPC",
        "LHC18n_pass1_DPGTrackIncAccTPC",
        "LHC18o_pass1_DPGTrackIncAccTPC",
        "LHC18p_pass1_DPGTrackIncAccTPC"
    };*/
    TString DataSets[nSets]={
        "LHC18b_pass1_PHOS",
        "LHC18d_pass1_PHOS",
    ...
    TString PrefixDataSets[nSets]={
        "/alice/data/2018/LHC18b/000",
        "/alice/data/2018/LHC18d/000",
        "/alice/data/2018/LHC18e/000",
        "/alice/data/2018/LHC18f/000",
        "/alice/data/2018/LHC18g/000",
        "/alice/data/2018/LHC18h/000",
        "/alice/data/2018/LHC18i/000",
        "/alice/data/2018/LHC18j/000",
        "/alice/data/2018/LHC18k/000",
        "/alice/data/2018/LHC18l/000",
        "/alice/data/2018/LHC18m/000",
        "/alice/data/2018/LHC18n/000",
        "/alice/data/2018/LHC18o/000",
        "/alice/data/2018/LHC18p/000"
    };
    TString SuffixDataSets[nSets]={
        ...
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 8),
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 9),
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 10),
        Form("/pass1_withTRDtracking%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 11),
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 12),
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 13),
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 14)
    };
    ...
    for(Int_t i=nSetsStart; i<nSetsEnd; i++)
    {
        ...
        for(Int_t j=0; j<(Int_t)vecRuns.size(); j++)
        {
            ...
            if (TrainNumber.Contains("1328")){
                if (vecRuns.at(j).Contains("256366")||vecRuns.at(j).Contains("289547")){
                    continue;
                }
            }

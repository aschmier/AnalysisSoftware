...
void Grid_CopyFiles_Runwise_DataAOD_LHC18_LowB_AODVal(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString TrainTag;
    TString TrainStart;
    TString AODString="/AOD236";
    TString passAdditionString="_CENT_woSDD";
    if (TrainNumberChoice == 14){
        TrainNumber=Form("1404");
        TrainTag=Form("20200509");
        TrainStart=Form("20200509-0815");
    } else if (TrainNumberChoice == 16){
        TrainNumber=Form("1423");

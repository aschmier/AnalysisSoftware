...
void Grid_CopyFiles_Runwise_DataAOD_LHC18_LowB(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString TrainTag;
    TString TrainStart;
    TString AODString="/AOD212";
    TString passAdditionString="_CENT_woSDD";
    if (TrainNumberChoice == 13){
        TrainNumber=Form("1407");
        TrainTag=Form("20200515");
        TrainStart=Form("20200515-2137");
    } else if (TrainNumberChoice == 16){
        TrainNumber=Form("1422");
    ...
    TString DataSets[nSets]={
        "FILTER_p-p_212_LHC18c"
    };
    TString DataSetsFolder[nSets]={
        "FILTER_p-p_212_LHC18c"
    };
    TString PrefixDataSets[nSets]={
        "/alice/data/2018/LHC18c/000"
    };
    TString SuffixDataSets[nSets]={
        Form("/pass1%s%s/PWGGA/GA_pp_AOD/%s_%s_child_%d/", passAdditionString.Data(), AODString.Data(), TrainNumber.Data(), TrainStart.Data(), 1)
    };

...
void Grid_CopyFiles_Runwise_DataAOD_LHC17(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    /*TString DataSets[nSets]={
        "LHC17c_pass1_DPGTrack",
        "LHC17e_pass1_DPGTrack",
        "LHC17f_pass1_DPGTrack",
        "LHC17h_pass1_DPGTrack",
        "LHC17i_pass1_DPGTrack",
        "LHC17j_pass1_DPGTrack",
        "LHC17k_pass1_DPGTrack",
        "LHC17l_pass1_DPGTrack",
        "LHC17m_pass1_DPGTrack",
        "LHC17o_pass1_DPGTrack",
        "LHC17r_pass1_DPGTrack"
    };*/
    TString DataSets[nSets]={
        "LHC17c_pass1_PHOS",
        "LHC17e_pass1_PHOS",
    ...
    TString PrefixDataSets[nSets]={
        "/alice/data/2017/LHC17c/000",
        "/alice/data/2017/LHC17e/000",
        "/alice/data/2017/LHC17f/000",
        "/alice/data/2017/LHC17h/000",
        "/alice/data/2017/LHC17i/000",
        "/alice/data/2017/LHC17j/000",
        "/alice/data/2017/LHC17k/000",
        "/alice/data/2017/LHC17l/000",
        "/alice/data/2017/LHC17m/000",
        "/alice/data/2017/LHC17o/000",
        "/alice/data/2017/LHC17r/000"
    };
    ...
    for(Int_t i=nSetsStart; i<nSetsEnd; i++)
    {
        ...
        {
            if ( vecRuns.at(j).Contains("280764")){
                continue;
            }

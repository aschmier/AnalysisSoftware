...
void Grid_CopyFiles_Runwise_DataAOD_LHC18_AODVal(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString DataSets[nSets]={
        Form("FILTER_p-p_%s_LHC18b",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18d",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18e",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18f",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18g",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18h",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18i",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18j",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18k",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18l",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18m",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18n",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18o",  FilterString.Data()),
        Form("FILTER_p-p_%s_LHC18p",  FilterString.Data())
    };

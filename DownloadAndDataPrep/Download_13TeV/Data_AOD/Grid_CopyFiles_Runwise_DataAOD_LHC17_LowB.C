...
void Grid_CopyFiles_Runwise_DataAOD_LHC17_LowB(TString folder = "/home/jens/Programme_und_Skripte/alice-pcg/AnalysisSoftware", Int_t TrainNumberChoiceArgument=1, Int_t doUnzipArgument=1, Bool_t isJetJet=kFALSE)
{
    ...
    TString DataSets[nSets]={
        "FILTER_p-p_212_LHC17g"
    };
    TString DataSetsFolder[nSets]={
        "FILTER_p-p_212_LHC17g"
    };
    TString PrefixDataSets[nSets]={
        "/alice/data/2017/LHC17g/000"
    };
    TString SuffixDataSets[nSets]={
        Form("/pass1%s/PWGGA/GA_pp_AOD/%s_%s/", AODString.Data(), TrainNumber.Data(), TrainStart.Data())
    };

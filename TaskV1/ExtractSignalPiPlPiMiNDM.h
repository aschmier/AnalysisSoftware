...
TH1D*   fHistoSBdefaultMesonBackFit[6]                      = { NULL, NULL, NULL, NULL, NULL, NULL};
TH1D*   fHistoSBdefaultMesonBackFit_SubPiZero[6]            = { NULL, NULL, NULL, NULL, NULL, NULL};
TH1D*   fHistoSBdefaultMesonBackFit_FixedPzPiZero[6]        = { NULL, NULL, NULL, NULL, NULL, NULL};
...
TH1D*   fHistoSigndefaultMesonBackFit[6]                    = { NULL, NULL, NULL, NULL, NULL, NULL};
TH1D*   fHistoSigndefaultMesonBackFit_SubPiZero[6]          = { NULL, NULL, NULL, NULL, NULL, NULL};
TH1D*   fHistoSigndefaultMesonBackFit_FixedPzPiZero[6]      = { NULL, NULL, NULL, NULL, NULL, NULL};
...
TH1D** 	fHistoMappingBackNormInvMassPtBinBackFit[5]=                {NULL,NULL,NULL,NULL,NULL};
TH1D** 	fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[5]=      {NULL,NULL,NULL,NULL,NULL};
TH1D** 	fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[5]=  {NULL,NULL,NULL,NULL,NULL};
...
Double_t* fBckYieldsBackFit[6] =                                   {NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fBckYieldsBackFit_SubPiZero[6] =                         {NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fBckYieldsBackFit_FixedPzPiZero[6] =                     {NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fTotalBckYieldsBackFit[6]= 								{NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fTotalBckYieldsBackFit_SubPiZero[6]= 					{NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fTotalBckYieldsBackFit_FixedPzPiZero[6]=					{NULL, NULL, NULL, NULL, NULL, NULL};
...
Double_t* fMesonSBdefaultBackFit[3]                         = { NULL, NULL, NULL};
Double_t* fMesonSBdefaultBackFit_SubPiZero[3]               = { NULL, NULL, NULL};
Double_t* fMesonSBdefaultBackFit_FixedPzPiZero[3]           = { NULL, NULL, NULL};
...
Double_t* fMesonSigndefaultBackFit[3]                       = { NULL, NULL, NULL};
Double_t* fMesonSigndefaultBackFit_SubPiZero[3]             = { NULL, NULL, NULL};
Double_t* fMesonSigndefaultBackFit_FixedPzPiZero[3]         = { NULL, NULL, NULL};
...
Double_t* fMesonSBdefaultBackFitError[3]                    = { NULL, NULL, NULL};
Double_t* fMesonSBdefaultBackFitError_SubPiZero[3]          = { NULL, NULL, NULL};
Double_t* fMesonSBdefaultBackFitError_FixedPzPiZero[3]      = { NULL, NULL, NULL};
...
Double_t* fMesonSigndefaultBackFitError[3]                  = { NULL, NULL, NULL};
Double_t* fMesonSigndefaultBackFitError_SubPiZero[3]        = { NULL, NULL, NULL};
Double_t* fMesonSigndefaultBackFitError_FixedPzPiZero[3]    = { NULL, NULL, NULL};
...
Double_t* fBckYieldsBackFitError[6] =                            {NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fBckYieldsBackFitError_SubPiZero[6] =                  {NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fBckYieldsBackFitError_FixedPzPiZero[6] =              {NULL, NULL, NULL, NULL, NULL, NULL};
...
Double_t* fTotalBckYieldsBackFitError[6]=							{NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fTotalBckYieldsBackFitError_SubPiZero[6]=				{NULL, NULL, NULL, NULL, NULL, NULL};
Double_t* fTotalBckYieldsBackFitError_FixedPzPiZero[6]=			{NULL, NULL, NULL, NULL, NULL, NULL};

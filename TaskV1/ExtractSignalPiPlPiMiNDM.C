...
Double_t FunctionBGExclusion(Double_t *x, Double_t *par){
    if (x[0] > fPeakRange[0] && x[0] < fPeakRange[1]) {
        TF1::RejectPoint();
        return 0;
    }
...
Double_t FunctionBGExclusionExp(Double_t *x, Double_t *par){
    if (x[0] > fPeakRange[0] && x[0] < fPeakRange[1]) {
        TF1::RejectPoint();
        return 0;
    }
...
void ExtractSignalPiPlPiMiNDM(   TString meson                  = "",
    ...
    // if(optionMC.CompareTo("kTRUE") == 0 && mode ==64 && (fCutSelectionRead.Contains("2_00052113_111113106f032230000_0103603c00000000_32c51070a_0153503000000000"))){
    //     fCutSelectionRead = "2_00010113_111113106f032230000_0103603c00000000_32c51070a_0153503000000000";
    ...
    TString ObjectNameBck_FromMC                            = "ESD_Mother_InvMass_Pt";
    TString ObjectNameBckSubPiZero_FromMC                   = Form("ESD_InvMass_Mother_Sub_InvMass%s_Pt",oldNewTaskString.Data());
    TString ObjectNameBckFixedPzPiZero_FromMC               = Form("ESD_InvMass_Mother_FixedPz%s_Pt",oldNewTaskString.Data());
    TString ObjectNameTrue_FromMC                           = "ESD_TrueMotherPiPlPiMiNDM_InvMass_Pt";
    TString ObjectNameTrueSubPiZero_FromMC                  = "ESD_TrueMotherPiPlPiMiNDM_InvMass_SubNDM_Pt";
    TString ObjectNameTrueFixedPzPiZero_FromMC              = "ESD_TrueMotherPiPlPiMiNDM_InvMass_FixedPzNDM_Pt";

    TString ObjectNameCombinatorical_FromData               = Form("%s", histBckName.Data());
    TString ObjectNameCombinatoricalSubPiZero_FromData      = Form("%s", histBckNameSub.Data());
    TString ObjectNameCombinatoricalFixedPzPiZero_FromData  = Form("%s", histBckNameFixed.Data());

    TString ObjectNameCombinatorical_FromMC                 = Form("%s", histBckName.Data());
    TString ObjectNameCombinatoricalSubPiZero_FromMC        = Form("%s", histBckNameSub.Data());
    TString ObjectNameCombinatoricalFixedPzPiZero_FromMC    = Form("%s", histBckNameFixed.Data());

    if(fBackMixingMode.CompareTo("a")!=0){
        ObjectNameCombinatorical_FromData                   = Form("%s", ObjectNameBck[0].Data());
        ObjectNameCombinatoricalSubPiZero_FromData          = Form("%s", ObjectNameBckSubPiZero[0].Data());
        ObjectNameCombinatoricalFixedPzPiZero_FromData      = Form("%s", ObjectNameBckFixedPzPiZero[0].Data());

        ObjectNameCombinatorical_FromMC                     = Form("%s", ObjectNameBck[0].Data());
        ObjectNameCombinatoricalSubPiZero_FromMC            = Form("%s", ObjectNameBckSubPiZero[0].Data());
    ...
    if(fGammaGamma && fBck[0]){
        ProcessEM_switch( fGammaGamma , fBck[0], fBGFitRange); // scale the added background
    ...
    if(fGammaGamma_SubPiZero && fBck_SubPiZero[0]){
        ProcessEM_switch( fGammaGamma_SubPiZero , fBck_SubPiZero[0], fBGFitRange_SubPiZero);
    ...
    if(fGammaGamma_FixedPzPiZero && fBck_FixedPzPiZero[0]){
        ProcessEM_switch( fGammaGamma_FixedPzPiZero , fBck_FixedPzPiZero[0], fBGFitRange_FixedPzPiZero);
    ...
    if(fMesonFullPtSignal && fMesonFullPtBackground[0] && fFittingHistMidPtSignal && fFittingHistMidPtBackground[0]){
        ProcessEM_switch( fMesonFullPtSignal, fMesonFullPtBackground[0], fBGFitRange);
        fMesonFullPtBackNorm            = fBckNorm;
        ProcessEM_switch( fFittingHistMidPtSignal, fFittingHistMidPtBackground[0], fBGFitRange);
    ...
    if(fMesonFullPtSignal_SubPiZero && fMesonFullPtBackground_SubPiZero[0] && fFittingHistMidPtSignal_SubPiZero && fFittingHistMidPtBackground_SubPiZero[0]){
        ProcessEM_switch( fMesonFullPtSignal_SubPiZero, fMesonFullPtBackground_SubPiZero[0], fBGFitRange_SubPiZero);
        fMesonFullPtBackNorm_SubPiZero            = fBckNorm;
        ProcessEM_switch( fFittingHistMidPtSignal_SubPiZero, fFittingHistMidPtBackground_SubPiZero[0], fBGFitRange_SubPiZero);
    ...
    if(fMesonFullPtSignal_FixedPzPiZero && fMesonFullPtBackground_FixedPzPiZero[0] && fFittingHistMidPtSignal_FixedPzPiZero &&  fFittingHistMidPtBackground_FixedPzPiZero[0]){
        ProcessEM_switch( fMesonFullPtSignal_FixedPzPiZero, fMesonFullPtBackground_FixedPzPiZero[0], fBGFitRange_FixedPzPiZero);
        fMesonFullPtBackNorm_FixedPzPiZero            = fBckNorm;
        ProcessEM_switch( fFittingHistMidPtSignal_FixedPzPiZero, fFittingHistMidPtBackground_FixedPzPiZero[0], fBGFitRange_FixedPzPiZero);
    ...
    //      cout << "test" << endl;
    //      cout << fHistoMappingTrueMesonInvMassPtMidPt << endl;
    ...
    for(Int_t iPt=fStartPtBin;iPt<fNBinsPt;iPt++){ // BEGIN ANALYSIS for each Pt bin
        ...
        if (doDebugOutputLevel>=1){
            cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Analysis Pt Bin Loop; Pt: "<<fBinsPt[iPt];
            cout<<" - "<<fBinsPt[iPt+1];
            cout<<"; Rebin: "<<fNRebin[iPt]<<endl;}
        ...
        if (useMCBck<=1){
            if(fHistoMappingGGInvMassPtBin[iPt]){
                ...
                for (Int_t k=0; k<1; k++){
                    fHistoMappingBackNormInvMassPtBinBackFit[k][iPt]=fHistoMappingGGInvMassBackFitWithoutSignalPtBin[iPt];
                }
            }
            if(fHistoMappingGGInvMassPtBin_SubPiZero[iPt]){
                ...
                for (Int_t k=0; k<1; k++){
                    fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[k][iPt]=fHistoMappingGGInvMassBackFitWithoutSignalPtBin[iPt];
                }
            }
            if(fHistoMappingGGInvMassPtBin_FixedPzPiZero[iPt]){
                ...
                for (Int_t k=0; k<1; k++){
                    fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[k][iPt]=fHistoMappingGGInvMassBackFitWithoutSignalPtBin[iPt];
                }
            }
        ...
        for(Int_t k=0;k<5;k++){
          if((fHistoMappingGGInvMassBackFitPtBin[iPt]!=NULL) && (fHistoMappingBackInvMassPtBin[k][iPt]!=NULL )){
            ProcessEM_switch( fHistoMappingGGInvMassPtBin[iPt], fHistoMappingBackInvMassPtBin[k][iPt], fBGFitRange);
            if(k==0){
          ...
          if((fHistoMappingGGInvMassBackFitPtBin_SubPiZero[iPt]!=NULL) && (fHistoMappingBackInvMassPtBin_SubPiZero[k][iPt]!=NULL )){
            ProcessEM_switch( fHistoMappingGGInvMassPtBin_SubPiZero[iPt], fHistoMappingBackInvMassPtBin_SubPiZero[k][iPt], fBGFitRange_SubPiZero);
            if(k==0){
                fNormTot = fNorm; // k==0 means tot back was just scaled -> store value for using for samescale
          ...
          if((fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[iPt]!=NULL) && (fHistoMappingBackInvMassPtBin_FixedPzPiZero[k][iPt]!=NULL )){
            ProcessEM_switch( fHistoMappingGGInvMassPtBin_FixedPzPiZero[iPt], fHistoMappingBackInvMassPtBin_FixedPzPiZero[k][iPt], fBGFitRange_FixedPzPiZero);
            if(k==0){
                fNormTot = fNorm; // k==0 means tot back was just scaled -> store value for using for samescale
        ...
        if(fCrysFitting==0){
            ...
            if(fHistoMappingSignalInvMassPtBin[iPt]){
              ...
              if (fFitReco)
                ...
                fMesonChi2[0][iPt]                      = -1;
              cout << fHistSignalOnly << endl;
              fHistoMappingSignalInvMassPtBinResSubtracted[iPt] = (TH1D*) fHistSignalOnly->Clone(Form("fHistoMappingSignalInvMassPtBinResSubtracted_%i",iPt));
              cout << "fHistSignalOnly" << endl;
            } else{
            ...
            if(fHistoMappingGGInvMassBackFitPtBin[iPt]) {
                ...
                fMesonYieldsBackFitFromFit[iPt]                 = fIntGaussExp;
                fMesonYieldsBackFitFromFitError[iPt]            = fIntGaussExpError;
                if (fFitReco)
            ...
            if(fHistoMappingSignalInvMassPtBin_SubPiZero[iPt]){
              ...
              fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero[iPt] = (TH1D*) fHistSignalOnly->Clone(Form("fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero_%i",iPt));
              if (fFitReco)
            ...
            if(fHistoMappingGGInvMassBackFitPtBin_SubPiZero[iPt]) {
                ...
                fMesonYieldsBackFitFromFit_SubPiZero[iPt]                 = fIntGaussExp;
                fMesonYieldsBackFitFromFitError_SubPiZero[iPt]            = fIntGaussExpError;
                if (fFitReco)
                  fMesonChi2[4][iPt]                      = fFitReco->GetChisquare()/fFitReco->GetNDF();
                else
                  fMesonChi2[4][iPt]                      = -1;
            } else {
                fMesonYieldsResidualBckFuncBackFit_SubPiZero[iPt]         = 0.;
            ...
            if(fHistoMappingSignalInvMassPtBin_FixedPzPiZero[iPt]!=NULL){
              ...
              fFileDataLog << "Subtracted polinomial fit" << endl;
              fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero[iPt] = (TH1D*) fHistSignalOnly->Clone(Form("fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero_%i",iPt));
              if (fFitReco)
             ...
             if(fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[iPt]) {
                  ...
                  fMesonYieldsBackFitFromFit_FixedPzPiZero[iPt]                 = fIntGaussExp;
                  fMesonYieldsBackFitFromFitError_FixedPzPiZero[iPt]            = fIntGaussExpError;
                  if (fFitReco)
                    fMesonChi2[5][iPt]                      = fFitReco->GetChisquare()/fFitReco->GetNDF();
                  else
                    fMesonChi2[5][iPt]                      = -1;
             } else {
        ...
        if(fFitSignalInvMassPtBin[iPt]){
            Double_t sigma                                                      = fFitSignalInvMassPtBin[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassPtBin[iPt]->GetParError(2);
            CalculateFWHM( fFitSignalInvMassPtBin[iPt],fMesonFitRange);
            fMesonFWHM[iPt]                                                     = fFWHMFunc;
            fMesonFWHMError[iPt]                                                = fFWHMFuncError;
            fMesonWidth[iPt]                                                    = sigma;
            fMesonWidthError[iPt]                                               = sigma_err;
        } else {
            fMesonFWHM[iPt]                                                     = 0.;
        ...
        if(fFitSignalInvMassPtBin_SubPiZero[iPt]){
            Double_t sigma                                                      = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParError(2);
            ...
            fMesonWidth_SubPiZero[iPt]                                          = sigma;
            fMesonWidthError_SubPiZero[iPt]                                     = sigma_err;
        } else {
            fMesonFWHM_SubPiZero[iPt]                                           = 0.;
            fMesonFWHMError_SubPiZero[iPt]                                      = 0.;
            fMesonWidth_SubPiZero[iPt]                                          = 0.;
            fMesonWidthError_SubPiZero[iPt]                                     = 0.;
        }
        // Calculation for fixed Pi0 Pz
        if(fFitSignalInvMassPtBin_FixedPzPiZero[iPt]){
            Double_t sigma                                                      = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(2);
            ...
            fMesonWidth_FixedPzPiZero[iPt]                                      = sigma;
            fMesonWidthError_FixedPzPiZero[iPt]                                 = sigma_err;
        } else {
            fMesonFWHM_FixedPzPiZero[iPt]                                       = 0.;
            fMesonFWHMError_FixedPzPiZero[iPt]                                  = 0.;
            fMesonWidth_FixedPzPiZero[iPt]                                      = 0.;
            fMesonWidthError_FixedPzPiZero[iPt]                                 = 0.;
        }
        ...
        if(fFitSignalInvMassBackFitPtBin[iPt]){ 
            ...
            Double_t sigma                                                      = fFitSignalInvMassBackFitPtBin[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassBackFitPtBin[iPt]->GetParError(2);
            fMesonFWHMBackFit[iPt]                                              = 2.3548 * sigma;
            fMesonFWHMBackFitError[iPt]                                         = 2.3548 * sigma_err;
            fMesonWidthBackFit[iPt]                                             = sigma;
            fMesonWidthBackFitError[iPt]                                        = sigma_err;
        } else {
        ...
        if(fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]){ 
            ...
            Double_t sigma                                                      = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParError(2);
            fMesonFWHMBackFit_SubPiZero[iPt]                                    = 2.3548 * sigma;
            fMesonFWHMBackFitError_SubPiZero[iPt]                               = 2.3548 * sigma_err;
            fMesonWidthBackFit_SubPiZero[iPt]                                   = sigma;
            fMesonWidthBackFitError_SubPiZero[iPt]                              = sigma_err;
        } else {
        ...
        if(fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]){ 
            ...
            Double_t sigma                                                      = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParError(2);
            fMesonFWHMBackFit_FixedPzPiZero[iPt]                                = 2.3548 * sigma;
            fMesonFWHMBackFitError_FixedPzPiZero[iPt]                           = 2.3548 * sigma_err;
            fMesonWidthBackFit_FixedPzPiZero[iPt]                               = sigma;
            fMesonWidthBackFitError_FixedPzPiZero[iPt]                          = sigma_err;
        } else {
        ...
        if (fFitSignalInvMassPtBin[iPt] !=0x00){
            ...
            fMesonAmplitude[iPt]                                                = fFitSignalInvMassPtBin[iPt]->GetParameter(0);
            fMesonAmplitudeError[iPt]                                           = fFitSignalInvMassPtBin[iPt]->GetParError(0);
            ...
            fMesonCurIntRangeAllPt[0][0][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPt[1][0][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPt[2][0][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPt[0][1][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPt[1][1][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPt[2][1][iPt]                                   = fMesonMass[iPt] + fMesonIntDeltaRangeNarrow[1];
            ...
            if (fFitSignalInvMassPtBin_SubPiZero !=0x00){
              ...
              fMesonLambdaTailpar_SubPiZero[iPt]                                = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(3);
              fMesonLambdaTailparError_SubPiZero[iPt]                           = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParError(3);
              fMesonAmplitude_SubPiZero[iPt]                                    = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(0);
              fMesonAmplitudeError_SubPiZero[iPt]                               = fFitSignalInvMassPtBin_SubPiZero[iPt]->GetParError(0);
              ...
              fMesonCurIntRangeAllPt_SubPiZero[0][0][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRange[0];
              fMesonCurIntRangeAllPt_SubPiZero[1][0][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeWide[0];
              fMesonCurIntRangeAllPt_SubPiZero[2][0][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
              fMesonCurIntRangeAllPt_SubPiZero[0][1][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRange[1];
              fMesonCurIntRangeAllPt_SubPiZero[1][1][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeWide[1];
              fMesonCurIntRangeAllPt_SubPiZero[2][1][iPt]                       = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];
            }
            ...
            if (fFitSignalInvMassPtBin_FixedPzPiZero !=0x00){
              ...
              fMesonLambdaTailpar_FixedPzPiZero[iPt]                            = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(3);
              fMesonLambdaTailparError_FixedPzPiZero[iPt]                       = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(3);
              fMesonAmplitude_FixedPzPiZero[iPt]                                = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(0);
              fMesonAmplitudeError_FixedPzPiZero[iPt]                           = fFitSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(0);
              ...
              fMesonCurIntRangeAllPt_FixedPzPiZero[0][0][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRange[0];
              fMesonCurIntRangeAllPt_FixedPzPiZero[1][0][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[0];
              fMesonCurIntRangeAllPt_FixedPzPiZero[2][0][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
              fMesonCurIntRangeAllPt_FixedPzPiZero[0][1][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRange[1];
              fMesonCurIntRangeAllPt_FixedPzPiZero[1][1][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[1];
              fMesonCurIntRangeAllPt_FixedPzPiZero[2][1][iPt]                   = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];
            }
        } else {

            fMesonMass[iPt]                                                     = fMesonMassExpect;
            fMesonMassError[iPt]                                                = 0.;
            fMesonLambdaTailpar[iPt]                                            = 0.;
            fMesonLambdaTailparError[iPt]                                       = 0.;
            fMesonAmplitude[iPt]                                                = 0.;
            fMesonAmplitudeError[iPt]                                           = 0.;
            ...
            fMesonCurIntRangeAllPt[0][0][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPt[1][0][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPt[2][0][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPt[0][1][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPt[1][1][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPt[2][1][iPt]                                   = fMesonMassExpect + fMesonIntDeltaRangeNarrow[1];

            fMesonMass_SubPiZero[iPt]                                           = fMesonMassExpect;
            fMesonMassError_SubPiZero[iPt]                                      = 0.;
            fMesonLambdaTailpar_SubPiZero[iPt]                                  = 0.;
            fMesonLambdaTailparError_SubPiZero[iPt]                             = 0.;
            fMesonAmplitude_SubPiZero[iPt]                                      = 0.;
            fMesonAmplitudeError_SubPiZero[iPt]                                 = 0.;
            fMesonCurIntRange_SubPiZero[0][0]                                   = fMesonMass_SubPiZero[iPt]   + fMesonIntDeltaRange[0];
            fMesonCurIntRange_SubPiZero[1][0]                                   = fMesonMass_SubPiZero[iPt]   + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRange_SubPiZero[2][0]                                   = fMesonMass_SubPiZero[iPt]   + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRange_SubPiZero[0][1]                                   = fMesonMass_SubPiZero[iPt]   + fMesonIntDeltaRange[1];
            ...
            fMesonLambdaTailpar_FixedPzPiZero[iPt]                              = 0.;
            fMesonLambdaTailparError_FixedPzPiZero[iPt]                         = 0.;
            fMesonAmplitude_FixedPzPiZero[iPt]                                  = 0.;
            fMesonAmplitudeError_FixedPzPiZero[iPt]                             = 0;
            fMesonCurIntRange_FixedPzPiZero[0][0]                               = fMesonMass_FixedPzPiZero[iPt]   + fMesonIntDeltaRange[0];
            fMesonCurIntRange_FixedPzPiZero[1][0]                               = fMesonMass_FixedPzPiZero[iPt]   + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRange_FixedPzPiZero[2][0]                               = fMesonMass_FixedPzPiZero[iPt]   + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRange_FixedPzPiZero[0][1]                               = fMesonMass_FixedPzPiZero[iPt]   + fMesonIntDeltaRange[1];
        ...
        if (fFitSignalInvMassBackFitPtBin[iPt] !=0x00){ 
            ...
            fMesonLambdaTailparBackFit[iPt]                                     = fFitSignalInvMassBackFitPtBin[iPt]->GetParameter(3);
            fMesonLambdaTailparBackFitError[iPt]                                = fFitSignalInvMassBackFitPtBin[iPt]->GetParError(3);
            fMesonAmplitudeBackFit[iPt]                                         = fFitSignalInvMassBackFitPtBin[iPt]->GetParameter(0);
            fMesonAmplitudeBackFitError[iPt]                                    = fFitSignalInvMassBackFitPtBin[iPt]->GetParError(0);
            ...
            fMesonCurIntRangeAllPtBackFit[0][0][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPtBackFit[1][0][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPtBackFit[2][0][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPtBackFit[0][1][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPtBackFit[1][1][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPtBackFit[2][1][iPt]                            = fMesonMassBackFit[iPt] + fMesonIntDeltaRangeNarrow[1];
            ...
            if(fFitSignalInvMassBackFitPtBin_SubPiZero !=0x00){
              ...
              fMesonLambdaTailparBackFit_SubPiZero[iPt]                         = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParameter(3);
              fMesonLambdaTailparBackFitError_SubPiZero[iPt]                    = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParError(3);
              fMesonAmplitudeBackFit_SubPiZero[iPt]                             = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParameter(0);
              fMesonAmplitudeBackFitError_SubPiZero[iPt]                        = fFitSignalInvMassBackFitPtBin_SubPiZero[iPt]->GetParError(0);
              //fMesonCurIntRangeBackFit[0]                                       = fMesonIntRange[0] - (fMesonMassExpect-fMesonMassBackFit[iPt]);
              //fMesonCurIntRangeBackFit[1]                                       = fMesonIntRange[1] - (fMesonMassExpect-fMesonMassBackFit[iPt]);
              ...
              fMesonCurIntRangeAllPtBackFit_SubPiZero[0][0][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRange[0];
              fMesonCurIntRangeAllPtBackFit_SubPiZero[1][0][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRangeWide[0];
              fMesonCurIntRangeAllPtBackFit_SubPiZero[2][0][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
              fMesonCurIntRangeAllPtBackFit_SubPiZero[0][1][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRange[1];
              fMesonCurIntRangeAllPtBackFit_SubPiZero[1][1][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRangeWide[1];
              fMesonCurIntRangeAllPtBackFit_SubPiZero[2][1][iPt]                = fMesonMassBackFit_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];
            }
            ...
            if(fFitSignalInvMassBackFitPtBin_FixedPzPiZero !=0x00){
              ...
              fMesonLambdaTailparBackFit_FixedPzPiZero[iPt]                     = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParameter(3);
              fMesonLambdaTailparBackFitError_FixedPzPiZero[iPt]                = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParError(3);
              fMesonAmplitudeBackFit_FixedPzPiZero[iPt]                         = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParameter(0);
              fMesonAmplitudeBackFitError_FixedPzPiZero[iPt]                    = fFitSignalInvMassBackFitPtBin_FixedPzPiZero[iPt]->GetParError(0);
              //fMesonCurIntRangeBackFit[0]                                       = fMesonIntRange[0] - (fMesonMassExpect-fMesonMassBackFit[iPt]);
              //fMesonCurIntRangeBackFit[1]                                       = fMesonIntRange[1] - (fMesonMassExpect-fMesonMassBackFit[iPt]);
              ...
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[0][0][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRange[0];
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[1][0][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[0];
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[2][0][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[0][1][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRange[1];
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[1][1][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[1];
              fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[2][1][iPt]            = fMesonMassBackFit_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];
            }
        } else {
            fMesonMassBackFit[iPt]                                              = 0;
            fMesonMassBackFitError[iPt]                                         = 0;
            fMesonLambdaTailparBackFit[iPt]                                     = 0.;
            fMesonLambdaTailparBackFitError[iPt]                                = 0.;
            fMesonAmplitudeBackFit[iPt]                                         = 0.;
            fMesonAmplitudeBackFitError[iPt]                                    = 0;
            ...
            fMesonCurIntRangeAllPtBackFit[0][0][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPtBackFit[1][0][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPtBackFit[2][0][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPtBackFit[0][1][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPtBackFit[1][1][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPtBackFit[2][1][iPt]                            = fMesonMass[iPt] + fMesonIntDeltaRangeNarrow[1];

            fMesonMassBackFit_SubPiZero[iPt]                                    = 0;
            fMesonMassBackFitError_SubPiZero[iPt]                               = 0;
            fMesonLambdaTailparBackFit_SubPiZero[iPt]                           = 0.;
            fMesonLambdaTailparBackFitError_SubPiZero[iPt]                      = 0.;
            fMesonAmplitudeBackFit_SubPiZero[iPt]                               = 0.;
            fMesonAmplitudeBackFitError_SubPiZero[iPt]                          = 0;
            //MesonCurIntRangeBackFit[0]                                          = fMesonIntRange[0];
            //MesonCurIntRangeBackFit[1]                                          = fMesonIntRange[1];
            ...
            fMesonCurIntRangeAllPtBackFit_SubPiZero[0][0][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[1][0][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[2][0][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[0][1][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[1][1][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[2][1][iPt]                  = fMesonMass_SubPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];

            fMesonMassBackFit_FixedPzPiZero[iPt]                                = 0;
            fMesonMassBackFitError_FixedPzPiZero[iPt]                           = 0;
            fMesonLambdaTailparBackFit_FixedPzPiZero[iPt]                       = 0.;
            fMesonLambdaTailparBackFitError_FixedPzPiZero[iPt]                  = 0.;
            fMesonAmplitudeBackFit_FixedPzPiZero[iPt]                           = 0.;
            fMesonAmplitudeBackFitError_FixedPzPiZero[iPt]                      = 0;
            //MesonCurIntRangeBackFit[0]                                          = fMesonIntRange[0];
            //MesonCurIntRangeBackFit[1]                                          = fMesonIntRange[1];
            ...
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[0][0][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRange[0];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[1][0][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[0];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[2][0][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[0];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[0][1][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRange[1];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[1][1][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeWide[1];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[2][1][iPt]              = fMesonMass_FixedPzPiZero[iPt] + fMesonIntDeltaRangeNarrow[1];
        ...
        if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Set Yields To Variables"<<endl;}
        for (Int_t k = 0; k < 3; k++){
            ...
            if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Set Yields To Variables for BackFit"<<endl;}
            if (k < 3){ // backfitting doesnt have 6 cases (left doesnt make sense for fitting)
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Set Background Yields To Variables for BackFit"<<endl;}
                // Integrate the bck histo backfit
                if(fHistoMappingBackNormInvMassPtBinBackFit[0][iPt]) {
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit"<<endl;}
                    IntegrateHistoInvMass( fHistoMappingBackNormInvMassPtBinBackFit[0][iPt], fMesonCurIntRange[k]); // 0 because of tot back
                    fBckYieldsBackFit[k][iPt]              = fYields;
                    fBckYieldsBackFitError[k][iPt]         = fYieldsError;
                } else {
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit else case"<<endl;}
                    fBckYieldsBackFit[k][iPt]              = 0.;
                    fBckYieldsBackFitError[k][iPt]         = 0.;
                }

                // Integrate the bck histo with InvMass pi0 subtracted backfit
                if(  fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[0][iPt] != NULL){
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero"<<endl;}
                    IntegrateHistoInvMass( fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[0][iPt], fMesonCurIntRange_SubPiZero[k]);
                    fBckYieldsBackFit_SubPiZero[k][iPt]              = fYields;
                    fBckYieldsBackFitError_SubPiZero[k][iPt]         = fYieldsError;
                } else{
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero else case"<<endl;}
                    fBckYieldsBackFit_SubPiZero[k][iPt]              = 0.;
                    fBckYieldsBackFitError_SubPiZero[k][iPt]         = 0.;
                }

                // Integrate the bck histo with Pz of pi0 fixed backfit
                if(fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[0][iPt] != NULL){
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero"<<endl;}
                    IntegrateHistoInvMass( fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[0][iPt], fMesonCurIntRange_FixedPzPiZero[k]);
                    fBckYieldsBackFit_FixedPzPiZero[k][iPt]              = fYields;
                    fBckYieldsBackFitError_FixedPzPiZero[k][iPt]         = fYieldsError;
                } else {
                    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero else case"<<endl;}
                    fBckYieldsBackFit_FixedPzPiZero[k][iPt]              = 0.;
                    fBckYieldsBackFitError_FixedPzPiZero[k][iPt]         = 0.;
                }


                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Set Signal Yields To Variables for BackFit"<<endl;}
                ...
                if(fHistoMappingGGInvMassBackFitPtBin_SubPiZero[iPt]){
                    cout << endl <<"BackFit histo "<< nameIntRange[k].Data() << ":\t" << fBinsPt[iPt] <<"-" << fBinsPt[iPt+1] << endl;
            ...
            if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Set Yields To Variables for BackFit ended"<<endl;}
            ...
            if(fIsMC){
                ...
                if ((fHistoMappingTrueMesonInvMassPtBins[iPt]!=NULL)&&(fHistoMappingTrueMesonInvMassPtBins[iPt]->GetEntries() !=0)){
                    ...
                    if (fFitTrueSignalInvMassPtBin[iPt] != 0x00){
                        ...
                        Double_t sigma                                          = fFitTrueSignalInvMassPtBin[iPt]->GetParameter(2);
                        Double_t sigma_err                                      = fFitTrueSignalInvMassPtBin[iPt]->GetParError(2);
                        ...
                        fMesonWidth[iPt]                                        = sigma;
                        fMesonWidthError[iPt]                                   = sigma_err;
                        fMesonTrueLambdaTailpar[iPt]                            = fFitTrueSignalInvMassPtBin[iPt]->GetParameter(3);
                        fMesonTrueLambdaTailparError[iPt]                       = fFitTrueSignalInvMassPtBin[iPt]->GetParError(3);
                        fMesonTrueAmplitude[iPt]                                = fFitTrueSignalInvMassPtBin[iPt]->GetParameter(0);
                        fMesonTrueAmplitudeError[iPt]                           = fFitTrueSignalInvMassPtBin[iPt]->GetParError(0);
                        ...
                        fMesonTrueWidth[iPt]                                    = 0.;
                        fMesonTrueWidthError[iPt]                               = 0.;
                        fMesonTrueLambdaTailpar[iPt]                            = 0.;
                        fMesonTrueLambdaTailparError[iPt]                       = 0.;
                        fMesonTrueAmplitude[iPt]                                = 0.;
                        fMesonTrueAmplitudeError[iPt]                           = 0.;
                ...
                if ((fHistoMappingTrueMesonInvMassPtBins_SubPiZero[iPt]!=NULL)&&(fHistoMappingTrueMesonInvMassPtBins_SubPiZero[iPt]->GetEntries() !=0)){
                    ...
                    if (fFitTrueSignalInvMassPtBin_SubPiZero[iPt] != 0x00){
                        ...
                        Double_t sigma                                          = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(2);
                        Double_t sigma_err                                      = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParError(2);
                        ...
                        fMesonTrueWidth_SubPiZero[iPt]                          = sigma;
                        fMesonTrueWidthError_SubPiZero[iPt]                     = sigma_err;
                        fMesonTrueLambdaTailpar_SubPiZero[iPt]                  = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(3);
                        fMesonTrueLambdaTailparError_SubPiZero[iPt]             = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParError(3);
                        fMesonTrueAmplitude_SubPiZero[iPt]                      = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParameter(0);
                        fMesonTrueAmplitudeError_SubPiZero[iPt]                 = fFitTrueSignalInvMassPtBin_SubPiZero[iPt]->GetParError(0);
                        ...
                        fMesonTrueWidth_SubPiZero[iPt]                          = 0.;
                        fMesonTrueWidthError_SubPiZero[iPt]                     = 0.;
                        fMesonTrueLambdaTailpar_SubPiZero[iPt]                  = 0.;
                        fMesonTrueLambdaTailparError_SubPiZero[iPt]             = 0.;
                        fMesonTrueAmplitude_SubPiZero[iPt]                      = 0.;
                        fMesonTrueAmplitudeError_SubPiZero[iPt]                 = 0.;
                ...
                if ((fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero[iPt]!=NULL)&&(fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero[iPt]->GetEntries() !=0)){
                    ...
                    if (fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt] != 0x00){
                        ...
                        Double_t sigma                                          = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(2);
                        Double_t sigma_err                                      = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(2);
                        ...
                        fMesonTrueWidth_FixedPzPiZero[iPt]                      = sigma;
                        fMesonTrueWidthError_FixedPzPiZero[iPt]                 = sigma_err;
                        fMesonTrueLambdaTailpar_FixedPzPiZero[iPt]              = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(3);
                        fMesonTrueLambdaTailparError_FixedPzPiZero[iPt]         = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(3);
                        fMesonTrueAmplitude_FixedPzPiZero[iPt]                  = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParameter(0);
                        fMesonTrueAmplitudeError_FixedPzPiZero[iPt]             = fFitTrueSignalInvMassPtBin_FixedPzPiZero[iPt]->GetParError(0);
                        ...
                        fMesonTrueWidth_FixedPzPiZero[iPt]                      = 0.;
                        fMesonTrueWidthError_FixedPzPiZero[iPt]                 = 0.;
                        fMesonTrueLambdaTailpar_FixedPzPiZero[iPt]              = 0.;
                        fMesonTrueLambdaTailparError_FixedPzPiZero[iPt]         = 0.;
                        fMesonTrueAmplitude_FixedPzPiZero[iPt]                  = 0.;
                        fMesonTrueAmplitudeError_FixedPzPiZero[iPt]             = 0.;
                ...
                if(fHistoMappingTrueMesonInvMassPtReweightedBins[iPt]){
                    ...
                    if (fHistoMappingTrueMesonInvMassPtReweightedBins[iPt]->GetEntries() !=0){
                        ...
                        if (fFitTrueSignalInvMassPtReweightedBin[iPt] != 0x00){
                            ...
                            Double_t sigma                                      = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParameter(2);
                            Double_t sigma_err                                  = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParError(2);
                            ...
                            fMesonTrueWidthReweighted[iPt]                      = sigma;
                            fMesonTrueWidthReweightedError[iPt]                 = sigma_err;
                            fMesonTrueLambdaTailparReweighted[iPt]              = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParameter(3);
                            fMesonTrueLambdaTailparReweightedError[iPt]         = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParError(3);
                            fMesonTrueAmplitudeReweighted[iPt]                  = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParameter(0);
                            fMesonTrueAmplitudeReweightedError[iPt]             = fFitTrueSignalInvMassPtReweightedBin[iPt]->GetParError(0);
                            ...
                            fMesonTrueWidthReweighted[iPt]                      = 0.;
                            fMesonTrueWidthReweightedError[iPt]                 = 0.;
                            fMesonTrueLambdaTailparReweighted[iPt]              = 0.;
                            fMesonTrueLambdaTailparReweightedError[iPt]         = 0.;
                            fMesonTrueAmplitudeReweighted[iPt]                  = 0.;
                            fMesonTrueAmplitudeReweightedError[iPt]             = 0.;
                ...
                if(fHistoMappingTrueMesonInvMassPtReweightedBins_SubPiZero[iPt]){
                    ...
                    if (fHistoMappingTrueMesonInvMassPtReweightedBins_SubPiZero[iPt]->GetEntries() !=0){
                        ...
                        if (fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt] != 0x00){
                            ...
                            Double_t sigma                                      = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParameter(2);
                            Double_t sigma_err                                  = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParError(2);
                            ...
                            fMesonTrueWidthReweighted_SubPiZero[iPt]            = sigma;
                            fMesonTrueWidthReweightedError_SubPiZero[iPt]       = sigma_err;
                            fMesonTrueLambdaTailparReweighted_SubPiZero[iPt]    = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParameter(3);
                            fMesonTrueLambdaTailparReweightedError_SubPiZero[iPt] = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParError(3);
                            fMesonTrueAmplitudeReweighted_SubPiZero[iPt]        = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParameter(0);
                            fMesonTrueAmplitudeReweightedError_SubPiZero[iPt]   = fFitTrueSignalInvMassPtReweightedBin_SubPiZero[iPt]->GetParError(0);
                            ...
                            fMesonTrueWidthReweighted_SubPiZero[iPt]            = 0.;
                            fMesonTrueWidthReweightedError_SubPiZero[iPt]       = 0.;
                            fMesonTrueLambdaTailparReweighted_SubPiZero[iPt]    = 0.;
                            fMesonTrueLambdaTailparReweightedError_SubPiZero[iPt] = 0.;
                            fMesonTrueAmplitudeReweighted_SubPiZero[iPt]        = 0.;
                            fMesonTrueAmplitudeReweightedError_SubPiZero[iPt]   = 0.;
                ...
                if(fHistoMappingTrueMesonInvMassPtReweightedBins_FixedPzPiZero[iPt]){
                    ...
                    if (fHistoMappingTrueMesonInvMassPtReweightedBins_FixedPzPiZero[iPt]->GetEntries() !=0){
                        ...
                        if (fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt] != 0x00){
                            ...
                            Double_t sigma                                      = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParameter(2);
                            Double_t sigma_err                                  = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParError(2);
                            fMesonTrueFWHMReweighted_FixedPzPiZero[iPt]         = fFWHMFunc;
                            fMesonTrueFWHMReweightedError_FixedPzPiZero[iPt]    = fFWHMFuncError;
                            fMesonTrueWidthReweighted_FixedPzPiZero[iPt]        = sigma;
                            fMesonTrueWidthReweightedError_FixedPzPiZero[iPt]   = sigma_err;
                            fMesonTrueLambdaTailparReweighted_FixedPzPiZero[iPt] = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParameter(3);
                            fMesonTrueLambdaTailparReweightedError_FixedPzPiZero[iPt] = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParError(3);
                            fMesonTrueAmplitudeReweighted_FixedPzPiZero[iPt]    = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParameter(0);
                            fMesonTrueAmplitudeReweightedError_FixedPzPiZero[iPt] = fFitTrueSignalInvMassPtReweightedBin_FixedPzPiZero[iPt]->GetParError(0);
                            ...
                            fMesonTrueWidthReweighted_FixedPzPiZero[iPt]        = 0.;
                            fMesonTrueWidthReweightedError_FixedPzPiZero[iPt]   = 0.;
                            fMesonTrueLambdaTailparReweighted_FixedPzPiZero[iPt] = 0.;
                            fMesonTrueLambdaTailparReweightedError_FixedPzPiZero[iPt] = 0.;
                            fMesonTrueAmplitudeReweighted_FixedPzPiZero[iPt]    = 0.;
                            fMesonTrueAmplitudeReweightedError_FixedPzPiZero[iPt] = 0.;
            ...
            fTotalBckYieldsBackFit[k][iPt]                         = fBckYieldsBackFit[k][iPt] + fMesonYieldsResidualBckFuncBackFit[iPt];
            fTotalBckYieldsBackFit_SubPiZero[k][iPt]               = fBckYieldsBackFit_SubPiZero[k][iPt] + fMesonYieldsResidualBckFuncBackFit_SubPiZero[iPt];
            fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt]           = fBckYieldsBackFit_FixedPzPiZero[k][iPt] + fMesonYieldsResidualBckFuncBackFit_FixedPzPiZero[iPt];
            fTotalBckYieldsBackFitError[k][iPt]                    = TMath::Power(fBckYieldsBackFitError[k][iPt]*fBckYieldsBackFitError[k][iPt] + fMesonYieldsResidualBckFuncBackFitError[iPt]*fMesonYieldsResidualBckFuncBackFitError[iPt],0.5);
            fTotalBckYieldsBackFitError_SubPiZero[k][iPt]          = TMath::Power(fBckYieldsBackFitError_SubPiZero[k][iPt]*fBckYieldsBackFitError_SubPiZero[k][iPt] + fMesonYieldsResidualBckFuncBackFitError_SubPiZero[iPt]*fMesonYieldsResidualBckFuncBackFitError_SubPiZero[iPt],0.5);
            fTotalBckYieldsBackFitError_FixedPzPiZero[k][iPt]     = TMath::Power(fBckYieldsBackFitError_FixedPzPiZero[k][iPt]*fBckYieldsBackFitError_FixedPzPiZero[k][iPt] + fMesonYieldsResidualBckFuncBackFitError_FixedPzPiZero[iPt]*fMesonYieldsResidualBckFuncBackFitError_FixedPzPiZero[iPt],0.5);
            if (k<3){
                ...
                fMesonYieldsBackFitFromFitPerEvent[iPt]                    = fMesonYieldsBackFitFromFit[iPt]/fNEvents;
                fMesonYieldsBackFitFromFitPerEventError[iPt]               = fMesonYieldsBackFitFromFitError[iPt]/fNEvents;
                ...
                fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]          = fMesonYieldsBackFit_SubPiZero[k][iPt];
                ...
                fMesonYieldsBackFitFromFitPerEvent_SubPiZero[iPt]                    = fMesonYieldsBackFitFromFit_SubPiZero[iPt]/fNEvents;
                fMesonYieldsBackFitFromFitPerEventError_SubPiZero[iPt]               = fMesonYieldsBackFitFromFitError_SubPiZero[iPt]/fNEvents;
                ...
                //BackFit
                //SB default BackFit
                if (fTotalBckYieldsBackFit[k][iPt] != 0){
                    fMesonSBdefaultBackFit[k][iPt]                     = fMesonYieldsCorResidualBckFuncBackFit[k][iPt]/fTotalBckYieldsBackFit[k][iPt];
                    fMesonSBdefaultBackFitError[k][iPt]                = TMath::Power( TMath::Power(fMesonYieldsCorResidualBckFuncBackFitError[k][iPt]/fTotalBckYieldsBackFit[k][iPt], 2.) +
                                                                                       TMath::Power((fTotalBckYieldsBackFitError[k][iPt]*fMesonYieldsCorResidualBckFuncBackFit[k][iPt])/(fTotalBckYieldsBackFit[k][iPt] *fTotalBckYieldsBackFit[k][iPt]), 2.), 0.5);
                } else {
                    fMesonSBdefaultBackFit[k][iPt]         = 0.;
                    fMesonSBdefaultBackFitError[k][iPt]    = 0.;
                }

                //SB default BackFit SubPiZero
                if (fTotalBckYieldsBackFit_SubPiZero[k][iPt] != 0){
                    fMesonSBdefaultBackFit_SubPiZero[k][iPt]                     = fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]/fTotalBckYieldsBackFit_SubPiZero[k][iPt];
                    fMesonSBdefaultBackFitError_SubPiZero[k][iPt]                = TMath::Power( TMath::Power(fMesonYieldsCorResidualBckFuncBackFitError_SubPiZero[k][iPt]/fTotalBckYieldsBackFit_SubPiZero[k][iPt], 2.) +
                                                                                                 TMath::Power((fTotalBckYieldsBackFitError_SubPiZero[k][iPt]*fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt])/(fTotalBckYieldsBackFit_SubPiZero[k][iPt] *fTotalBckYieldsBackFit_SubPiZero[k][iPt]), 2.), 0.5);
                } else {
                    fMesonSBdefaultBackFit_SubPiZero[k][iPt]         = 0.;
                    fMesonSBdefaultBackFitError_SubPiZero[k][iPt]    = 0.;
                }

                //SB default BackFit FixedPzPiZero
                if (fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt] != 0){
                    fMesonSBdefaultBackFit_FixedPzPiZero[k][iPt]                     = fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt]/fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt];
                    fMesonSBdefaultBackFitError_FixedPzPiZero[k][iPt]                = TMath::Power( TMath::Power(fMesonYieldsCorResidualBckFuncBackFitError_FixedPzPiZero[k][iPt]/fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt], 2.) +
                                                                                                     TMath::Power((fTotalBckYieldsBackFitError_FixedPzPiZero[k][iPt]*fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt])/(fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt] *fTotalBckYieldsBackFit_FixedPzPiZero[k][iPt]), 2.), 0.5);
                } else {
                    fMesonSBdefaultBackFit_FixedPzPiZero[k][iPt]         = 0.;
                    fMesonSBdefaultBackFitError_FixedPzPiZero[k][iPt]    = 0.;
                }
                ...
                //----------------------------------------------------
                //BackFit
                if ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit[k][iPt] + fTotalBckYields[k][iPt],0.5) != 0){
                    fMesonSigndefaultBackFit[k][iPt]                   = fMesonYieldsCorResidualBckFuncBackFit[k][iPt]/TMath::Power(fMesonYieldsCorResidualBckFuncBackFit[k][iPt] + fTotalBckYields[k][iPt],0.5);
                    Double_t a                                  = ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit[k][iPt] + fTotalBckYields[k][iPt], -0.5) -
                                                                    0.5*fMesonYieldsCorResidualBckFuncBackFit[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit[k][iPt] +
                                                                    fTotalBckYields[k][iPt], -1.5) * fMesonYieldsCorResidualBckFuncBackFitError[k][iPt]);
                    Double_t b                                  = 0.5*fMesonYieldsCorResidualBckFuncBackFit[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit[k][iPt]
                                                                  + fTotalBckYields[k][iPt],-1.5) * fTotalBckYieldsError[k][iPt];
                    fMesonSigndefaultBackFitError[k][iPt]              = TMath::Power( a*a + b*b, 0.5);
                } else {
                    fMesonSigndefaultBackFit[k][iPt]       = 0.;
                    fMesonSigndefaultBackFitError[k][iPt]  = 0.;
                }

                //Significance default SubPiZero
                if ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt] + fTotalBckYields_SubPiZero[k][iPt],0.5) != 0){
                    fMesonSigndefaultBackFit_SubPiZero[k][iPt]                   = fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]/TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt] + fTotalBckYields_SubPiZero[k][iPt],0.5);
                    Double_t a                                  = ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt] + fTotalBckYields_SubPiZero[k][iPt], -0.5) -
                                                                    0.5*fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt] +
                                                                    fTotalBckYields_SubPiZero[k][iPt], -1.5) * fMesonYieldsCorResidualBckFuncBackFitError_SubPiZero[k][iPt]);
                    Double_t b                                  = 0.5*fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_SubPiZero[k][iPt]
                                                                  + fTotalBckYields_SubPiZero[k][iPt],-1.5) * fTotalBckYieldsError_SubPiZero[k][iPt];
                    fMesonSigndefaultBackFitError_SubPiZero[k][iPt]              = TMath::Power( a*a + b*b, 0.5);
                } else {
                    fMesonSigndefaultBackFit_SubPiZero[k][iPt]       = 0.;
                    fMesonSigndefaultBackFitError_SubPiZero[k][iPt]  = 0.;
                }

                //Significance default FixedPzPiZero
                if ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt] + fTotalBckYields_FixedPzPiZero[k][iPt],0.5) != 0){
                    fMesonSigndefaultBackFit_FixedPzPiZero[k][iPt]                   = fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt]/TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt] + fTotalBckYields_FixedPzPiZero[k][iPt],0.5);
                    Double_t a                                  = ( TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt] + fTotalBckYields_FixedPzPiZero[k][iPt], -0.5) -
                                                                    0.5*fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt] +
                                                                    fTotalBckYields_FixedPzPiZero[k][iPt], -1.5) * fMesonYieldsCorResidualBckFuncBackFitError_FixedPzPiZero[k][iPt]);
                    Double_t b                                  = 0.5*fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt]*TMath::Power(fMesonYieldsCorResidualBckFuncBackFit_FixedPzPiZero[k][iPt]
                                                                  + fTotalBckYields_FixedPzPiZero[k][iPt],-1.5) * fTotalBckYieldsError_FixedPzPiZero[k][iPt];
                    fMesonSigndefaultBackFitError_FixedPzPiZero[k][iPt]              = TMath::Power( a*a + b*b, 0.5);
                } else {
                    fMesonSigndefaultBackFit_FixedPzPiZero[k][iPt]       = 0.;
                    fMesonSigndefaultBackFitError_FixedPzPiZero[k][iPt]  = 0.;
                }
            }
        ...
        if(fHistoMappingGGInvMassPtBin[iPt] && fHistoMappingBackInvMassPtBin[0][iPt]) {
            ProcessEM_switch( fHistoMappingGGInvMassPtBin[iPt], fHistoMappingBackInvMassPtBin[0][iPt], fBGFitRangeLeft); // only done for added background so far
       ...
       if( fHistoMappingGGInvMassPtBin_SubPiZero[iPt] && fHistoMappingBackInvMassPtBin_SubPiZero[0][iPt]) {
            ProcessEM_switch( fHistoMappingGGInvMassPtBin_SubPiZero[iPt], fHistoMappingBackInvMassPtBin_SubPiZero[0][iPt], fBGFitRangeLeft_SubPiZero); // only done for added background so far
       ...
       if( fHistoMappingGGInvMassPtBin_FixedPzPiZero[iPt] && fHistoMappingBackInvMassPtBin_FixedPzPiZero[0][iPt]) {
            ProcessEM_switch( fHistoMappingGGInvMassPtBin_FixedPzPiZero[iPt], fHistoMappingBackInvMassPtBin_FixedPzPiZero[0][iPt], fBGFitRangeLeft_FixedPzPiZero); // only done for added background so far
        ...
        if(fFitInvMassLeftPtBin[iPt]){
            Double_t sigma                                                      = fFitInvMassLeftPtBin[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitInvMassLeftPtBin[iPt]->GetParError(2);
            CalculateFWHM(fFitInvMassLeftPtBin[iPt],fMesonFitRange);
            fMesonFWHMLeft[iPt]                                                 = fFWHMFunc;
            fMesonFWHMLeftError[iPt]                                            = fFWHMFuncError;
            fMesonWidthLeft[iPt]                                                = sigma;
            fMesonWidthLeftError[iPt]                                           = sigma_err;
        } else{
        ...
        if(fFitInvMassLeftPtBin_SubPiZero[iPt]){
            Double_t sigma                                                      = fFitInvMassLeftPtBin_SubPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitInvMassLeftPtBin_SubPiZero[iPt]->GetParError(2);
            ...
            fMesonWidthLeft_SubPiZero[iPt]                                      = sigma;
            fMesonWidthLeftError_SubPiZero[iPt]                                 = sigma_err;
        } else{
        ...
        if(fFitInvMassLeftPtBin_FixedPzPiZero[iPt]){
            Double_t sigma                                                      = fFitInvMassLeftPtBin_FixedPzPiZero[iPt]->GetParameter(2);
            Double_t sigma_err                                                  = fFitInvMassLeftPtBin_FixedPzPiZero[iPt]->GetParError(2);
            ...
            fMesonWidthLeft_FixedPzPiZero[iPt]                                  = sigma;
            fMesonWidthLeftError_FixedPzPiZero[iPt]                             = sigma_err;
        } else{
    ...
    //---------------------------------------------------------------------------------------
    //--------------------------------End Analysis over Pt Bins------------------------------
    //---------------------------------------------------------------------------------------

    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; After Analysis Pt Bin Loop"<<endl;}
    //******************** Data OUTPUTFILE ***************************************************
    ...
    fileSysErrDat.close();
    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; After Data Outputfile"<<endl;}
    //******************************** OUTPUT END ******************************************************

    //********************************* PLOTTING *******************************************************
    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Before Plotting"<<endl;}
    ...
    if(((TString)fMesonCutSelection(1,1)).CompareTo("4")!=0){
        ...
        if(fIsMC){
            ...
            nameCanvasSub       = "MesonCanvasSubtracted";
            namePadSub          = "MesonPadSubtracted";
            if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBin_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fFitTrueSignalInvMassPtBin_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"fit of validated signal","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonTrueMass_SubPiZero, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
        }

        // Histos with residual background subtracted. Errors not correct. QA plot only

        // Meson Subtracted
        nameMesonSub        = Form("%s/%s_%s_MesonSignalOnly%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
        nameCanvasSub       = "MesonCanvasSubtracted";
        namePadSub          = "MesonPadSubtracted";
        PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBinResSubtracted, fHistoMappingTrueMesonInvMassPtBins, fFitSignalInvMassPtBin, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,NULL,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

        // Meson Subtracted minus InvMass pi0
        nameMesonSub        = Form("%s/%s_%s_MesonSignalOnly_SubPiZero_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
        nameCanvasSub       = "MesonCanvasSubtracted";
        namePadSub          = "MesonPadSubtracted";
        if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fFitSignalInvMassPtBin_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMass_SubPiZero,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

        // Meson Subtracted with pz of pi0 fixed
        nameMesonSub        = Form("%s/%s_%s_MesonSignalOnly_FixedPzPiZero_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
        nameCanvasSub       = "MesonCanvasSubtracted";
        namePadSub          = "MesonPadSubtracted";
        PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fFitSignalInvMassPtBin_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMass_FixedPzPiZero,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

        if(fIsMC){
            // Meson Subtracted with pz of pi0 fixed that shows fit of true signal instead of signal fit
            nameMesonSub        = Form("%s/%s_%s_MesonSignalOnly_FixedPzPiZero_TrueFit_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
            nameCanvasSub       = "MesonCanvasSubtracted";
            namePadSub          = "MesonPadSubtracted";
            if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fFitTrueSignalInvMassPtBin_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"fit of validated signal","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonTrueMass_FixedPzPiZero,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

            // Meson Subtracted with pz of pi0 fixed that shows fit of true signal instead of signal fit
            nameMesonSub        = Form("%s/%s_%s_MesonSignalOnly_SubPiZero_TrueFit_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
            nameCanvasSub       = "MesonCanvasSubtracted";
            namePadSub          = "MesonPadSubtracted";
            if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fFitTrueSignalInvMassPtBin_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"fit of validated signal","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonTrueMass_SubPiZero,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
        }
    }
    ...
    namePadSub                  = "MesonPadSubtractedBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fFitSignalInvMassBackFitPtBin_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","fitted background subtracted",kFALSE,fMesonMassBackFit_FixedPzPiZero,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
   ...
   // Meson Back Fit (minus pi0 inv mass)
    ...
    namePadSub                  = "MesonPadBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fBackgroundFitPol_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMassBackFit,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    namePadSub                  = "MesonPadBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fBackgroundFitPol_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMassBackFit,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

    // Meson Back Fit
    nameMesonSub                = Form("%s/%s_%s_MesonBackFitWithGauss%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
    nameCanvasSub               = "MesonCanvasBackFit";
    namePadSub                  = "MesonPadBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin, fHistoMappingTrueMesonInvMassPtBins, fBackgroundFitGaussPol, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMassBackFit,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

   // Meson Back Fit (minus pi0 inv mass)
    nameMesonSub                = Form("%s/%s_%s_MesonBackFitWithGauss_SubPiZero_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
    nameCanvasSub               = "MesonCanvasBackFit";
    namePadSub                  = "MesonPadBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fBackgroundFitGaussPol_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMassBackFit,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

    // Meson Back Fit (pz of pi0 fixed)
    nameMesonSub                = Form("%s/%s_%s_MesonBackFitWithGauss_FixedPzPiZero_%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(), fPeriodFlag.Data(), fCutSelection.Data(),Suffix.Data());
    nameCanvasSub               = "MesonCanvasBackFit";
    namePadSub                  = "MesonPadBackFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fBackgroundFitGaussPol_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}",kFALSE,fMesonMassBackFit,fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    namePadSub                  = "MesonPadWithBGAndFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_SubPiZero, fHistoMappingTrueMesonInvMassPtBins,fFitWithPol2ForBG_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE , fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    namePadSub                  = "MesonPadWithBGAndFit";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    PlotWithFitSubtractedInvMassInPtBins( fHistoMappingGGInvMassPtBin_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins,fFitWithPol2ForBG_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE , fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    namePadSub                  = "MesonPadSubtractedLeft";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassLeftPtBin_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fFitInvMassLeftPtBin_SubPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_SubPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    namePadSub                  = "MesonPadSubtractedLeft";
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting nameMesonSub: "<<nameMesonSub<<endl;}
    if(backAvailable) PlotWithFitSubtractedInvMassInPtBins( fHistoMappingSignalInvMassLeftPtBin_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fFitInvMassLeftPtBin_FixedPzPiZero, nameMesonSub, nameCanvasSub, namePadSub, fMesonMassRange_FixedPzPiZero, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, kFALSE, fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    if(backAvailable) PlotExampleInvMassBinsV2(fHistoMappingGGInvMassPtBin[fExampleBin], fHistoMappingSignalInvMassPtBin[fExampleBin], fHistoMappingBackNormInvMassPtBin[0][fExampleBin],
                        ...
                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig,kFALSE, NULL, -1, 0, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    // In example bin with pi0 inv mass subtracted

    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting PlotExampleInvMassBinsV2"<<endl;}
    if(backAvailable) PlotExampleInvMassBinsV2(fHistoMappingGGInvMassPtBin_SubPiZero[fExampleBin], fHistoMappingSignalInvMassPtBin_SubPiZero[fExampleBin], fHistoMappingBackNormInvMassPtBin_SubPiZero[0][fExampleBin],
                        ...
                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig,kFALSE,fBGFitRange_SubPiZero, -1, 0, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    if(backAvailable) PlotExampleInvMassBinsV2(fHistoMappingGGInvMassPtBin_FixedPzPiZero[fExampleBin], fHistoMappingSignalInvMassPtBin_FixedPzPiZero[fExampleBin], fHistoMappingBackNormInvMassPtBin_FixedPzPiZero[0][fExampleBin],
                        ...
                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig, kFALSE, fBGFitRange_FixedPzPiZero, -1, 0, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting PlotExampleInvMassBinsBckFit"<<endl;}
    if (doDebugOutputLevel>=3){
        cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fExampleBin: "<<fExampleBin<<endl;
        if (fHistoMappingGGInvMassBackFitPtBin[fExampleBin] == NULL){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; fHistoMappingGGInvMassBackFitPtBin[fExampleBin] == NULL"<<endl;}
    }
    PlotExampleInvMassBinsBckFit(fHistoMappingGGInvMassPtBin[fExampleBin], fHistoMappingGGInvMassBackFitPtBin[fExampleBin], fBackgroundFitPol[fExampleBin],fHistoBckFitConfidence[fExampleBin],
                        ...
                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig, kFALSE, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    // In example bin with pi0 inv mass subtracted
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting PlotExampleInvMassBinsBckFit; In example bin with pi0 inv mass subtracted"<<endl;}
    ...
    // In example bin with pz of pi0 fixed
    if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting PlotExampleInvMassBinsBckFit; In example bin with pz of pi0 fixed"<<endl;}
    ...
    if(((TString)fMesonCutSelection(1,1)).CompareTo("a")!=0){ //Do these plots only if LikeSign method was used
        ...
        if(backAvailable) PlotExampleInvMassBinsBckGroups(fHistoMappingGGInvMassPtBin[fExampleBin], fHistoMappingBackNormInvMassPtBin,fExampleBin, outputDir.Data(),Suffix.Data(), fMesonMassRange, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig ,"InvMassBinBckGroups");
        ...
        if(backAvailable) PlotExampleInvMassBinsBckGroups(fHistoMappingGGInvMassPtBin_SubPiZero[fExampleBin], fHistoMappingBackNormInvMassPtBin_SubPiZero,fExampleBin, outputDir.Data(),Suffix.Data(), fMesonMassRange_SubPiZero, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig ,"InvMassBinBckGroups_SubPiZero");
        ...
        if(backAvailable) PlotExampleInvMassBinsBckGroups(fHistoMappingGGInvMassPtBin_FixedPzPiZero[fExampleBin], fHistoMappingBackNormInvMassPtBin_FixedPzPiZero,fExampleBin, outputDir.Data(),Suffix.Data(), fMesonMassRange_FixedPzPiZero, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                        fThesis, fCollisionSystem, fBinsPt, fDecayChannel, fDetectionProcess, fTriggerInt, fExampleBinScaleFac, fMode, addSig ,"InvMassBinBckGroups_FixedPzPiZero");
    }

    if(fIsMC){
      if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting in fIsMC"<<endl;}
      ...
      if(fHistoMappingTruePiPlPiMiSameMotherInvMassPtBin[0]) PlotExampleInvMassSingleHistAndArray(fHistoMappingTruePiPlPiMiSameMotherInvMassPtBin[0][fStartPtBin],fHistoMappingTruePiPlPiMiSameMotherInvMassPtBin,1,7,0.46,2.0,fStartPtBin, outputDir.Data(),Suffix.Data(), fMesonMassRange_FixedPzPiZero, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                      fThesis, fCollisionSystem, fBinsPt, fDecayChannel,HistosLegendsTitlesPiPlPiMi[0],HistosLegendsTitlesPiPlPiMi,fDetectionProcess, 0, fExampleBinScaleFac, fMode, addSig ,"TrueBackPiPlPiMi_Contributions",kFALSE,1.);
      ...
      if(fHistoMappingTruePiPlPiZeroSameMotherInvMassPtBin[0]) PlotExampleInvMassSingleHistAndArray(fHistoMappingTruePiPlPiZeroSameMotherInvMassPtBin[0][fStartPtBin],fHistoMappingTruePiPlPiZeroSameMotherInvMassPtBin,1,5,0.46,2.0,fStartPtBin, outputDir.Data(),Suffix.Data(), fMesonMassRange_FixedPzPiZero, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                      fThesis, fCollisionSystem, fBinsPt, fDecayChannel,HistosLegendsTitlesPiPlPiZero[0],HistosLegendsTitlesPiPlPiZero,fDetectionProcess, 0, fExampleBinScaleFac, fMode, addSig ,"TrueBackPiPlPiZero_Contributions",kFALSE,1.);
      ...
      if(fHistoMappingTruePiMiPiZeroSameMotherInvMassPtBin[0]) PlotExampleInvMassSingleHistAndArray(fHistoMappingTruePiMiPiZeroSameMotherInvMassPtBin[0][fStartPtBin],fHistoMappingTruePiMiPiZeroSameMotherInvMassPtBin,1,5,0.46,2.0,fStartPtBin, outputDir.Data(),Suffix.Data(), fMesonMassRange_FixedPzPiZero, pictDrawingCoordinatesFWHM, fNEvents, fdate, fPrefix, fPrefix2,
                                      fThesis, fCollisionSystem, fBinsPt, fDecayChannel,HistosLegendsTitlesPiMiPiZero[0],HistosLegendsTitlesPiMiPiZero,fDetectionProcess, 0, fExampleBinScaleFac, fMode, addSig ,"TrueBackPiMiPiZero_Contributions",kFALSE,1.);

      // pi+pi-pi0 contributions
      cout << fHistoMappingTruePiPlPiMiSameMotherInvMassPtBin[0] << endl;
    ...
    //       tempPlotArray[1] = fHistoMappingTruePiPlPiZeroSameMotherInvMassPtBin[0][fStartPtBin];
    //       tempPlotArray[2] = fHistoMappingTruePiMiPiZeroSameMotherInvMassPtBin[0][fStartPtBin];
    //       tempPlotArray[3] = fHistoMappingTruePiPlPiMiSameMotherInvMassPtBin[0][fStartPtBin];
    ...
    if(fIsMC){
        ...
        nameMesonTrue   = Form("%s/%s_%s_TrueMesonFitted_SubPiZero%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(),fPeriodFlag.Data(),fCutSelection.Data(),Suffix.Data());
        nameCanvasTrue  = "TrueMesonCanvasFitted";
        namePadTrue     = "TrueMesonPadFitted";
        PlotWithFitSubtractedInvMassInPtBins(fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fHistoMappingTrueMesonInvMassPtBins_SubPiZero, fFitTrueSignalInvMassPtBin_SubPiZero, nameMesonTrue, nameCanvasTrue, namePadTrue, fMesonMassRange, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);

        nameMesonTrue   = Form("%s/%s_%s_TrueMesonFitted_FixedPzPiZero%s_%s.%s",outputDir.Data(),fPrefix.Data(),fPrefix2.Data(),fPeriodFlag.Data(),fCutSelection.Data(),Suffix.Data());
        nameCanvasTrue  = "TrueMesonCanvasFitted";
        namePadTrue     = "TrueMesonPadFitted";
        PlotWithFitSubtractedInvMassInPtBins(fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fHistoMappingTrueMesonInvMassPtBins_FixedPzPiZero, fFitTrueSignalInvMassPtBin_FixedPzPiZero, nameMesonTrue, nameCanvasTrue, namePadTrue, fMesonMassRange, fdate, fPrefix, fRow, fColumn, fStartPtBin, fNBinsPt, fBinsPt, fTextMeasurement, fIsMC,fDecayChannel, fDetectionProcess, fCollisionSystem,"MC validated signal",kTRUE,"Fit","mixed evt. subtr. #it{M}_{#pi^{+}#pi^{-}#pi^{0}}", kFALSE, NULL, fThesis, useFitIntDeltaRange, fMesonIntDeltaRangeByFit);
    ...
    if(fIsMC){
       ...
       for (Int_t k=0; k<3;k++){
        ...
        // efficiency calculation for fitted background + integration of gaussian
        fNameHistoEffi="MesonEffiBackFitFromFitPt";
        fHistoMonteMesonEffiBackFitFromFitPt                = CalculateMesonEfficiency(fHistoYieldMesonBackFitFromFit, fHistoMCMesonWithinAccepPt, fNameHistoEffi );

        fNameHistoEffi="MesonEffiBackFitFromFitPt_SubPiZero";
        fHistoMonteMesonEffiBackFitFromFitPt_SubPiZero      = CalculateMesonEfficiency(fHistoYieldMesonBackFitFromFit_SubPiZero, fHistoMCMesonWithinAccepPt, fNameHistoEffi );

        fNameHistoEffi="MesonEffiBackFitFromFitPt_FixedPzPiZero";
        fHistoMonteMesonEffiBackFitFromFitPt_FixedPzPiZero  = CalculateMesonEfficiency(fHistoYieldMesonBackFitFromFit_FixedPzPiZero, fHistoMCMesonWithinAccepPt, fNameHistoEffi );
    ...
    //Plot Parameters
    if (DoMonitoring){
        cout<<"Plotting monitoring"<<endl;
        if (fBackMixingMode.CompareTo("4")==0){
            DoMonitoringBackMixing      = kFALSE;
        }
        if (DoMonitoringBackMixing){
            cout<<"Plotting monitoring: Background mixing histograms"<<endl;
            ///*********************** Width FWHM
            if (DoMonitoring_WidthFWHM) {
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background mixing histograms: "<<" Plotting width FWHM"<<endl;}

                //Normal InvMass
                TCanvas* canvasFWHMMeson = new TCanvas("canvasFWHMMeson","",1550,1200);  // gives the page size
                canvasFWHMMeson->SetTickx();
                canvasFWHMMeson->SetTicky();
                ...
                canvasFWHMMeson->Update();

                TLegend* legendFWHMMeson = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMeson->AddEntry(fHistoFWHMMeson,Form("%s FWHM",fPrefix.Data()),"p");
                ...
                //Fixed Pz
                TCanvas* canvasFWHMMeson_FixedPzPiZero = new TCanvas("canvasFWHMMeson_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasFWHMMeson_FixedPzPiZero->SetTickx();
                canvasFWHMMeson_FixedPzPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMMeson_FixedPzPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMMeson_FixedPzPiZero,
                                          "", "p_{T} (GeV/c)","FWHM (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*4, // *4 because fMesonWidthRange[1] corresponds to fit parameter sigma, but histogram is FWHM
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueFWHMMeson_FixedPzPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueFWHMMeson_FixedPzPiZero->Draw("same,pe");
                }
                canvasFWHMMeson_FixedPzPiZero->Update();

                TLegend* legendFWHMMeson_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMeson_FixedPzPiZero->AddEntry(fHistoFWHMMeson_FixedPzPiZero,Form("%s FWHM",fPrefix.Data()),"p");
                ...
                //Sub Pi0
                TCanvas* canvasFWHMMeson_SubPiZero = new TCanvas("canvasFWHMMeson_SubPiZero","",1550,1200);  // gives the page size
                canvasFWHMMeson_SubPiZero->SetTickx();
                canvasFWHMMeson_SubPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMMeson_SubPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMMeson_SubPiZero,
                                          "", "p_{T} (GeV/c)","FWHM (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*4, // *4 because fMesonWidthRange[1] corresponds to fit parameter sigma, but histogram is FWHM
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueFWHMMeson_SubPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueFWHMMeson_SubPiZero->Draw("same,pe");
                }
                canvasFWHMMeson_SubPiZero->Update();

                TLegend* legendFWHMMeson_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMeson_SubPiZero->AddEntry(fHistoFWHMMeson_SubPiZero,Form("%s FWHM",fPrefix.Data()),"p");
            ...
            if (DoMonitoring_WidthFWHMToSigma) {
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background mixing histograms: "<<" Plotting width FWHMToSigma"<<endl;}
                //Normal InvMass
                TCanvas* canvasFWHMToSigmaMeson = new TCanvas("canvasFWHMToSigmaMeson","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMeson->SetTickx();
                canvasFWHMToSigmaMeson->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMeson, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMeson,
                                          "", "p_{T} (GeV/c)","Sigma as FWHM/2.3548 (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueFWHMToSigmaMeson, 24, 1., kRed+2, kRed+2);
                    fHistoTrueFWHMToSigmaMeson->Draw("same,pe");
                }
                canvasFWHMToSigmaMeson->Update();

                TLegend* legendFWHMToSigmaMeson = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMToSigmaMeson->AddEntry(fHistoFWHMToSigmaMeson,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
                ...
                //Fixed Pz
                TCanvas* canvasFWHMToSigmaMeson_FixedPzPiZero = new TCanvas("canvasFWHMToSigmaMeson_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMeson_FixedPzPiZero->SetTickx();
                canvasFWHMToSigmaMeson_FixedPzPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMeson_FixedPzPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMeson_FixedPzPiZero,
                                          "", "p_{T} (GeV/c)","Sigma as FWHM/2.3548 (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueFWHMToSigmaMeson_FixedPzPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueFWHMToSigmaMeson_FixedPzPiZero->Draw("same,pe");
                }
                canvasFWHMToSigmaMeson_FixedPzPiZero->Update();

                TLegend* legendFWHMToSigmaMeson_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMToSigmaMeson_FixedPzPiZero->AddEntry(fHistoFWHMToSigmaMeson_FixedPzPiZero,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
                ...
                //Sub Pi0
                TCanvas* canvasFWHMToSigmaMeson_SubPiZero = new TCanvas("canvasFWHMToSigmaMeson_SubPiZero","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMeson_SubPiZero->SetTickx();
                canvasFWHMToSigmaMeson_SubPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMeson_SubPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMeson_SubPiZero,
                                          "", "p_{T} (GeV/c)","Sigma as FWHM/2.3548 (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueFWHMToSigmaMeson_SubPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueFWHMToSigmaMeson_SubPiZero->Draw("same,pe");
                }
                canvasFWHMToSigmaMeson_SubPiZero->Update();

                TLegend* legendFWHMToSigmaMeson_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMToSigmaMeson_SubPiZero->AddEntry(fHistoFWHMToSigmaMeson_SubPiZero,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
            ...
            if (DoMonitoring_WidthSigma) {
                ...
                //Normal InvMass
                TCanvas* canvasWidthMeson = new TCanvas("canvasWidthMeson","",1550,1200);  // gives the page size
                canvasWidthMeson->SetTickx();
                canvasWidthMeson->SetTicky();

                DrawGammaSetMarker(fHistoWidthMeson, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoWidthMeson,
                                          "", "p_{T} (GeV/c)","Width(#sigma) (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.3,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueWidthMeson, 24, 1., kRed+2, kRed+2);
                    fHistoTrueWidthMeson->Draw("same,pe");
                }
                canvasWidthMeson->Update();

                TLegend* legendWidthMeson = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendWidthMeson->AddEntry(fHistoWidthMeson,Form("%s #sigma",fPrefix.Data()),"p");
                ...
                //Fixed Pz
                TCanvas* canvasWidthMeson_FixedPzPiZero = new TCanvas("canvasWidthMeson_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasWidthMeson_FixedPzPiZero->SetTickx();
                canvasWidthMeson_FixedPzPiZero->SetTicky();

                DrawGammaSetMarker(fHistoWidthMeson_FixedPzPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoWidthMeson_FixedPzPiZero,
                                          "", "p_{T} (GeV/c)","Width(#sigma) (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.3,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueWidthMeson_FixedPzPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueWidthMeson_FixedPzPiZero->Draw("same,pe");
                }
                canvasWidthMeson_FixedPzPiZero->Update();

                TLegend* legendWidthMeson_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendWidthMeson_FixedPzPiZero->AddEntry(fHistoWidthMeson_FixedPzPiZero,Form("%s #sigma",fPrefix.Data()),"p");
                ...
                //Sub Pi0
                TCanvas* canvasWidthMeson_SubPiZero = new TCanvas("canvasSigmaMeson_SubPiZero","",1550,1200);  // gives the page size
                canvasWidthMeson_SubPiZero->SetTickx();
                canvasWidthMeson_SubPiZero->SetTicky();

                DrawGammaSetMarker(fHistoWidthMeson_SubPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoWidthMeson_SubPiZero,
                                          "", "p_{T} (GeV/c)","Width(#sigma) (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.3,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                    DrawGammaSetMarker(fHistoTrueWidthMeson_SubPiZero, 24, 1., kRed+2, kRed+2);
                    fHistoTrueWidthMeson_SubPiZero->Draw("same,pe");
                }
                canvasWidthMeson_SubPiZero->Update();

                TLegend* legendWidthMeson_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendWidthMeson_SubPiZero->AddEntry(fHistoWidthMeson_SubPiZero,Form("%s #sigma",fPrefix.Data()),"p");
        ...
        if (DoMonitoringBackFit){
            cout<<"Plotting monitoring: Background fitting without mixing"<<endl;
            ///*********************** Width FWHM
            if (DoMonitoring_WidthFWHM) {
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Plotting width FWHM"<<endl;}
                //Normal InvMass
                TCanvas* canvasFWHMMesonBackFit = new TCanvas("canvasFWHMMesonBackFit","",1550,1200);  // gives the page size
                canvasFWHMMesonBackFit->SetTickx();
                canvasFWHMMesonBackFit->SetTicky();

                DrawGammaSetMarker(fHistoFWHMMesonBackFit, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMMesonBackFit,
                                          "", "p_{T} (GeV/c)","FWHM (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*4, // *4 because fMesonWidthRange[1] corresponds to fit parameter sigma, but histogram is FWHM
                        kFALSE, 0., 10.);
                ...
                canvasFWHMMesonBackFit->Update();

                TLegend* legendFWHMMesonBackFit = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMesonBackFit->AddEntry(fHistoFWHMMesonBackFit,Form("%s FWHM",fPrefix.Data()),"p");
                ...
                //Fixed Pz
                TCanvas* canvasFWHMMesonBackFit_FixedPzPiZero = new TCanvas("canvasFWHMMesonBackFit_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasFWHMMesonBackFit_FixedPzPiZero->SetTickx();
                canvasFWHMMesonBackFit_FixedPzPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMMesonBackFit_FixedPzPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMMesonBackFit_FixedPzPiZero,
                                          "", "p_{T} (GeV/c)","FWHM (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*4, // *4 because fMesonWidthRange[1] corresponds to fit parameter sigma, but histogram is FWHM
                        kFALSE, 0., 10.);
                ...
                canvasFWHMMesonBackFit_FixedPzPiZero->Update();

                TLegend* legendFWHMMesonBackFit_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMesonBackFit_FixedPzPiZero->AddEntry(fHistoFWHMMesonBackFit_FixedPzPiZero,Form("%s FWHM",fPrefix.Data()),"p");
                ...
                //Sub Pi0
                TCanvas* canvasFWHMMesonBackFit_SubPiZero = new TCanvas("canvasFWHMMesonBackFit_SubPiZero","",1550,1200);  // gives the page size
                canvasFWHMMesonBackFit_SubPiZero->SetTickx();
                canvasFWHMMesonBackFit_SubPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMMesonBackFit_SubPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMMesonBackFit_SubPiZero,
                                          "", "p_{T} (GeV/c)","FWHM (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*4, // *4 because fMesonWidthRange[1] corresponds to fit parameter sigma, but histogram is FWHM
                        kFALSE, 0., 10.);
                ...
                canvasFWHMMesonBackFit_SubPiZero->Update();

                TLegend* legendFWHMMesonBackFit_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendFWHMMesonBackFit_SubPiZero->AddEntry(fHistoFWHMMesonBackFit_SubPiZero,Form("%s FWHM",fPrefix.Data()),"p");
            ...
            ///*********************** Width Sigma
            if (DoMonitoring_WidthFWHMToSigma) {
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Plotting width FWHMToSigma"<<endl;}
                //Normal InvMass
                TCanvas* canvasFWHMToSigmaMesonBackFit = new TCanvas("canvasFWHMToSigmaMesonBackFit","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMesonBackFit->SetTickx();
                canvasFWHMToSigmaMesonBackFit->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMesonBackFit, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMesonBackFit,
                                          "", "p_{T} (GeV/c)","FWHMToSigma (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                if (fIsMC > 0){
                ...
                if (useFitIntDeltaRange){
                    DrawGammaSetMarker(fHistoWidthFitBinValues, 24, 1., kBlue+2, kBlue+2);
                    fHistoWidthFitBinValues->Draw("same,pe");
                }
                canvasFWHMToSigmaMesonBackFit->Update();

                TLegend* legendFWHMToSigmaMesonBackFit = GetAndSetLegend2(0.2,0.12,0.45,0.3, 0.04*1200,1);
                legendFWHMToSigmaMesonBackFit->AddEntry(fHistoFWHMToSigmaMesonBackFit,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
                if(fIsMC) legendFWHMToSigmaMesonBackFit->AddEntry(fHistoTrueFWHMToSigmaMeson,"True MC","p");
                if (useFitIntDeltaRange){legendFWHMToSigmaMesonBackFit->AddEntry(fHistoWidthFitBinValues,"Omega Width from external Fit","p");}
                ...
                //Fixed Pz
                TCanvas* canvasFWHMToSigmaMesonBackFit_FixedPzPiZero = new TCanvas("canvasFWHMToSigmaMesonBackFit_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMesonBackFit_FixedPzPiZero->SetTickx();
                canvasFWHMToSigmaMesonBackFit_FixedPzPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero,
                                          "", "p_{T} (GeV/c)","FWHMToSigma (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                ...
                canvasFWHMToSigmaMesonBackFit_FixedPzPiZero->Update();

                TLegend* legendFWHMToSigmaMesonBackFit_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.3, 0.04*1200,1);
                legendFWHMToSigmaMesonBackFit_FixedPzPiZero->AddEntry(fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
                if(fIsMC) legendFWHMToSigmaMesonBackFit_FixedPzPiZero->AddEntry(fHistoTrueFWHMToSigmaMeson_FixedPzPiZero,"True MC","p");
                if (useFitIntDeltaRange){legendFWHMToSigmaMesonBackFit_FixedPzPiZero->AddEntry(fHistoWidthFitBinValues,"Omega Width from external Fit","p");}
                ...
                //Sub Pi0
                TCanvas* canvasFWHMToSigmaMesonBackFit_SubPiZero = new TCanvas("canvasFWHMToSigmaMesonBackFit_SubPiZero","",1550,1200);  // gives the page size
                canvasFWHMToSigmaMesonBackFit_SubPiZero->SetTickx();
                canvasFWHMToSigmaMesonBackFit_SubPiZero->SetTicky();

                DrawGammaSetMarker(fHistoFWHMToSigmaMesonBackFit_SubPiZero, 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoFWHMToSigmaMesonBackFit_SubPiZero,
                                          "", "p_{T} (GeV/c)","FWHMToSigma (GeV/c^{2})",
                                          kFALSE, 3.,0., kFALSE,
                                          kTRUE, -0.004, fMesonWidthRange[1]*1.35,
                        kFALSE, 0., 10.);
                ...
                canvasFWHMToSigmaMesonBackFit_SubPiZero->Update();

                TLegend* legendFWHMToSigmaMesonBackFit_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.3, 0.04*1200,1);
                legendFWHMToSigmaMesonBackFit_SubPiZero->AddEntry(fHistoFWHMToSigmaMesonBackFit_SubPiZero,Form("%s #sigma as FWHM/2.3548",fPrefix.Data()),"p");
                if(fIsMC) legendFWHMToSigmaMesonBackFit_SubPiZero->AddEntry(fHistoTrueFWHMToSigmaMeson_SubPiZero,"True MC","p");
                if (useFitIntDeltaRange){legendFWHMToSigmaMesonBackFit_SubPiZero->AddEntry(fHistoWidthFitBinValues,"Omega Width from external Fit","p");}
            ...
            if (DoMonitoring_Mass) {
                ...
                if (useFitIntDeltaRange){
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitUpper, 24, 1., kBlue+2, kBlue+2);
                    fHistoIntDeltaRangeBackFitByFitUpper->Draw("same,pe");
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitLower, 24, 1., kBlue-2, kBlue-2);
                    fHistoIntDeltaRangeBackFitByFitLower->Draw("same,pe");
                }
                canvasMesonMassBackFit->Update();

                TLegend* legendMesonMassBackFit = GetAndSetLegend2(0.15,0.74,0.4,0.94, 0.04*1200,1);
                ...
                if (useFitIntDeltaRange){
                    legendMesonMassBackFit->AddEntry(fHistoIntDeltaRangeBackFitByFitUpper,"Normal Integration Window from external Fit, Upper","p");
                    legendMesonMassBackFit->AddEntry(fHistoIntDeltaRangeBackFitByFitLower,"Normal Integration Window from external Fit, Lower","p");
                }
                ...
                if (useFitIntDeltaRange){
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero, 24, 1., kBlue+2, kBlue+2);
                    fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero->Draw("same,pe");
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero, 24, 1., kBlue-2, kBlue-2);
                    fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero->Draw("same,pe");
                }
                canvasMesonMassBackFit_FixedPzPiZero->Update();

                TLegend* legendMesonMassBackFit_FixedPzPiZero = GetAndSetLegend2(0.15,0.74,0.4,0.94, 0.04*1200,1);
                ...
                if (useFitIntDeltaRange){
                    legendMesonMassBackFit_FixedPzPiZero->AddEntry(fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero,"Normal Integration Window from external Fit, Upper","p");
                    legendMesonMassBackFit_FixedPzPiZero->AddEntry(fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero,"Normal Integration Window from external Fit, Lower","p");
                }
                ...
                if (useFitIntDeltaRange){
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero, 24, 1., kBlue+2, kBlue+2);
                    fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero->Draw("same,pe");
                    DrawGammaSetMarker(fHistoIntDeltaRangeBackFitByFitLower_SubPiZero, 24, 1., kBlue-2, kBlue-2);
                    fHistoIntDeltaRangeBackFitByFitLower_SubPiZero->Draw("same,pe");
                }
                canvasMesonMassBackFit_SubPiZero->Update();

                TLegend* legendMesonMassBackFit_SubPiZero = GetAndSetLegend2(0.15,0.74,0.4,0.94, 0.04*1200,1);
                ...
                if (useFitIntDeltaRange){
                    legendMesonMassBackFit_SubPiZero->AddEntry(fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero,"Normal Integration Window from external Fit, Upper","p");
                    legendMesonMassBackFit_SubPiZero->AddEntry(fHistoIntDeltaRangeBackFitByFitLower_SubPiZero,"Normal Integration Window from external Fit, Lower","p");
                }
            ...
            if (DoMonitoring_BackFitSignalToBG){
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Signal To Background Ratio"<<endl;}

                //Normal InvMass
                TCanvas* canvasSBBackFit = new TCanvas("canvasSBBackFit","",1550,1200);  // gives the page size
                canvasSBBackFit->SetTickx();
                canvasSBBackFit->SetTicky();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit[0],
                                          "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSBBackFit->Update();
                TLegend* legendSBBackFit = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFit->AddEntry(fHistoSBdefaultMesonBackFit[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFit->Draw();

                if (fIsMC) canvasSBBackFit->SaveAs(Form("%s/%s_MC_SB_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFit->SaveAs(Form("%s/%s_data_SB_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //FixedPzPiZero
                TCanvas* canvasSBBackFit_FixedPzPiZero = new TCanvas("canvasSBBackFit_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasSBBackFit_FixedPzPiZero->SetTickx();
                canvasSBBackFit_FixedPzPiZero->SetTicky();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit_FixedPzPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit_FixedPzPiZero[0],
                                          "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSBBackFit_FixedPzPiZero->Update();
                TLegend* legendSBBackFit_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFit_FixedPzPiZero->AddEntry(fHistoSBdefaultMesonBackFit_FixedPzPiZero[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFit_FixedPzPiZero->Draw();

                if (fIsMC) canvasSBBackFit_FixedPzPiZero->SaveAs(Form("%s/%s_MC_SB_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFit_FixedPzPiZero->SaveAs(Form("%s/%s_data_SB_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //SubPiZero
                TCanvas* canvasSBBackFit_SubPiZero = new TCanvas("canvasSBBackFit_SubPiZero","",1550,1200);  // gives the page size
                canvasSBBackFit_SubPiZero->SetTickx();
                canvasSBBackFit_SubPiZero->SetTicky();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit_SubPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit_SubPiZero[0],
                                          "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSBBackFit_SubPiZero->Update();
                TLegend* legendSBBackFit_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFit_SubPiZero->AddEntry(fHistoSBdefaultMesonBackFit_SubPiZero[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFit_SubPiZero->Draw();

                if (fIsMC) canvasSBBackFit_SubPiZero->SaveAs(Form("%s/%s_MC_SB_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFit_SubPiZero->SaveAs(Form("%s/%s_data_SB_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                //-----------------------------------------------------------
                //LogScale
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Signal To Background Ratio Log Scale"<<endl;}

                //Normal InvMass
                TCanvas* canvasSBBackFitLog = new TCanvas("canvasSBBackFit","",1550,1200);  // gives the page size
                canvasSBBackFitLog->SetTickx();
                canvasSBBackFitLog->SetTicky();
                canvasSBBackFitLog->SetLogy();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit[0],
                        "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSBBackFitLog->Update();
                TLegend* legendSBBackFitLog = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFitLog->AddEntry(fHistoSBdefaultMesonBackFit[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFitLog->Draw();

                if (fIsMC) canvasSBBackFitLog->SaveAs(Form("%s/%s_MC_SB_Log_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFitLog->SaveAs(Form("%s/%s_data_SB_Log_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //FixedPzPiZero
                TCanvas* canvasSBBackFitLog_FixedPzPiZero = new TCanvas("canvasSBBackFitLog_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasSBBackFitLog_FixedPzPiZero->SetTickx();
                canvasSBBackFitLog_FixedPzPiZero->SetTicky();
                canvasSBBackFitLog_FixedPzPiZero->SetLogy();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit_FixedPzPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit_FixedPzPiZero[0],
                        "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSBBackFitLog_FixedPzPiZero->Update();
                TLegend* legendSBBackFitLog_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFitLog_FixedPzPiZero->AddEntry(fHistoSBdefaultMesonBackFit_FixedPzPiZero[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFitLog_FixedPzPiZero->Draw();

                if (fIsMC) canvasSBBackFitLog_FixedPzPiZero->SaveAs(Form("%s/%s_MC_SB_Log_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFitLog_FixedPzPiZero->SaveAs(Form("%s/%s_data_SB_Log_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //SubPiZero
                TCanvas* canvasSBBackFitLog_SubPiZero = new TCanvas("canvasSBBackFitLog_SubPiZero","",1550,1200);  // gives the page size
                canvasSBBackFitLog_SubPiZero->SetTickx();
                canvasSBBackFitLog_SubPiZero->SetTicky();
                canvasSBBackFitLog_SubPiZero->SetLogy();
                DrawGammaSetMarker(fHistoSBdefaultMesonBackFit_SubPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSBdefaultMesonBackFit_SubPiZero[0],
                        "", "p_{T} (GeV/c)", "Signal to Background Ratio",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSBBackFitLog_SubPiZero->Update();
                TLegend* legendSBBackFitLog_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSBBackFitLog_SubPiZero->AddEntry(fHistoSBdefaultMesonBackFit_SubPiZero[0],Form("SB parameter for %s",fPrefix.Data()),"p");
                legendSBBackFit_SubPiZero->Draw();

                if (fIsMC) canvasSBBackFitLog_SubPiZero->SaveAs(Form("%s/%s_MC_SB_Log_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSBBackFitLog_SubPiZero->SaveAs(Form("%s/%s_data_SB_Log_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
            }
            ///*********************** Significance
            if (DoMonitoring_BackFitSignificance){
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Significance"<<endl;}

                //Normal InvMass
                TCanvas* canvasSigndefaultBackFit = new TCanvas("canvasSigndefaultBackFit","",1550,1200);  // gives the page size
                canvasSigndefaultBackFit->SetTickx();
                canvasSigndefaultBackFit->SetTicky();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit[0],
                                          "", "p_{T} (GeV/c)", "Significance",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSigndefaultBackFit->Update();
                TLegend* legendSigndefaultBackFit = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFit->AddEntry(fHistoSigndefaultMesonBackFit[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFit->Draw();

                if (fIsMC) canvasSigndefaultBackFit->SaveAs(Form("%s/%s_MC_Significance_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFit->SaveAs(Form("%s/%s_data_Significance_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //FixedPzPiZero
                TCanvas* canvasSigndefaultBackFit_FixedPzPiZero = new TCanvas("canvasSigndefaultBackFit_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasSigndefaultBackFit_FixedPzPiZero->SetTickx();
                canvasSigndefaultBackFit_FixedPzPiZero->SetTicky();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit_FixedPzPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit_FixedPzPiZero[0],
                                          "", "p_{T} (GeV/c)", "Significance",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSigndefaultBackFit_FixedPzPiZero->Update();
                TLegend* legendSigndefaultBackFit_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFit_FixedPzPiZero->AddEntry(fHistoSigndefaultMesonBackFit_FixedPzPiZero[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFit_FixedPzPiZero->Draw();

                if (fIsMC) canvasSigndefaultBackFit_FixedPzPiZero->SaveAs(Form("%s/%s_MC_Significance_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFit_FixedPzPiZero->SaveAs(Form("%s/%s_data_Significance_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //SubPiZero
                TCanvas* canvasSigndefaultBackFit_SubPiZero = new TCanvas("canvasSigndefaultBackFit_SubPiZero","",1550,1200);  // gives the page size
                canvasSigndefaultBackFit_SubPiZero->SetTickx();
                canvasSigndefaultBackFit_SubPiZero->SetTicky();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit_SubPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit_SubPiZero[0],
                                          "", "p_{T} (GeV/c)", "Significance",
                                          kFALSE, 3.,0.,  kTRUE,
                                          kFALSE, 0., 0.,
                                          kFALSE, 0., 10.);
                canvasSigndefaultBackFit_SubPiZero->Update();
                TLegend* legendSigndefaultBackFit_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFit_SubPiZero->AddEntry(fHistoSigndefaultMesonBackFit_SubPiZero[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFit_SubPiZero->Draw();

                if (fIsMC) canvasSigndefaultBackFit_SubPiZero->SaveAs(Form("%s/%s_MC_Significance_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFit_SubPiZero->SaveAs(Form("%s/%s_data_Significance_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                //-----------------------------------------------------------
                //LogScale
                if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Plotting monitoring: Background fitting without mixing: "<<" Significance Log Scale"<<endl;}

                //Normal InvMass
                TCanvas* canvasSigndefaultBackFitLog = new TCanvas("canvasSigndefaultBackFitLog","",1550,1200);  // gives the page size
                canvasSigndefaultBackFitLog->SetTickx();
                canvasSigndefaultBackFitLog->SetTicky();
                canvasSigndefaultBackFitLog->SetLogy();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit[0],
                        "", "p_{T} (GeV/c)", "Significance",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSigndefaultBackFitLog->Update();
                TLegend* legendSigndefaultBackFitLog = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFitLog->AddEntry(fHistoSigndefaultMesonBackFit[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFitLog->Draw();

                if (fIsMC) canvasSigndefaultBackFitLog->SaveAs(Form("%s/%s_MC_Significance_Log_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFitLog->SaveAs(Form("%s/%s_data_Significance_Log_%s.%s",outputDirMon_BackFit_Std.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //FixedPzPiZero
                TCanvas* canvasSigndefaultBackFitLog_FixedPzPiZero = new TCanvas("canvasSigndefaultBackFitLog_FixedPzPiZero","",1550,1200);  // gives the page size
                canvasSigndefaultBackFitLog_FixedPzPiZero->SetTickx();
                canvasSigndefaultBackFitLog_FixedPzPiZero->SetTicky();
                canvasSigndefaultBackFitLog_FixedPzPiZero->SetLogy();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit_FixedPzPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit_FixedPzPiZero[0],
                        "", "p_{T} (GeV/c)", "Significance",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSigndefaultBackFitLog_FixedPzPiZero->Update();
                TLegend* legendSigndefaultBackFitLog_FixedPzPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFitLog_FixedPzPiZero->AddEntry(fHistoSigndefaultMesonBackFit_FixedPzPiZero[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFitLog_FixedPzPiZero->Draw();

                if (fIsMC) canvasSigndefaultBackFitLog_FixedPzPiZero->SaveAs(Form("%s/%s_MC_Significance_Log_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFitLog_FixedPzPiZero->SaveAs(Form("%s/%s_data_Significance_Log_%s.%s",outputDirMon_BackFit_FixedPzPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));

                //SubPiZero
                TCanvas* canvasSigndefaultBackFitLog_SubPiZero = new TCanvas("canvasSigndefaultBackFitLog_SubPiZero","",1550,1200);  // gives the page size
                canvasSigndefaultBackFitLog_SubPiZero->SetTickx();
                canvasSigndefaultBackFitLog_SubPiZero->SetTicky();
                canvasSigndefaultBackFitLog_SubPiZero->SetLogy();
                DrawGammaSetMarker(fHistoSigndefaultMesonBackFit_SubPiZero[0], 20, 1., kBlack, kBlack);
                DrawAutoGammaMesonHistos( fHistoSigndefaultMesonBackFit_SubPiZero[0],
                        "", "p_{T} (GeV/c)", "Significance",
                        kFALSE, 3.,0.,  kTRUE,
                        kFALSE, 0., 0.,
                        kFALSE, 0., 10.);
                canvasSigndefaultBackFitLog_SubPiZero->Update();
                TLegend* legendSigndefaultBackFitLog_SubPiZero = GetAndSetLegend2(0.2,0.12,0.45,0.2, 0.04*1200,1);
                legendSigndefaultBackFitLog_SubPiZero->AddEntry(fHistoSigndefaultMesonBackFit_SubPiZero[0],Form("Significance parameter for %s",fPrefix.Data()),"p");
                legendSigndefaultBackFit_SubPiZero->Draw();

                if (fIsMC) canvasSigndefaultBackFitLog_SubPiZero->SaveAs(Form("%s/%s_MC_Significance_Log_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
                else canvasSigndefaultBackFitLog_SubPiZero->SaveAs(Form("%s/%s_data_Significance_Log_%s.%s",outputDirMon_BackFit_SubPiZero.Data(),fPrefix.Data(),fCutSelection.Data(),Suffix.Data()));
            }
        }
    } // Plot Parameters Ended
    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Before SaveHistos"<<endl;}
    SaveHistos(fIsMC, fCutSelection, fPrefix2);
    fFileErrLog.close();
    fFileDataLog.close();
    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; Line: "<<__LINE__<<"; Before Delete"<<endl;}
    Delete();
}
...
void ProcessBckFitSubtraction(TH1D *fGammaGamma, Int_t i, Double_t * fPeakRangeDummy, Double_t *fFitRangeDummy, TString energy, TString suffix, TString cutSelection, TString meson,Int_t InvMassType){
    ...
    if (doDebugOutputLevel>=1){
        ...
        cout<<"\t fPeakRangeDummy[0]"<<fPeakRangeDummy[0]<<"; fPeakRangeDummy[1]"<<fPeakRangeDummy[1]<<endl;
        cout<<"\t fFitRangeDummy[0]"<<fFitRangeDummy[0]<<"; fFitRangeDummy[1]"<<fFitRangeDummy[1]<<endl;
        cout<<"\t fTotalBackFitMode: "<<fTotalBackFitMode<<endl;
    }
    ...
    // Test for RooFit, possible to use for future developmnets, not working fully yet
    // --- Observable ---

    TF1* RooFitBckGauss = NULL;
    TF1* RooFitBckOnly = NULL;
    if(fTotalBackFitMode == 4){
        RooRealVar mes("mes","m_{ES} (GeV)",fFitRangeDummy[0],fFitRangeDummy[1]);


        // --- Parameters ---
        RooRealVar sigmean("sigmean","#omega mass",fMesonMassExpect,fMesonMassExpect*0.8,fMesonMassExpect*1.2);
        RooRealVar sigwidth("sigwidth","#omega width",0.02,0.01,0.06);

        // --- Build Gaussian PDF ---
        RooGaussian signalModel("signal","signal PDF",mes,sigmean,sigwidth);

        RooRealVar c0("c0","coefficient #0", 10.,-100.,100.) ;
        RooRealVar c1("c1","coefficient #1", 10.,-100.,100.) ;
        RooPolynomial bkgpoly("bkgpoly","background p.d.f.",mes,RooArgList(c0,c1)) ; 
        
        RooRealVar a("a","coefficient #0", 10.,-100.,100.) ;
        RooRealVar b("b","coefficient #1", 10.,-100.,100.) ;
        RooPolynomial bkgpolyOnly("bkgpolyOnly","background p.d.f.",mes,RooArgList(a,b)) ; 
        
        RooRealVar lambda("lambda", "slope", 0.1, 20., 0.);
        RooExponential bkgexpo("bkg","background p.d.f.",mes,lambda) ; 
        ...
        // Get TF1, however it's from a PDF so normalized to 1
        // this right now is the main problem since it can not be properly scaled back
        RooFitBckGauss = (TF1*) model.asTF(RooArgList(mes),RooArgList(c0,c1,sigmean,sigwidth),RooArgList(mes));
        RooFitBckOnly= (TF1*) bkgpoly.asTF(RooArgList(mes),RooArgList(c0,c1),RooArgList(mes));
    }

    // Loop over histo in fitrange to find min and max bin
    Int_t startBin = fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->FindBin(fPeakRangeDummy[0]);
    Int_t endBin = fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->FindBin(fPeakRangeDummy[1]);
    Int_t maxContentBin=startBin;
    Int_t minContentBin=startBin;
    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; startBin: "<<startBin<<"; endBin: "<<endBin<<endl;}

    Float_t minContent = fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetBinContent(startBin);
    Float_t maxContent = fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetBinContent(startBin);

    if (doDebugOutputLevel>=1){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; minContent: "<<minContent<<"; maxContent: "<<maxContent<<endl;}
    for (Int_t binx= startBin; binx < endBin+1; binx++){
           Float_t currContent = fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetBinContent(binx);
           if(currContent<minContent) {
               minContent = currContent;
               minContentBin=binx;
           }
    ...
    if(fTotalBackFitMode == 3) {
        ...
        if( (FitPol2Gauss->GetParameter(3)<fMesonMassExpect*0.95) || (FitPol2Gauss->GetParameter(4)<fMesonMassExpect*0.95)){
            ...
            FitPol2Gauss->SetParameter(3,fMesonMassExpect);
            FitPol2Gauss->FixParameter(3,fMesonMassExpect);
            FitPol2Gauss->SetParError(3,0.);
        }
        if (doDebugOutputLevel>=3){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; fFitRangeDummy[0]: "<<fFitRangeDummy[0]<<"; fFitRangeDummy[1]: "<<fFitRangeDummy[1]<<endl;}
        if (doDebugOutputLevel>=3){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; resultBckFitTotal =fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->Fit(FitPol2Gauss,\"QMRES0\",\"\",fFitRangeDummy[0],fFitRangeDummy[1]);//QMRES0"<<endl;}
         resultBckFitTotal =fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->Fit(FitPol2Gauss,"QMRES0","",fFitRangeDummy[0],fFitRangeDummy[1]);//QMRES0
    ...
    if(InvMassType==0){
      ...
      if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; For background subtraction"<<endl;}
      fBackgroundFitPol[i]->SetParameters(FitParamsPol);
      if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; For background subtraction"<<endl;}
      fBackgroundFitPol[i]->SetRange(fFitRangeDummy[0],fFitRangeDummy[1]);

      // for plotting
      if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<"; for plotting"<<endl;}
      ...
      } else{ // copy to avoid crashes if accidently plottet
        if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<" "<<endl;}
        fBackgroundFitGaussPol[i] = fBackgroundFitPol[i];
      }
      if (doDebugOutputLevel>=2){cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction(); Line: "<<__LINE__<<" "<<endl;}
      ...
      fBackgroundFitPol_SubPiZero[i]->SetParErrors(FitParamErr);
      fBackgroundFitPol_SubPiZero[i]->SetRange(fFitRangeDummy[0],fFitRangeDummy[1]);
      ...
      if((fTotalBackFitMode!=1 )&&(fTotalBackFitMode!=5 )&&(fTotalBackFitMode!=7 )){ // not needed if Gauss wasn't used
        ...
        fBackgroundFitGaussPol_SubPiZero[i] = fBackgroundFitPol_SubPiZero[i];
      }      
      ...
      if((fTotalBackFitMode!=1 )&&(fTotalBackFitMode!=5 )&&(fTotalBackFitMode!=7 )){ // not needed if Gauss wasn't used
        ...
        fBackgroundFitGaussPol_FixedPzPiZero[i] = fBackgroundFitPol_FixedPzPiZero[i];
      }
      for (Int_t binx= 0; binx < fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetNbinsX()+1; binx++){
          if(fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetBinCenter(binx) > fFitRangeDummy[0] && fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->GetBinCenter(binx) < fFitRangeDummy[1]){
...
void ProcessBckFitSubtraction_CombinatoricsAndContamination(TH1D *fGammaGamma, TH1D *fCombinatorics, TH1D *fContamination, Int_t i, Double_t * fPeakRangeDummy, Double_t *fFitRangeDummy, TString energy, TString suffix, TString cutSelection, TString meson,Int_t InvMassType, TH1D* fTrueCombinatorics, TH1D* fTrueContamination){
    ...
    resultBckFitTotal =fHistoMappingGGInvMassBackFitWithoutSignalPtBin[i]->Fit(FitCombinatoricalContamination,"QMRES0","",fFitRangeDummy[0],fFitRangeDummy[1]);//QMRES0

    double* FitParams;
    FitParams = new double [2];

    if(InvMassType==0){
      // For background subtraction
      fBackgroundFitPol[i] = NULL;
      fBackgroundFitPol[i] = new TF1  (Form("FitCombinatoricalContamination_%i", i),tempBckClass,fFitRangeDummy[0],fFitRangeDummy[1], 2);
      FitCombinatoricalContamination->GetParameters(&FitParams[0]);
      cout<<"FitParams: "<<" 0.) "<<FitParams[0]<<" 1.) "<<FitParams[1]<<endl;
    ...
    gSystem->mkdir("Debug");
      c1->Print(Form("%s/%s_%s_PolSubtraction_%i.png","Debug",fPrefix.Data(),fPrefix2.Data(),i));
        ...
        fBackgroundFitPol_SubPiZero[i] = new TF1  (Form("FitCombinatoricalContamination_SubPiZero_%i", i), tempBckClass, fFitRangeDummy[0], fFitRangeDummy[1], 2);
        FitCombinatoricalContamination->GetParameters(&FitParams[0]);
        ...
        fHistoMappingGGInvMassBackFitPtBin_SubPiZero[i] = (TH1D*) fGammaGamma->Clone(Form("fHistoMappingGGInvMassBackFit_in_Pt_Bin%i",i));
        fHistoMappingGGInvMassBackFitPtBin_SubPiZero[i]->Sumw2();
      ...
      gSystem->mkdir("Debug");
        ...
        // For background subtraction
        fBackgroundFitPol_FixedPzPiZero[i] = NULL;
        fBackgroundFitPol_FixedPzPiZero[i] = new TF1  (Form("FitCombinatoricalContamination_FixedPzPiZero_%i", i), tempBckClass, fFitRangeDummy[0], fFitRangeDummy[1], 2);
        FitCombinatoricalContamination->GetParameters(&FitParams[0]);
        ...
        fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[i] = (TH1D*) fGammaGamma->Clone(Form("fHistoMappingGGInvMassBackFit_in_Pt_Bin%i",i));
        fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[i]->Sumw2();
    ...
    if (doDebugOutputLevel>=1){
        cout<<"Debug Text Output; ExtractSignalPiPlPiMiNDM.C; ProcessBckFitSubtraction() ends; Line: "<<__LINE__<<endl;
    }
}
...
Double_t FitFunctionSigBckRatio(Double_t *x, Double_t *par){
    Double_t result=0;
    result=FitFunctionSigBckRatioPol2(x, par);
    return result;
}

Double_t FitFunctionSigBckRatioPol1(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
...
Double_t FitFunctionSigBckRatioPol2(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol3(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol1_withGaus(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol2_withGaus(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol3_withGaus(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol1_withGausExp(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol2_withGausExp(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
Double_t FitFunctionSigBckRatioPol3_withGausExp(Double_t *x, Double_t *par){
    Double_t result=0;
    Double_t xx=x[0];
    Double_t FitRangeIgnoreSigBckRatioMin;
    Double_t FitRangeIgnoreSigBckRatioMax;
...
void ProcessEM_FitBins(TH1D* fGammaGamma, TH1D* fBck, Double_t * fBGFitRangeEM) {
    ...
    //------------------------------------------------------------------------------------------------------------
    //Pol_N_Prefit
    if (fFitSigBckPol1_Prefit!=NULL){delete fFitSigBckPol1_Prefit; fFitSigBckPol1_Prefit=NULL;}
    if (fFitSigBckPol2_Prefit!=NULL){delete fFitSigBckPol2_Prefit; fFitSigBckPol2_Prefit=NULL;}
    if (fFitSigBckPol3_Prefit!=NULL){delete fFitSigBckPol3_Prefit; fFitSigBckPol3_Prefit=NULL;}
    //------------------------------------
    //Pol_N
    if (fFitSigBckPol1!=NULL){delete fFitSigBckPol1; fFitSigBckPol1=NULL;}
    if (fFitSigBckPol2!=NULL){delete fFitSigBckPol2; fFitSigBckPol2=NULL;}
    if (fFitSigBckPol3!=NULL){delete fFitSigBckPol3; fFitSigBckPol3=NULL;}
    //------------------------------------
    //Pol_N_plus_Gaus
    if (fFitSigBckPol1_withGaus!=NULL){delete fFitSigBckPol1_withGaus; fFitSigBckPol1_withGaus=NULL;}
    if (fFitSigBckPol2_withGaus!=NULL){delete fFitSigBckPol2_withGaus; fFitSigBckPol2_withGaus=NULL;}
    if (fFitSigBckPol3_withGaus!=NULL){delete fFitSigBckPol3_withGaus; fFitSigBckPol3_withGaus=NULL;}
    //------------------------------------------------------------------------------------------------------------
    //Define Fits
    ...
    fFitSigBckPol1_Prefit = new TF1(fFitBackgroundHistogramFitNamePol1_Prefit.Data(), FitFunctionSigBckRatioPol1, FitRangeSigBckRatioMin_Prefit, FitRangeSigBckRatioMax_Prefit, iNumberOfFitParametersPol1_Prefit);
    fFitSigBckPol2_Prefit = new TF1(fFitBackgroundHistogramFitNamePol2_Prefit.Data(), FitFunctionSigBckRatioPol2, FitRangeSigBckRatioMin_Prefit, FitRangeSigBckRatioMax_Prefit, iNumberOfFitParametersPol2_Prefit);
    fFitSigBckPol3_Prefit = new TF1(fFitBackgroundHistogramFitNamePol3_Prefit.Data(), FitFunctionSigBckRatioPol3, FitRangeSigBckRatioMin_Prefit, FitRangeSigBckRatioMax_Prefit, iNumberOfFitParametersPol3_Prefit);
    //------------------------------------
    //Pol_N
    if (debugOutputLevel>=2){cout<<"Debug Output, ExtractSignalV2.C, ProcessEM_FitBins(), Line: "<<__LINE__<<"; Define Fits"<<" -> Pol_N"<<endl;}
    fFitSigBckPol1 = new TF1(fFitBackgroundHistogramFitNamePol1.Data(), "pol1", FitRangeSigBckRatioMin, FitRangeSigBckRatioMax);
    fFitSigBckPol2 = new TF1(fFitBackgroundHistogramFitNamePol2.Data(), "pol2", FitRangeSigBckRatioMin, FitRangeSigBckRatioMax);
    fFitSigBckPol3 = new TF1(fFitBackgroundHistogramFitNamePol3.Data(), "pol3", FitRangeSigBckRatioMin, FitRangeSigBckRatioMax);
    //------------------------------------
    //Pol_N_plus_Gaus
    ...
    if (FitRangeSigBckRatioOption<20){
        fFitSigBckPol1_withGaus = new TF1(fFitBackgroundHistogramFitNamePol1_withGaus.Data(), FitFunctionSigBckRatioPol1_withGaus, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol1_withGaus);
        fFitSigBckPol2_withGaus = new TF1(fFitBackgroundHistogramFitNamePol2_withGaus.Data(), FitFunctionSigBckRatioPol2_withGaus, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol2_withGaus);
        fFitSigBckPol3_withGaus = new TF1(fFitBackgroundHistogramFitNamePol3_withGaus.Data(), FitFunctionSigBckRatioPol3_withGaus, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol3_withGaus);
    } else {
        iNumberOfFitParametersPol1_withGaus++;
        iNumberOfFitParametersPol2_withGaus++;
        iNumberOfFitParametersPol3_withGaus++;
        fFitSigBckPol1_withGaus = new TF1(fFitBackgroundHistogramFitNamePol1_withGaus.Data(), FitFunctionSigBckRatioPol1_withGausExp, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol1_withGaus);
        fFitSigBckPol2_withGaus = new TF1(fFitBackgroundHistogramFitNamePol2_withGaus.Data(), FitFunctionSigBckRatioPol2_withGausExp, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol2_withGaus);
        fFitSigBckPol3_withGaus = new TF1(fFitBackgroundHistogramFitNamePol3_withGaus.Data(), FitFunctionSigBckRatioPol3_withGausExp, FitRangeSigBckRatioMin, FitRangeSigBckRatioMax, iNumberOfFitParametersPol3_withGaus);
    }
    //------------------------------------------------------------------------------------------------------------
    ...
    if (debugOutputLevel>=2){
        cout<<"------------------------------------"<<endl;
        cout<<"Debug Output, ExtractSignalV2.C, ProcessEM_FitBins(), Line: "<<__LINE__<<"; fFitSigBckPol2_Prefit Parameters after Fit"<<endl;
        for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol2_Prefit; iNumberOfPolParameters_Loop++){
            cout<<"fFitSigBckPol2_Prefit->GetParameter("<<iNumberOfPolParameters_Loop<<"): "<<fFitSigBckPol2_Prefit->GetParameter(iNumberOfPolParameters_Loop)<<endl;
        }
    }
    //------------------------------------------------------------------------------------------------------------
    ...
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol1_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol1_withGaus->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol1_Prefit->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol1_withGaus->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol1_Prefit->GetParError(iNumberOfPolParameters_Loop));
    }
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol2_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol2_withGaus->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol2_Prefit->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol2_withGaus->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol2_Prefit->GetParError(iNumberOfPolParameters_Loop));
    }
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol3_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol3_withGaus->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol3_Prefit->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol3_withGaus->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol3_Prefit->GetParError(iNumberOfPolParameters_Loop));
    }
    //------------------------------------
    fFitSigBckPol1_withGaus->SetParameter(iNumberOfFitParametersPol1_Prefit, mesonAmplitude);
    fFitSigBckPol1_withGaus->SetParLimits(iNumberOfFitParametersPol1_Prefit, mesonAmplitudeMin, mesonAmplitudeMax);
    fFitSigBckPol1_withGaus->SetParameter(iNumberOfFitParametersPol1_Prefit+1, fMesonMassExpect);
    fFitSigBckPol1_withGaus->SetParLimits(iNumberOfFitParametersPol1_Prefit+1, fMesonMassExpect*0.95, fMesonMassExpect*1.1);
    fFitSigBckPol1_withGaus->SetParameter(iNumberOfFitParametersPol1_Prefit+2, fMesonWidthExpect);
    fFitSigBckPol1_withGaus->SetParLimits(iNumberOfFitParametersPol1_Prefit+2, fMesonWidthRange[0], fMesonWidthRange[1]);
    if (FitRangeSigBckRatioOption>=20){
        if (fMesonLambdaTail == fMesonLambdaTailRange[0] && fMesonLambdaTail == fMesonLambdaTailRange[1] ){
            fFitSigBckPol1_withGaus->FixParameter(iNumberOfFitParametersPol1_Prefit+3,fMesonLambdaTail);
        } else {
            fFitSigBckPol1_withGaus->SetParameter(iNumberOfFitParametersPol1_Prefit+3,fMesonLambdaTail);
            fFitSigBckPol1_withGaus->SetParLimits(iNumberOfFitParametersPol1_Prefit+3,fMesonLambdaTailRange[0],fMesonLambdaTailRange[1]);
        }
    }
    //------------------------------------
    fFitSigBckPol2_withGaus->SetParameter(iNumberOfFitParametersPol2_Prefit, mesonAmplitude);
    fFitSigBckPol2_withGaus->SetParLimits(iNumberOfFitParametersPol2_Prefit, mesonAmplitudeMin, mesonAmplitudeMax);
    fFitSigBckPol2_withGaus->SetParameter(iNumberOfFitParametersPol2_Prefit+1, fMesonMassExpect);
    fFitSigBckPol2_withGaus->SetParLimits(iNumberOfFitParametersPol2_Prefit+1, fMesonMassExpect*0.9, fMesonMassExpect*1.1);
    fFitSigBckPol2_withGaus->SetParameter(iNumberOfFitParametersPol2_Prefit+2, fMesonWidthExpect);
    fFitSigBckPol2_withGaus->SetParLimits(iNumberOfFitParametersPol2_Prefit+2, fMesonWidthRange[0], fMesonWidthRange[1]);
    if (FitRangeSigBckRatioOption>=20){
        if (fMesonLambdaTail == fMesonLambdaTailRange[0] && fMesonLambdaTail == fMesonLambdaTailRange[1] ){
            fFitSigBckPol2_withGaus->FixParameter(iNumberOfFitParametersPol2_Prefit+3,fMesonLambdaTail);
        } else {
            fFitSigBckPol2_withGaus->SetParameter(iNumberOfFitParametersPol2_Prefit+3,fMesonLambdaTail);
            fFitSigBckPol2_withGaus->SetParLimits(iNumberOfFitParametersPol2_Prefit+3,fMesonLambdaTailRange[0],fMesonLambdaTailRange[1]);
        }
    }
    //------------------------------------
    fFitSigBckPol3_withGaus->SetParameter(iNumberOfFitParametersPol3_Prefit, mesonAmplitude);
    fFitSigBckPol3_withGaus->SetParLimits(iNumberOfFitParametersPol3_Prefit, mesonAmplitudeMin, mesonAmplitudeMax);
    fFitSigBckPol3_withGaus->SetParameter(iNumberOfFitParametersPol3_Prefit+1, fMesonMassExpect);
    fFitSigBckPol3_withGaus->SetParLimits(iNumberOfFitParametersPol3_Prefit+1, fMesonMassExpect*0.9, fMesonMassExpect*1.1);
    fFitSigBckPol3_withGaus->SetParameter(iNumberOfFitParametersPol3_Prefit+2, fMesonWidthExpect);
    fFitSigBckPol3_withGaus->SetParLimits(iNumberOfFitParametersPol3_Prefit+2, fMesonWidthRange[0], fMesonWidthRange[1]);
    if (FitRangeSigBckRatioOption>=20){
        if (fMesonLambdaTail == fMesonLambdaTailRange[0] && fMesonLambdaTail == fMesonLambdaTailRange[1] ){
            fFitSigBckPol3_withGaus->FixParameter(iNumberOfFitParametersPol3_Prefit+3,fMesonLambdaTail);
        } else {
            fFitSigBckPol3_withGaus->SetParameter(iNumberOfFitParametersPol3_Prefit+3,fMesonLambdaTail);
            fFitSigBckPol3_withGaus->SetParLimits(iNumberOfFitParametersPol3_Prefit+3,fMesonLambdaTailRange[0],fMesonLambdaTailRange[1]);
        }
    }
    if (debugOutputLevel>=2){
        cout<<"------------------------------------"<<endl;
    ...
    //------------------------------------------------------------------------------------------------------------
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol1_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol1->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol1_withGaus->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol1->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol1_withGaus->GetParError(iNumberOfPolParameters_Loop));
    }
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol2_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol2->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol2_withGaus->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol2->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol2_withGaus->GetParError(iNumberOfPolParameters_Loop));
    }
    for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol3_Prefit; iNumberOfPolParameters_Loop++){
        fFitSigBckPol3->SetParameter(iNumberOfPolParameters_Loop, fFitSigBckPol3_withGaus->GetParameter(iNumberOfPolParameters_Loop));
        fFitSigBckPol3->SetParError(iNumberOfPolParameters_Loop, fFitSigBckPol3_withGaus->GetParError(iNumberOfPolParameters_Loop));
    }
    if (debugOutputLevel>=2){
        cout<<"------------------------------------"<<endl;
        cout<<"Debug Output, ExtractSignalV2.C, ProcessEM_FitBins(), Line: "<<__LINE__<<"; fFitSigBckPol2 Parameters"<<endl;
        for (Int_t iNumberOfPolParameters_Loop=0; iNumberOfPolParameters_Loop<iNumberOfFitParametersPol2; iNumberOfPolParameters_Loop++){
            cout<<"fFitSigBckPol2->GetParameter("<<iNumberOfPolParameters_Loop<<"): "<<fFitSigBckPol2->GetParameter(iNumberOfPolParameters_Loop)<<endl;
        }
    }
    ...
    for (Int_t i = 1; i < fBckNorm->GetNbinsX()+1; i++){
        ...
        if (usePolNForBackgroundScaling == 1){
            CurrentBinContentRatio=fFitSigBckPol1->Eval(CurrentBinCenter);
        } else if(usePolNForBackgroundScaling == 2){
            CurrentBinContentRatio=fFitSigBckPol2->Eval(CurrentBinCenter);
        } else if(usePolNForBackgroundScaling == 3){
            CurrentBinContentRatio=fFitSigBckPol3->Eval(CurrentBinCenter);
        } else {
            CurrentBinContentRatio=fFitSigBckPol2->Eval(CurrentBinCenter);
        }
        if (fBckNorm->GetBinContent(i) == 0){
...
void FillMassHistosArray(TH2D* fGammaGammaInvMassVSPtDummy,TH2D* fGammaGammaInvMassVSPtDummy_SubPiZero,TH2D* fGammaGammaInvMassVSPtDummy_FixedPzPiZero)
{
    ...
    fGammaGammaInvMassVSPtDummy->ProjectionX("Mapping_GG_InvMass_MidPt",startBinMidPt,endBinMidPt,"e");
    ...
    fGammaGammaInvMassVSPtDummy->ProjectionX("Mapping_GG_InvMass_FullPt",startBinFullPt,endBinFullPt,"e");
    ...
    if(fGammaGammaInvMassVSPtDummy_SubPiZero!=NULL){
      ...
      fGammaGammaInvMassVSPtDummy_SubPiZero->ProjectionX("Mapping_GG_InvMass_SubPiZero_MidPt",startBinMidPt,endBinMidPt,"e");
      ...
      fGammaGammaInvMassVSPtDummy_SubPiZero->ProjectionX("Mapping_GG_InvMass_SubPiZero_FullPt",startBinFullPt,endBinFullPt,"e");
    ...
    if(fGammaGammaInvMassVSPtDummy_FixedPzPiZero!=NULL){
      ...
      fGammaGammaInvMassVSPtDummy_FixedPzPiZero->ProjectionX("Mapping_GG_InvMass_FixedPzPiZero_MidPt",startBinMidPt,endBinMidPt,"e");
      ...
      fGammaGammaInvMassVSPtDummy_FixedPzPiZero->ProjectionX("Mapping_GG_InvMass_FixedPzPiZero_FullPt",startBinFullPt,endBinFullPt,"e");
    ...
    //                 << fGammaGammaInvMassVSPtDummy->GetYaxis()->GetBinCenter(endBin)<< endl;
        ...
        fGammaGammaInvMassVSPtDummy->ProjectionX(fNameHistoGG.Data(),startBin,endBin,"e");
        ...
        if(fGammaGammaInvMassVSPtDummy_SubPiZero!=NULL){
          ...
          fGammaGammaInvMassVSPtDummy_SubPiZero->ProjectionX(fNameHistoGG.Data(),startBin,endBin,"e");
        ...
        if(fGammaGammaInvMassVSPtDummy_FixedPzPiZero!=NULL){
          ...
          fGammaGammaInvMassVSPtDummy_FixedPzPiZero->ProjectionX(fNameHistoGG.Data(),startBin,endBin,"e");
...
void ProjectHistogramInPtBins(TH2D* HistogramToProject, TH1D **ProjectedHistograms){
    ...
    for(Int_t iPt=fStartPtBin;iPt<fNBinsPt;iPt++){
        HistogramName               = HistogramToProject->GetTitle();
        ProjectionName              = Form("%s_(%fto%f)GeV/c", HistogramName.Data(), fBinsPt[iPt], fBinsPt[iPt+1]);
        Int_t startBin = HistogramToProject->GetYaxis()->FindBin(fBinsPt[iPt]+0.001);
        Int_t endBin = HistogramToProject->GetYaxis()->FindBin(fBinsPt[iPt+1]-0.001);
        ProjectedHistograms[iPt]    = HistogramToProject->ProjectionX(ProjectionName.Data(),startBin,endBin,"e");
    }
}
...
void CreatePtHistos(){
    ...
    for (Int_t k = 0; k < 3; k++){
        ...
        if(k==0){
            fHistoYieldMesonBackFitFromFit =           			new TH1D(Form("histoYield%sMesonBackFitFromFit",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
            fHistoYieldMesonBackFitFromFit_SubPiZero = 			new TH1D(Form("histoYield%sMesonBackFitFromFit_SubPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
            fHistoYieldMesonBackFitFromFit_FixedPzPiZero = 	    new TH1D(Form("histoYield%sMesonBackFitFromFit_FixedPzPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
            fHistoYieldMesonPerEventBackFitFromFit =               new TH1D(Form("histoYield%sMesonPerEventBackFitFromFit",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
            fHistoYieldMesonPerEventBackFitFromFit_SubPiZero =     new TH1D(Form("histoYield%sMesonPerEventBackFitFromFit_SubPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
            fHistoYieldMesonPerEventBackFitFromFit_FixedPzPiZero = new TH1D(Form("histoYield%sMesonPerEventBackFitFromFit_FixedPzPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        }
        // validated yields
        ...
        fHistoSigndefaultMesonBackFit[k]                            = new TH1D(Form("histoSigndefaultBackFit%sMeson",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSigndefaultMesonBackFit_SubPiZero[k]                  = new TH1D(Form("histoSigndefaultBackFit%sMeson_SubPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSigndefaultMesonBackFit_FixedPzPiZero[k]              = new TH1D(Form("histoSigndefaultBackFit%sMeson_FixedPzPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSigndefaultMesonBackFit[k]->Sumw2();
        fHistoSigndefaultMesonBackFit_SubPiZero[k]->Sumw2();
        fHistoSigndefaultMesonBackFit_FixedPzPiZero[k]->Sumw2();
        ...
        fHistoSBdefaultMesonBackFit[k]                              = new TH1D(Form("histoSBdefault%sMesonBackFit",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSBdefaultMesonBackFit_SubPiZero[k]                    = new TH1D(Form("histoSBdefault%sMesonBackFit_SubPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSBdefaultMesonBackFit_FixedPzPiZero[k]                = new TH1D(Form("histoSBdefault%sMesonBackFit_FixedPzPiZero",nameIntRange[k].Data()),"",fNBinsPt,fBinsPt);
        fHistoSBdefaultMesonBackFit[k]->Sumw2();
        fHistoSBdefaultMesonBackFit_SubPiZero[k]->Sumw2();
        fHistoSBdefaultMesonBackFit_FixedPzPiZero[k]->Sumw2();
    }
    ...
    fHistoMassMesonBackFit =                        new TH1D("histoMassMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoMassMesonBackFit_SubPiZero =              new TH1D("histoMassMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoMassMesonBackFit_FixedPzPiZero =          new TH1D("histoMassMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoLambdaMeson=								new TH1D("fHistoLambdaMeson","",fNBinsPt,fBinsPt);
    fHistoLambdaMeson_SubPiZero=					new TH1D("fHistoLambdaMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoLambdaMeson_FixedPzPiZero=				new TH1D("fHistoLambdaMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoLambdaMesonBackFit=						new TH1D("fHistoLambdaMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoLambdaMesonBackFit_SubPiZero=				new TH1D("fHistoLambdaMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoLambdaMesonBackFit_FixedPzPiZero=			new TH1D("fHistoLambdaMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoWidthMeson =                              new TH1D("histoWidthMeson","",fNBinsPt,fBinsPt);
    fHistoWidthMeson_SubPiZero=						new TH1D("fHistoWidthMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoWidthMeson_FixedPzPiZero=					new TH1D("fHistoWidthMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoWidthMesonBackFit=						new TH1D("fHistoWidthMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoWidthMesonBackFit_SubPiZero=				new TH1D("fHistoWidthMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoWidthMesonBackFit_FixedPzPiZero=			new TH1D("fHistoWidthMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoWidthFitBinValues=                        new TH1D("fHistoWidthFitBinValues","",fNBinsPt,fBinsPt);
    ...
    fHistoFWHMMesonBackFit =                        new TH1D("histoFWHMMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoFWHMMesonBackFit_SubPiZero =              new TH1D("histoFWHMMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoFWHMMesonBackFit_FixedPzPiZero =          new TH1D("histoFWHMMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoFWHMToSigmaMeson =                        new TH1D("histoFWHMToSigmaMeson","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMeson_SubPiZero =              new TH1D("histoFWHMToSigmaMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMeson_FixedPzPiZero =          new TH1D("histoFWHMToSigmaMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMesonBackFit =                 new TH1D("histoFWHMToSigmaMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMesonBackFit_SubPiZero =       new TH1D("histoFWHMToSigmaMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero =   new TH1D("histoFWHMToSigmaMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoIntDeltaRangeBackFitByFitUpper =                  new TH1D("fHistoIntDeltaRangeBackFitByFitUpper","",fNBinsPt,fBinsPt);
    fHistoIntDeltaRangeBackFitByFitLower =                  new TH1D("fHistoIntDeltaRangeBackFitByFitUpper","",fNBinsPt,fBinsPt);
    fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero =        new TH1D("fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoIntDeltaRangeBackFitByFitLower_SubPiZero =        new TH1D("fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero =    new TH1D("fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero =    new TH1D("fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoAmplitudeMeson=							new TH1D("fHistoAmplitudeMeson","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMeson_SubPiZero=					new TH1D("fHistoAmplitudeMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMeson_FixedPzPiZero=				new TH1D("fHistoAmplitudeMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMesonBackFit=					new TH1D("fHistoAmplitudeMesonBackFit","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMesonBackFit_SubPiZero=			new TH1D("fHistoAmplitudeMesonBackFit_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMesonBackFit_FixedPzPiZero=		new TH1D("fHistoAmplitudeMesonBackFit_FixedPzPiZero","",fNBinsPt,fBinsPt);
    ...
    fHistoLambdaMesonLeft=							new TH1D("fHistoLambdaMesonLeft","",fNBinsPt,fBinsPt);
    fHistoLambdaMesonLeft_SubPiZero=				new TH1D("fHistoLambdaMesonLeft_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoLambdaMesonLeft_FixedPzPiZero=			new TH1D("fHistoLambdaMesonLeft_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoWidthMesonLeft=							new TH1D("fHistoWidthMesonLeft","",fNBinsPt,fBinsPt);
    fHistoWidthMesonLeft_SubPiZero=					new TH1D("fHistoWidthMesonLeft_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoWidthMesonLeft_FixedPzPiZero=				new TH1D("fHistoWidthMesonLeft_FixedPzPiZero","",fNBinsPt,fBinsPt);
    ...
    fHistoFWHMToSigmaMesonLeft =                    new TH1D("histoFWHMToSigmaMesonLeft","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMesonLeft_SubPiZero =          new TH1D("histoFWHMToSigmaMesonLeft_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoFWHMToSigmaMesonLeft_FixedPzPiZero =      new TH1D("histoFWHMToSigmaMesonLeft_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoAmplitudeMesonLeft=						new TH1D("fHistoAmplitudeMesonLeft","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMesonLeft_SubPiZero=				new TH1D("fHistoAmplitudeMesonLeft_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoAmplitudeMesonLeft_FixedPzPiZero=			new TH1D("fHistoAmplitudeMesonLeft_FixedPzPiZero","",fNBinsPt,fBinsPt);
    ...
    fHistoTrueLambdaMeson=							new TH1D("fHistoTrueLambdaMeson","",fNBinsPt,fBinsPt);
    fHistoTrueLambdaMeson_SubPiZero=				new TH1D("fHistoTrueLambdaMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueLambdaMeson_FixedPzPiZero=			new TH1D("fHistoTrueLambdaMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueLambdaMesonReweighted=				new TH1D("fHistoTrueLambdaMesonReweighted","",fNBinsPt,fBinsPt);
    fHistoTrueLambdaMesonReweighted_SubPiZero=		new TH1D("fHistoTrueLambdaMesonReweighted_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueLambdaMesonReweighted_FixedPzPiZero=	new TH1D("fHistoTrueLambdaMesonReweighted_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoTrueWidthMeson=							new TH1D("fHistoTrueWidthMeson","",fNBinsPt,fBinsPt);
    fHistoTrueWidthMeson_SubPiZero=					new TH1D("fHistoTrueWidthMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueWidthMeson_FixedPzPiZero=				new TH1D("fHistoTrueWidthMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueWidthMesonReweighted=					new TH1D("fHistoTrueWidthMesonReweighted","",fNBinsPt,fBinsPt);
    fHistoTrueWidthMesonReweighted_SubPiZero=		new TH1D("fHistoTrueWidthMesonReweighted_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueWidthMesonReweighted_FixedPzPiZero=	new TH1D("fHistoTrueWidthMesonReweighted_FixedPzPiZero","",fNBinsPt,fBinsPt);
    ...
    fHistoTrueFWHMToSigmaMeson =                    new TH1D("histoTrueFWHMToSigmaMeson","",fNBinsPt,fBinsPt);
    fHistoTrueFWHMToSigmaMeson_SubPiZero =          new TH1D("histoTrueFWHMToSigmaMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueFWHMToSigmaMeson_FixedPzPiZero =      new TH1D("histoTrueFWHMToSigmaMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueFWHMToSigmaMesonReweighted =          new TH1D("histoTrueFWHMToSigmaMesonReweighted","",fNBinsPt,fBinsPt);
    fHistoTrueFWHMToSigmaMesonReweighted_SubPiZero = new TH1D("histoTrueFWHMToSigmaMesonReweighted_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueFWHMToSigmaMesonReweighted_FixedPzPiZero = new TH1D("histoTrueFWHMToSigmaMesonReweighted_FixedPzPiZero","",fNBinsPt,fBinsPt);

    fHistoTrueAmplitudeMeson=						new TH1D("fHistoTrueAmplitudeMeson","",fNBinsPt,fBinsPt);
    fHistoTrueAmplitudeMeson_SubPiZero=				new TH1D("fHistoTrueAmplitudeMeson_SubPiZero","",fNBinsPt,fBinsPt);
    fHistoTrueAmplitudeMeson_FixedPzPiZero=			new TH1D("fHistoTrueAmplitudeMeson_FixedPzPiZero","",fNBinsPt,fBinsPt);
...
void FillPtHistos()
{
    for(Int_t iPt=fStartPtBin+1;iPt<fNBinsPt+1;iPt++){
        ...
        fHistoMassMesonBackFit->SetBinContent(iPt,fMesonMassBackFit[iPt-1]);
        fHistoMassMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonMassBackFit_SubPiZero[iPt-1]);
        fHistoMassMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonMassBackFit_FixedPzPiZero[iPt-1]);
        fHistoMassMesonBackFit->SetBinError(iPt,fMesonMassBackFitError[iPt-1]);
        fHistoMassMesonBackFit_SubPiZero->SetBinError(iPt,fMesonMassBackFitError_SubPiZero[iPt-1]);
        fHistoMassMesonBackFit_FixedPzPiZero->SetBinError(iPt,fMesonMassBackFitError_FixedPzPiZero[iPt-1]);


        //Fit Parameters: Lambda
        fHistoLambdaMeson->SetBinContent(iPt,fMesonLambdaTailpar[iPt-1]);
        fHistoLambdaMeson_SubPiZero->SetBinContent(iPt,fMesonLambdaTailpar_SubPiZero[iPt-1]);
        fHistoLambdaMeson_FixedPzPiZero->SetBinContent(iPt,fMesonLambdaTailpar_FixedPzPiZero[iPt-1]);
        fHistoLambdaMeson->SetBinError(iPt,fMesonLambdaTailparError[iPt-1]);
        fHistoLambdaMeson_SubPiZero->SetBinError(iPt,fMesonLambdaTailparError_SubPiZero[iPt-1]);
        fHistoLambdaMeson_FixedPzPiZero->SetBinError(iPt,fMesonLambdaTailparError_FixedPzPiZero[iPt-1]);

        fHistoLambdaMesonBackFit->SetBinContent(iPt,fMesonLambdaTailparBackFit[iPt-1]);
        fHistoLambdaMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonLambdaTailparBackFit_SubPiZero[iPt-1]);
        fHistoLambdaMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonLambdaTailparBackFit_FixedPzPiZero[iPt-1]);
        fHistoLambdaMesonBackFit->SetBinError(iPt,fMesonLambdaTailparBackFitError[iPt-1]);
        fHistoLambdaMesonBackFit_SubPiZero->SetBinError(iPt,fMesonLambdaTailparBackFitError_SubPiZero[iPt-1]);
        fHistoLambdaMesonBackFit_FixedPzPiZero->SetBinError(iPt,fMesonLambdaTailparBackFitError_FixedPzPiZero[iPt-1]);

        //Fit Parameters: Width
        fHistoWidthMeson->SetBinContent(iPt,fMesonWidth[iPt-1]);
        fHistoWidthMeson_SubPiZero->SetBinContent(iPt,fMesonWidth_SubPiZero[iPt-1]);
        fHistoWidthMeson_FixedPzPiZero->SetBinContent(iPt,fMesonWidth_FixedPzPiZero[iPt-1]);
        fHistoWidthMeson->SetBinError(iPt,fMesonWidthError[iPt-1]);
        fHistoWidthMeson_SubPiZero->SetBinError(iPt,fMesonWidthError_SubPiZero[iPt-1]);
        fHistoWidthMeson_FixedPzPiZero->SetBinError(iPt,fMesonWidthError_FixedPzPiZero[iPt-1]);

        fHistoWidthMesonBackFit->SetBinContent(iPt,fMesonWidthBackFit[iPt-1]);
        fHistoWidthMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonWidthBackFit_SubPiZero[iPt-1]);
        fHistoWidthMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonWidthBackFit_FixedPzPiZero[iPt-1]);
        fHistoWidthMesonBackFit->SetBinError(iPt,fMesonWidthBackFitError[iPt-1]);
        fHistoWidthMesonBackFit_SubPiZero->SetBinError(iPt,fMesonWidthBackFitError_SubPiZero[iPt-1]);
        fHistoWidthMesonBackFit_FixedPzPiZero->SetBinError(iPt,fMesonWidthBackFitError_FixedPzPiZero[iPt-1]);

        fHistoWidthFitBinValues->SetBinContent(iPt,fMesonWidthFitBinValues[iPt-1]);
        fHistoWidthFitBinValues->SetBinError(iPt, 0.);
        ...
        fHistoFWHMMesonBackFit->SetBinContent(iPt,fMesonFWHMBackFit[iPt-1]);
        fHistoFWHMMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonFWHMBackFit_SubPiZero[iPt-1]);
        fHistoFWHMMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonFWHMBackFit_FixedPzPiZero[iPt-1]);
        fHistoFWHMMesonBackFit->SetBinError(iPt,fMesonFWHMBackFitError[iPt-1]);
        fHistoFWHMMesonBackFit_SubPiZero->SetBinError(iPt,fMesonFWHMBackFitError_SubPiZero[iPt-1]);
        fHistoFWHMMesonBackFit_FixedPzPiZero->SetBinError(iPt,fMesonFWHMBackFitError_FixedPzPiZero[iPt-1]);

        //Fit Parameters: FWHM to sigma
        fHistoFWHMToSigmaMeson->SetBinContent(iPt,fMesonFWHM[iPt-1]/2.3548);
        fHistoFWHMToSigmaMeson_SubPiZero->SetBinContent(iPt,fMesonFWHM_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMeson_FixedPzPiZero->SetBinContent(iPt,fMesonFWHM_FixedPzPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMeson->SetBinError(iPt,fMesonFWHMError[iPt-1]/2.3548);
        fHistoFWHMToSigmaMeson_SubPiZero->SetBinError(iPt,fMesonFWHMError_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMeson_FixedPzPiZero->SetBinError(iPt,fMesonFWHMError_FixedPzPiZero[iPt-1]/2.3548);

        fHistoFWHMToSigmaMesonBackFit->SetBinContent(iPt,fMesonFWHMBackFit[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonFWHMBackFit_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonFWHMBackFit_FixedPzPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonBackFit->SetBinError(iPt,fMesonFWHMBackFitError[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonBackFit_SubPiZero->SetBinError(iPt,fMesonFWHMBackFitError_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonBackFit_FixedPzPiZero->SetBinError(iPt,fMesonFWHMBackFitError_FixedPzPiZero[iPt-1]/2.3548);

        fHistoIntDeltaRangeBackFitByFitUpper->SetBinContent(iPt, fMesonMassBackFit[iPt-1]+fMesonIntDeltaRangeByFit[0][1][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitLower->SetBinContent(iPt, fMesonMassBackFit[iPt-1]+fMesonIntDeltaRangeByFit[0][0][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitUpper->SetBinError(iPt, 0.);
        fHistoIntDeltaRangeBackFitByFitLower->SetBinError(iPt, 0.);

        fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero->SetBinContent(iPt, fMesonMassBackFit_SubPiZero[iPt-1]+fMesonIntDeltaRangeByFit[0][1][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitLower_SubPiZero->SetBinContent(iPt, fMesonMassBackFit_SubPiZero[iPt-1]+fMesonIntDeltaRangeByFit[0][0][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitUpper_SubPiZero->SetBinError(iPt, 0.);
        fHistoIntDeltaRangeBackFitByFitLower_SubPiZero->SetBinError(iPt, 0.);

        fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero->SetBinContent(iPt, fMesonMassBackFit_FixedPzPiZero[iPt-1]+fMesonIntDeltaRangeByFit[0][1][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero->SetBinContent(iPt, fMesonMassBackFit_FixedPzPiZero[iPt-1]+fMesonIntDeltaRangeByFit[0][0][iPt-1]);
        fHistoIntDeltaRangeBackFitByFitUpper_FixedPzPiZero->SetBinError(iPt, 0.);
        fHistoIntDeltaRangeBackFitByFitLower_FixedPzPiZero->SetBinError(iPt, 0.);

        //Fit Parameters: Amplitude
        fHistoAmplitudeMeson->SetBinContent(iPt,fMesonAmplitude[iPt-1]);
        fHistoAmplitudeMeson_SubPiZero->SetBinContent(iPt,fMesonAmplitude_SubPiZero[iPt-1]);
        fHistoAmplitudeMeson_FixedPzPiZero->SetBinContent(iPt,fMesonAmplitude_FixedPzPiZero[iPt-1]);
        fHistoAmplitudeMeson->SetBinError(iPt,fMesonAmplitudeError[iPt-1]);
        fHistoAmplitudeMeson_SubPiZero->SetBinError(iPt,fMesonAmplitudeError_SubPiZero[iPt-1]);
        fHistoAmplitudeMeson_FixedPzPiZero->SetBinError(iPt,fMesonAmplitudeError_FixedPzPiZero[iPt-1]);

        fHistoAmplitudeMesonBackFit->SetBinContent(iPt,fMesonAmplitudeBackFit[iPt-1]);
        fHistoAmplitudeMesonBackFit_SubPiZero->SetBinContent(iPt,fMesonAmplitudeBackFit_SubPiZero[iPt-1]);
        fHistoAmplitudeMesonBackFit_FixedPzPiZero->SetBinContent(iPt,fMesonAmplitudeBackFit_FixedPzPiZero[iPt-1]);
        fHistoAmplitudeMesonBackFit->SetBinError(iPt,fMesonAmplitudeBackFitError[iPt-1]);
        ...
        if (fIsMC) {
            ...
            //True Fit Parameters: Lambda
            fHistoTrueLambdaMeson->SetBinContent(iPt,fMesonTrueLambdaTailpar[iPt-1]);
            fHistoTrueLambdaMeson_SubPiZero->SetBinContent(iPt,fMesonTrueLambdaTailpar_SubPiZero[iPt-1]);
            fHistoTrueLambdaMeson_FixedPzPiZero->SetBinContent(iPt,fMesonTrueLambdaTailpar_FixedPzPiZero[iPt-1]);
            fHistoTrueLambdaMeson->SetBinError(iPt,fMesonTrueLambdaTailparError[iPt-1]);
            fHistoTrueLambdaMeson_SubPiZero->SetBinError(iPt,fMesonTrueLambdaTailparError_SubPiZero[iPt-1]);
            fHistoTrueLambdaMeson_FixedPzPiZero->SetBinError(iPt,fMesonTrueLambdaTailparError_FixedPzPiZero[iPt-1]);
            fHistoTrueLambdaMesonReweighted->SetBinContent(iPt,fMesonTrueLambdaTailparReweighted[iPt-1]);
            fHistoTrueLambdaMesonReweighted_SubPiZero->SetBinContent(iPt,fMesonTrueLambdaTailparReweighted_SubPiZero[iPt-1]);
            fHistoTrueLambdaMesonReweighted_FixedPzPiZero->SetBinContent(iPt,fMesonTrueLambdaTailparReweighted_FixedPzPiZero[iPt-1]);
            fHistoTrueLambdaMesonReweighted->SetBinError(iPt,fMesonTrueLambdaTailparReweightedError[iPt-1]);
            fHistoTrueLambdaMesonReweighted_SubPiZero->SetBinError(iPt,fMesonTrueLambdaTailparReweightedError_SubPiZero[iPt-1]);
            fHistoTrueLambdaMesonReweighted_FixedPzPiZero->SetBinError(iPt,fMesonTrueLambdaTailparReweightedError_FixedPzPiZero[iPt-1]);

            //True Fit Parameters: Width
            fHistoTrueWidthMeson->SetBinContent(iPt,fMesonTrueWidth[iPt-1]);
            fHistoTrueWidthMeson_SubPiZero->SetBinContent(iPt,fMesonTrueWidth_SubPiZero[iPt-1]);
            fHistoTrueWidthMeson_FixedPzPiZero->SetBinContent(iPt,fMesonTrueWidth_FixedPzPiZero[iPt-1]);
            fHistoTrueWidthMeson->SetBinError(iPt,fMesonTrueWidthError[iPt-1]);
            fHistoTrueWidthMeson_SubPiZero->SetBinError(iPt,fMesonTrueWidthError_SubPiZero[iPt-1]);
            fHistoTrueWidthMeson_FixedPzPiZero->SetBinError(iPt,fMesonTrueWidthError_FixedPzPiZero[iPt-1]);
            fHistoTrueWidthMesonReweighted->SetBinContent(iPt,fMesonTrueWidthReweighted[iPt-1]);
            fHistoTrueWidthMesonReweighted_SubPiZero->SetBinContent(iPt,fMesonTrueWidthReweighted_SubPiZero[iPt-1]);
            fHistoTrueWidthMesonReweighted_FixedPzPiZero->SetBinContent(iPt,fMesonTrueWidthReweighted_FixedPzPiZero[iPt-1]);
            fHistoTrueWidthMesonReweighted->SetBinError(iPt,fMesonTrueWidthReweightedError[iPt-1]);
            fHistoTrueWidthMesonReweighted_SubPiZero->SetBinError(iPt,fMesonTrueWidthReweightedError_SubPiZero[iPt-1]);
            fHistoTrueWidthMesonReweighted_FixedPzPiZero->SetBinError(iPt,fMesonTrueWidthReweightedError_FixedPzPiZero[iPt-1]);

            //True Fit Parameters: FWHM
            ...
            //True Fit Parameters: FWHM to sigma
            fHistoTrueFWHMToSigmaMeson->SetBinContent(iPt,fMesonTrueFWHM[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMeson_SubPiZero->SetBinContent(iPt,fMesonTrueFWHM_SubPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMeson_FixedPzPiZero->SetBinContent(iPt,fMesonTrueFWHM_FixedPzPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMeson->SetBinError(iPt,fMesonTrueFWHMError[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMeson_SubPiZero->SetBinError(iPt,fMesonTrueFWHMError_SubPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMeson_FixedPzPiZero->SetBinError(iPt,fMesonTrueFWHMError_FixedPzPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted->SetBinContent(iPt,fMesonTrueFWHMReweighted[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted_SubPiZero->SetBinContent(iPt,fMesonTrueFWHMReweighted_SubPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted_FixedPzPiZero->SetBinContent(iPt,fMesonTrueFWHMReweighted_FixedPzPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted->SetBinError(iPt,fMesonTrueFWHMReweightedError[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted_SubPiZero->SetBinError(iPt,fMesonTrueFWHMReweightedError_SubPiZero[iPt-1]/2.3548);
            fHistoTrueFWHMToSigmaMesonReweighted_FixedPzPiZero->SetBinError(iPt,fMesonTrueFWHMReweightedError_FixedPzPiZero[iPt-1]/2.3548);

            //True Fit Parameters: Amplitude
            fHistoTrueAmplitudeMeson->SetBinContent(iPt,fMesonTrueAmplitude[iPt-1]);
            fHistoTrueAmplitudeMeson_SubPiZero->SetBinContent(iPt,fMesonTrueAmplitude_SubPiZero[iPt-1]);
            fHistoTrueAmplitudeMeson_FixedPzPiZero->SetBinContent(iPt,fMesonTrueAmplitude_FixedPzPiZero[iPt-1]);
            fHistoTrueAmplitudeMeson->SetBinError(iPt,fMesonTrueAmplitudeError[iPt-1]);
            fHistoTrueAmplitudeMeson_SubPiZero->SetBinError(iPt,fMesonTrueAmplitudeError_SubPiZero[iPt-1]);
            fHistoTrueAmplitudeMeson_FixedPzPiZero->SetBinError(iPt,fMesonTrueAmplitudeError_FixedPzPiZero[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted->SetBinContent(iPt,fMesonTrueAmplitudeReweighted[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted_SubPiZero->SetBinContent(iPt,fMesonTrueAmplitudeReweighted_SubPiZero[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted_FixedPzPiZero->SetBinContent(iPt,fMesonTrueAmplitudeReweighted_FixedPzPiZero[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted->SetBinError(iPt,fMesonTrueAmplitudeReweightedError[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted_SubPiZero->SetBinError(iPt,fMesonTrueAmplitudeReweightedError_SubPiZero[iPt-1]);
            fHistoTrueAmplitudeMesonReweighted_FixedPzPiZero->SetBinError(iPt,fMesonTrueAmplitudeReweightedError_FixedPzPiZero[iPt-1]);
        ...
        for (Int_t k = 0; k < 3; k++){
            ...
            fHistoSigndefaultMesonBackFit[k]->SetBinContent(iPt,fMesonSigndefaultBackFit[k][iPt-1]);
            fHistoSigndefaultMesonBackFit_SubPiZero[k]->SetBinContent(iPt,fMesonSigndefaultBackFit_SubPiZero[k][iPt-1]);
            fHistoSigndefaultMesonBackFit_FixedPzPiZero[k]->SetBinContent(iPt,fMesonSigndefaultBackFit_FixedPzPiZero[k][iPt-1]);
            fHistoSigndefaultMesonBackFit[k]->SetBinError(iPt,fMesonSigndefaultBackFitError[k][iPt-1]);
            fHistoSigndefaultMesonBackFit_SubPiZero[k]->SetBinError(iPt,fMesonSigndefaultBackFitError_SubPiZero[k][iPt-1]);
            fHistoSigndefaultMesonBackFit_FixedPzPiZero[k]->SetBinError(iPt,fMesonSigndefaultBackFitError_FixedPzPiZero[k][iPt-1]);
            ...
            fHistoSBdefaultMesonBackFit[k]->SetBinContent(iPt,fMesonSBdefaultBackFit[k][iPt-1]);
            fHistoSBdefaultMesonBackFit_SubPiZero[k]->SetBinContent(iPt,fMesonSBdefaultBackFit_SubPiZero[k][iPt-1]);
            fHistoSBdefaultMesonBackFit_FixedPzPiZero[k]->SetBinContent(iPt,fMesonSBdefaultBackFit_FixedPzPiZero[k][iPt-1]);
            fHistoSBdefaultMesonBackFit[k]->SetBinError(iPt,fMesonSBdefaultBackFitError[k][iPt-1]);
            fHistoSBdefaultMesonBackFit_SubPiZero[k]->SetBinError(iPt,fMesonSBdefaultBackFitError_SubPiZero[k][iPt-1]);
            fHistoSBdefaultMesonBackFit_FixedPzPiZero[k]->SetBinError(iPt,fMesonSBdefaultBackFitError_FixedPzPiZero[k][iPt-1]);
            ...
            if(k==0){
                fHistoYieldMesonBackFitFromFit->SetBinContent(iPt,fMesonYieldsBackFitFromFit[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonBackFitFromFit_SubPiZero->SetBinContent(iPt,fMesonYieldsBackFitFromFit_SubPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonBackFitFromFit_FixedPzPiZero->SetBinContent(iPt,fMesonYieldsBackFitFromFit_FixedPzPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonBackFitFromFit->SetBinError(iPt,fMesonYieldsBackFitFromFitError[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonBackFitFromFit_SubPiZero->SetBinError(iPt,fMesonYieldsBackFitFromFitError_SubPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonBackFitFromFit_FixedPzPiZero->SetBinError(iPt,fMesonYieldsBackFitFromFitError_FixedPzPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));

                fHistoYieldMesonPerEventBackFitFromFit->SetBinContent(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFit[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonPerEventBackFitFromFit_SubPiZero->SetBinContent(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFit_SubPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonPerEventBackFitFromFit_FixedPzPiZero->SetBinContent(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFit_FixedPzPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonPerEventBackFitFromFit->SetBinError(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFitError[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonPerEventBackFitFromFit_SubPiZero->SetBinError(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFitError_SubPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
                fHistoYieldMesonPerEventBackFitFromFit_FixedPzPiZero->SetBinError(iPt,(1./fNEvents)*fMesonYieldsBackFitFromFitError_FixedPzPiZero[iPt-1]/(fBinsPt[iPt]-fBinsPt[iPt-1]));
            }
        ...
        fHistoFWHMToSigmaMesonLeft->SetBinContent(iPt,fMesonFWHMLeft[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonLeft_SubPiZero->SetBinContent(iPt,fMesonFWHMLeft_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonLeft_FixedPzPiZero->SetBinContent(iPt,fMesonFWHMLeft_FixedPzPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonLeft->SetBinError(iPt,fMesonFWHMLeftError[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonLeft_SubPiZero->SetBinError(iPt,fMesonFWHMLeftError_SubPiZero[iPt-1]/2.3548);
        fHistoFWHMToSigmaMesonLeft_FixedPzPiZero->SetBinError(iPt,fMesonFWHMLeftError_FixedPzPiZero[iPt-1]/2.3548);
...
void FitSubtractedInvMassInPtBins(TH1D* fHistoMappingSignalInvMassPtBinSingle, Double_t* fMesonIntDeltaRangeFit, Int_t ptBin, Bool_t vary, Int_t InvMassType)
{
    ...
    TString histoName = fHistoMappingSignalInvMassPtBinSingle->GetName();
    cout << fHistoMappingSignalInvMassPtBinSingle->GetName() << endl;
    Bool_t noResidualBackFit = kFALSE;
    if(histoName.Contains("BackFit")){
       noResidualBackFit = kTRUE;
    }
    // Check if to use pol2 fitting
    Bool_t usePol2BckFitting = kFALSE;
    if((fMode==64) && (fPrefix.CompareTo("Omega") ==0)){

        //if(fBinsPt[ptBin]<2.5){
            usePol2BckFitting = kFALSE;
        //}
    }

    // Set Correct Meson Plot Range
    if ( fFitRangeForMaximumMode == 1){ //0==fPeakRange
        if(InvMassType==0) {
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fPeakRange[0],fPeakRange[1]);
        } else if(InvMassType==1){
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fPeakRange_SubPiZero[0],fPeakRange_SubPiZero[1]);
        } else if(InvMassType==2){
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fPeakRange_FixedPzPiZero[0],fPeakRange_FixedPzPiZero[1]);
        } else {
            cout << " ERROR! Invalid InvMassType was given. FitSubtractedInvMassInPtBins won't be run!" << endl;
            return;
        }
    } else if ( fFitRangeForMaximumMode == 2){ //2==fFitRange
        if(InvMassType==0) {
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fFitRange[0],fFitRange[1]);
        } else if(InvMassType==1){
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fFitRange_SubPiZero[0],fFitRange_SubPiZero[1]);
        } else if(InvMassType==2){
            fHistoMappingSignalInvMassPtBinSingle->GetXaxis()->SetRangeUser(fFitRange_FixedPzPiZero[0],fFitRange_FixedPzPiZero[1]);
        } else {
            cout << " ERROR! Invalid InvMassType was given. FitSubtractedInvMassInPtBins won't be run!" << endl;
            return;
        }
    } else { //0==fMesonMassPlotRange
        if(InvMassType==0) {
    ...
    if(!noResidualBackFit) fHistoMappingSignalInvMassPtBinSingle->Fit(fFitLinearBckExcl,"RME0");

    // set Results as start parameters
    if(usePol2BckFitting){ // use for bckground
        if(noResidualBackFit){
            fFitReco->FixParameter(4,0.);
            fFitReco->FixParameter(5,0.);
            fFitReco->FixParameter(6,0.);
        } else{
...
//        }
        ...
        fFitReco->SetParLimits(1,fMesonMassExpect*0.97,fMesonMassExpect*1.03);
    }
    ...
    fHistSignalOnly = (TH1F*) fHistoMappingSignalInvMassPtBinSingle->Clone();
    fHistSignalOnly->Sumw2();
    TH1F* dummyBackHist = (TH1F*) fHistoMappingSignalInvMassPtBinSingle->Clone("dummyBackHist");
    for (Int_t binx= 0; binx < dummyBackHist->GetNbinsX()+1; binx++){
              Double_t binLow = dummyBackHist->GetBinLowEdge(binx);
              Double_t binHigh = dummyBackHist->GetBinLowEdge(binx)+dummyBackHist->GetBinWidth(binx);
              Double_t area = fFitLinearBck->Integral(binLow,binHigh);
              //Double_t area_err = fFitLinearBck->IntegralError(binLow,binHigh);
              dummyBackHist->SetBinContent(binx,area/(dummyBackHist->GetBinWidth(binx)));
              //dummyBackHist->SetBinError(binx,TMath::Sqrt(area/(dummyBackHist->GetBinWidth(binx))));
    }

    fHistSignalOnly->Add(dummyBackHist,-1.);
    ...
    // Integrate fit ( as a cross check):

    if(noResidualBackFit){
        fIntGaussExp      = fFitReco->Integral(FitRangeTmp[0],FitRangeTmp[1]) / fHistoMappingSignalInvMassPtBinSingle->GetBinWidth(10);
        fIntGaussExpError = fFitReco->IntegralError(FitRangeTmp[0],FitRangeTmp[1]) / fHistoMappingSignalInvMassPtBinSingle->GetBinWidth(10);
    } else{
        fIntGaussExp      = 0.;
        fIntGaussExpError = 0.;
    }
...
void FitTrueInvMassInPtBins(TH1D* fHistoMappingSignalInvMassPtBinSingle, Double_t* fMesonIntDeltaRangeFit, Int_t ptBin, Bool_t vary, Int_t InvMassType)
{
    ...
    if (fPrefix.CompareTo("Pi0") ==0 || fPrefix.CompareTo("Pi0EtaBinning")==0 ){
        ...
        if (fMode == 2 || fMode == 3 || fMode == 4 || fMode == 5 ||  fMode == 41 || fMode == 42 || fMode == 44 || fMode == 45 ||  fMode == 61 || fMode == 62 || fMode == 65){
            mesonAmplitudeMin = mesonAmplitude*98./100.;
            if(fMode == 64){
    ...
    if (fPrefix.CompareTo("Eta")==0){
        ...
        fFitRecoPre->SetParLimits(1,fMesonMassExpect*0.9,fMesonMassExpect*1.10);
    }

    fHistoMappingSignalInvMassPtBinSingle->Fit(fFitRecoPre,"QRME0");

    Bool_t prefitWorked = kFALSE;
    ...
    fFitReco->SetParLimits(0,mesonAmplitudeMin,mesonAmplitudeMax);
    fFitReco->SetParLimits(1,fMesonMassExpect-(widthPrefit/4.),fMesonMassExpect+(widthPrefit/4.));
    if(fPrefix.CompareTo("Eta")==0){
...
void SaveHistos(Int_t optionMC, TString fCutID, TString fPrefix3)
{
    ...
    // check if something is wrong with cluster binning
    Bool_t processClusters = kTRUE;
    Int_t clusterPtbins = -1;
    if(fHistoClustersPt) clusterPtbins = fHistoClustersPt->GetXaxis()->GetNbins();
    if(fNBinsClusterPt>clusterPtbins){
       processClusters = kFALSE;
       printf("WARNING: Number of bins requested for rebinning of fHistoClustersE is higher than available histogram!\n");
       printf("WARNING: Cluster histograms will not be written to file! PLEASE CHECK fBinsClusterPt!\n");
    }

    if (doDebugOutputLevel>=1){cout<<"DebugOutput, ExtractSignalPiPlPiMiNDM.C, SaveHistos(), Line: "<<__LINE__<<"; fNBinsClusterPt: "<<fNBinsClusterPt<<endl;}
    TH1D*   deltaPtCluster       = new TH1D("fDeltaPtCluster","",fNBinsClusterPt,fBinsClusterPt);
    if (doDebugOutputLevel>=1){cout<<"DebugOutput, ExtractSignalPiPlPiMiNDM.C, SaveHistos(), Line: "<<__LINE__<<"; deltaPtCluster: "<<endl;}
    for(Int_t iPt=1;iPt<fNBinsClusterPt+1;iPt++){
        ...
        if (doDebugOutputLevel>=1){
            if (iPt<fNBinsClusterPt){
                cout<<"("<<iPt<<": "<<fBinsClusterPt[iPt]-fBinsClusterPt[iPt-1]<<"), ";
            } else {
                cout<<"("<<iPt<<": "<<fBinsClusterPt[iPt]-fBinsClusterPt[iPt-1]<<")"<<endl;
            }
        }
    }
    // Write cluster energy and pT
    if (fHistoClustersPt && processClusters){
        ...
        fHistoClustersPtPerEvent   = (TH1D*)fHistoClustersPt->Rebin(fNBinsClusterPt,"fHistoClustersPtPerEvent",fBinsClusterPt);
...
//         graphClusterPtReb->Print();
    ...
    if (fHistoClustersE && processClusters){
        cout << "writing ClusterE" << endl;
        fHistoClustersE->Write("ClusterE");
        TH1D*   fHistoClustersEPerEvent = NULL;
        Int_t clusterEbins = fHistoClustersE->GetXaxis()->GetNbins();
        fHistoClustersEPerEvent   = (TH1D*)fHistoClustersE->Rebin(fNBinsClusterPt,"fHistoClustersEPerEvent",fBinsClusterPt);
    ...
    for (Int_t k = 0; k < 3; k++){
        ...
        if (fHistoSigndefaultMesonBackFit[k])                fHistoSigndefaultMesonBackFit[k]->Write();
        if (fHistoSigndefaultMesonBackFit_SubPiZero[k])      fHistoSigndefaultMesonBackFit_SubPiZero[k]->Write();
        if (fHistoSigndefaultMesonBackFit_FixedPzPiZero[k])  fHistoSigndefaultMesonBackFit_FixedPzPiZero[k]->Write();
        ...
        if (fHistoSBdefaultMesonBackFit[k])                  fHistoSBdefaultMesonBackFit[k]->Write();
        if (fHistoSBdefaultMesonBackFit_SubPiZero[k])        fHistoSBdefaultMesonBackFit_SubPiZero[k]->Write();
        if (fHistoSBdefaultMesonBackFit_FixedPzPiZero[k])    fHistoSBdefaultMesonBackFit_FixedPzPiZero[k]->Write();
    }

    if (fHistoYieldMesonBackFitFromFit)               fHistoYieldMesonBackFitFromFit->Write();
    if (fHistoYieldMesonBackFitFromFit_SubPiZero)     fHistoYieldMesonBackFitFromFit_SubPiZero->Write();
    if (fHistoYieldMesonBackFitFromFit_FixedPzPiZero) fHistoYieldMesonBackFitFromFit_FixedPzPiZero->Write();
    if (fHistoYieldMesonPerEventBackFitFromFit)              fHistoYieldMesonPerEventBackFitFromFit->Write();
    if (fHistoYieldMesonPerEventBackFitFromFit_SubPiZero)    fHistoYieldMesonPerEventBackFitFromFit_SubPiZero->Write();
    if (fHistoYieldMesonPerEventBackFitFromFit_FixedPzPiZero)fHistoYieldMesonPerEventBackFitFromFit_FixedPzPiZero->Write();
    ...
    fHistoFWHMToSigmaMeson->Write();
    fHistoFWHMToSigmaMeson_SubPiZero->Write();
    fHistoFWHMToSigmaMeson_FixedPzPiZero->Write();

    fHistoMassMesonBackFit->Write();
    fHistoMassMesonBackFit_SubPiZero->Write();
    fHistoMassMesonBackFit_FixedPzPiZero->Write();
    fHistoFWHMMesonBackFit->Write();
    fHistoFWHMMesonBackFit_SubPiZero->Write();
    fHistoFWHMMesonBackFit_FixedPzPiZero->Write();
    ...
    fHistoFWHMToSigmaMesonLeft->Write();
    fHistoFWHMToSigmaMesonLeft_SubPiZero->Write();
    fHistoFWHMToSigmaMesonLeft_FixedPzPiZero->Write();
    ...
    for(Int_t ii =fStartPtBin;ii<fNBinsPt;ii++){
        ...
        if(fHistoMappingSignalInvMassPtBin[ii]) {
            DrawGammaSetLines(fHistoMappingSignalInvMassPtBin[ii], 3, 1, 1);
        ...
        if(fHistoMappingSignalInvMassPtBin_SubPiZero[ii]){
            DrawGammaSetLines(fHistoMappingSignalInvMassPtBin_SubPiZero[ii], 3, 1, 1);
        ...
        if( fHistoMappingSignalInvMassPtBin_FixedPzPiZero[ii]){
            DrawGammaSetLines(fHistoMappingSignalInvMassPtBin_FixedPzPiZero[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassPtBin[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassPtBin[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassPtBin_SubPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassPtBin_SubPiZero[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassPtBin_FixedPzPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassPtBin_FixedPzPiZero[ii], 3, 1, 1);
        ...
        if(fHistoMappingGGInvMassBackFitPtBin[ii]){
            DrawGammaSetLines(fHistoMappingGGInvMassBackFitPtBin[ii], 3, 1, 1);
        ...
        if( fHistoMappingGGInvMassBackFitPtBin_SubPiZero[ii]){
            DrawGammaSetLines(fHistoMappingGGInvMassBackFitPtBin_SubPiZero[ii], 3, 1, 1);
        ...
        if(  fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[ii]){
            DrawGammaSetLines(fHistoMappingGGInvMassBackFitPtBin_FixedPzPiZero[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassBackFitPtBin[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassBackFitPtBin[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassBackFitPtBin_SubPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassBackFitPtBin_SubPiZero[ii], 3, 1, 1);
        ...
        if(fFitSignalInvMassBackFitPtBin_FixedPzPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fFitSignalInvMassBackFitPtBin_FixedPzPiZero[ii], 3, 1, 1);
        ...
        if(fBackgroundFitPol[ii]!=0x00){
            DrawGammaSetLinesTF1(fBackgroundFitPol[ii], 3, 1, 1);
        ...
        if(fBackgroundFitPol_SubPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fBackgroundFitPol_SubPiZero[ii], 3, 1, 1);
        ...
        if(fBackgroundFitPol_FixedPzPiZero[ii]!=0x00){
            DrawGammaSetLinesTF1(fBackgroundFitPol_FixedPzPiZero[ii], 3, 1, 1);
...
void SaveCorrectionHistos(TString fCutID, TString fPrefix3)
{
    ...
    if(fHistoMonteMesonEffiBackFitFromFitPt) fHistoMonteMesonEffiBackFitFromFitPt->Write();
    if(fHistoMonteMesonEffiBackFitFromFitPt_SubPiZero) fHistoMonteMesonEffiBackFitFromFitPt_SubPiZero->Write();
    if(fHistoMonteMesonEffiBackFitFromFitPt_FixedPzPiZero) fHistoMonteMesonEffiBackFitFromFitPt_FixedPzPiZero->Write();

    fHistoMassMeson->Write("histoMCRecMassMeson");
    fHistoMassMeson_SubPiZero->Write("histoMCRecMassMeson_SubPiZero");
    fHistoMassMeson_FixedPzPiZero->Write("histoMCRecMassMeson_FixedPzPiZero");
    fHistoMassMesonBackFit->Write("histoMCRecMassMesonBackFit");
    fHistoMassMesonBackFit_SubPiZero->Write("histoMCRecMassMesonBackFit_SubPiZero");
    fHistoMassMesonBackFit_FixedPzPiZero->Write("histoMCRecMassMesonBackFit_FixedPzPiZero");
    fHistoFWHMMeson->Write("histoMCRecFWHMMeson");
    fHistoFWHMMeson_SubPiZero->Write("histoMCRecFWHMMeson_SubPiZero");
    fHistoFWHMMeson_FixedPzPiZero->Write("histoMCRecFWHMMeson_FixedPzPiZero");
    fHistoFWHMMesonBackFit->Write("histoMCRecFWHMMesonBackFit");
    fHistoFWHMMesonBackFit_SubPiZero->Write("histoMCRecFWHMMesonBackFit_SubPiZero");
    fHistoFWHMMesonBackFit_FixedPzPiZero->Write("histoMCRecFWHMMesonBackFit_FixedPzPiZero");
    ...
    fHistoTrueLambdaMeson->Write();
    fHistoTrueLambdaMeson_SubPiZero->Write();
    fHistoTrueLambdaMeson_FixedPzPiZero->Write();
    fHistoTrueLambdaMesonReweighted->Write();
    fHistoTrueLambdaMesonReweighted_SubPiZero->Write();
    fHistoTrueLambdaMesonReweighted_FixedPzPiZero->Write();
    fHistoTrueWidthMeson->Write();
    fHistoTrueWidthMeson_SubPiZero->Write();
    fHistoTrueWidthMeson_FixedPzPiZero->Write();
    fHistoTrueWidthMesonReweighted->Write();
    fHistoTrueWidthMesonReweighted_SubPiZero->Write();
    fHistoTrueWidthMesonReweighted_FixedPzPiZero->Write();
    ...
    fHistoTrueFWHMToSigmaMeson->Write();
    fHistoTrueFWHMToSigmaMeson_SubPiZero->Write();
    fHistoTrueFWHMToSigmaMeson_FixedPzPiZero->Write();
    fHistoTrueFWHMToSigmaMesonReweighted->Write();
    fHistoTrueFWHMToSigmaMesonReweighted_SubPiZero->Write();
    fHistoTrueFWHMToSigmaMesonReweighted_FixedPzPiZero->Write();
...
void Initialize(TString setPi0, Int_t numberOfBins){
    ...
    fMesonWidthFitBinValues =                                       new Double_t[fNBinsPt];
    ...
    for (Int_t k = 0; k < 6; k++){
        ...
        fMesonCurIntRangeAllPt[k]                                   = new Double_t*[2];
        fMesonCurIntRangeAllPt_SubPiZero[k]                         = new Double_t*[2];
        fMesonCurIntRangeAllPt_FixedPzPiZero[k]                     = new Double_t*[2];
        for (Int_t j = 0; j < 2; j++){
            fMesonCurIntRangeAllPt[k][j]                            = new Double_t[fNBinsPt];
            fMesonCurIntRangeAllPt_SubPiZero[k][j]                  = new Double_t[fNBinsPt];
            fMesonCurIntRangeAllPt_FixedPzPiZero[k][j]              = new Double_t[fNBinsPt];
        }
    }
    ...
    for (Int_t k = 0; k < 6; k++){
        ...
        fBckYieldsBackFit[k] =                                  new Double_t[fNBinsPt];
        fBckYieldsBackFit_SubPiZero[k] =                        new Double_t[fNBinsPt];
        fBckYieldsBackFit_FixedPzPiZero[k] =                    new Double_t[fNBinsPt];
        ...
        fTotalBckYieldsBackFit[k] = 							new Double_t[fNBinsPt];
        fTotalBckYieldsBackFit_SubPiZero[k] =					new Double_t[fNBinsPt];
        fTotalBckYieldsBackFit_FixedPzPiZero[k] =				new Double_t[fNBinsPt];
        ...
        fBckYieldsBackFitError[k] = 							new Double_t[fNBinsPt];
        fBckYieldsBackFitError_SubPiZero[k] =  					new Double_t[fNBinsPt];
        fBckYieldsBackFitError_FixedPzPiZero[k] =				new Double_t[fNBinsPt];
        fTotalBckYieldsBackFitError[k] = 						new Double_t[fNBinsPt];
        fTotalBckYieldsBackFitError_SubPiZero[k] = 				new Double_t[fNBinsPt];
        fTotalBckYieldsBackFitError_FixedPzPiZero[k] =			new Double_t[fNBinsPt];
    ...
    for (Int_t k = 0; k < 3; k++ ){
        ...
        fMesonSBdefaultBackFit[k]                                    = new Double_t[fNBinsPt];
        fMesonSBdefaultBackFit_SubPiZero[k]                          = new Double_t[fNBinsPt];
        fMesonSBdefaultBackFit_FixedPzPiZero[k]                      = new Double_t[fNBinsPt];
        ...
        fMesonSigndefaultBackFit[k]                                  = new Double_t[fNBinsPt];
        fMesonSigndefaultBackFit_SubPiZero[k]                        = new Double_t[fNBinsPt];
        fMesonSigndefaultBackFit_FixedPzPiZero[k]                    = new Double_t[fNBinsPt];
        ...
        fMesonSBdefaultBackFitError[k]                               = new Double_t[fNBinsPt];
        fMesonSBdefaultBackFitError_SubPiZero[k]                     = new Double_t[fNBinsPt];
        fMesonSBdefaultBackFitError_FixedPzPiZero[k]                 = new Double_t[fNBinsPt];
        ...
        fMesonSigndefaultBackFitError[k]                             = new Double_t[fNBinsPt];
        fMesonSigndefaultBackFitError_SubPiZero[k]                   = new Double_t[fNBinsPt];
        fMesonSigndefaultBackFitError_FixedPzPiZero[k]               = new Double_t[fNBinsPt];
        ...
        fMesonCurIntRangeAllPtBackFit[k] = 							new Double_t*[2];
        fMesonCurIntRangeAllPtBackFit_SubPiZero[k] = 				new Double_t*[2];
        fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[k] = 			new Double_t*[2];

        for (Int_t j = 0; j < 2; j++){
            fMesonCurIntRangeAllPtBackFit[k][j] =                   new Double_t[fNBinsPt];
            fMesonCurIntRangeAllPtBackFit_SubPiZero[k][j] =         new Double_t[fNBinsPt];
            fMesonCurIntRangeAllPtBackFit_FixedPzPiZero[k][j] =     new Double_t[fNBinsPt];
        }
        ...
        if(k==0){
            fMesonYieldsBackFitFromFit =									new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFit_SubPiZero =           				new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFit_FixedPzPiZero =						new Double_t[fNBinsPt];

            fMesonYieldsBackFitFromFitPerEvent =									new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitPerEvent_SubPiZero =           				new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitPerEvent_FixedPzPiZero =						new Double_t[fNBinsPt];

            fMesonYieldsBackFitFromFitError =									new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitError_SubPiZero =           				new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitError_FixedPzPiZero =						new Double_t[fNBinsPt];

            fMesonYieldsBackFitFromFitPerEventError =									new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitPerEventError_SubPiZero =           				new Double_t[fNBinsPt];
            fMesonYieldsBackFitFromFitPerEventError_FixedPzPiZero =						new Double_t[fNBinsPt];
        }
    ...
    fMesonLambdaTailpar_SubPiZero=                          new Double_t[fNBinsPt];
    fMesonLambdaTailpar_FixedPzPiZero=                      new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFit= 							new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFit_SubPiZero=                   new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFit_FixedPzPiZero=				new Double_t[fNBinsPt];
    ...
    for (Int_t iRanges=0; iRanges<3; iRanges++){
        fMesonIntDeltaRangeByFit[iRanges]=                               new Double_t*[2];
        for (Int_t j=0; j<2; j++){fMesonIntDeltaRangeByFit[iRanges][j] = new Double_t[fNBinsPt];}
    }
    fMesonAmplitude=                            			new Double_t[fNBinsPt];
    fMesonAmplitude_SubPiZero=                          	new Double_t[fNBinsPt];
    fMesonAmplitude_FixedPzPiZero=                          new Double_t[fNBinsPt];
    fMesonAmplitudeBackFit=                                 new Double_t[fNBinsPt];
    fMesonAmplitudeBackFit_SubPiZero=           			new Double_t[fNBinsPt];
    fMesonAmplitudeBackFit_FixedPzPiZero=   				new Double_t[fNBinsPt];
    ...
    fMesonLambdaTailparLeft = 								new Double_t[fNBinsPt];
    fMesonLambdaTailparLeft_SubPiZero =                  	new Double_t[fNBinsPt];
    fMesonLambdaTailparLeft_FixedPzPiZero = 				new Double_t[fNBinsPt];
    ...
    fMesonAmplitudeLeft=                                    new Double_t[fNBinsPt];
    fMesonAmplitudeLeft_SubPiZero=                          new Double_t[fNBinsPt];
    fMesonAmplitudeLeft_FixedPzPiZero=                      new Double_t[fNBinsPt];
    ...
    fMesonTrueLambdaTailpar= 								new Double_t[fNBinsPt];
    fMesonTrueLambdaTailpar_SubPiZero= 						new Double_t[fNBinsPt];
    fMesonTrueLambdaTailpar_FixedPzPiZero=					new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFit= 						new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFit_SubPiZero= 				new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFit_FixedPzPiZero=			new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweighted =						new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweighted_SubPiZero =			new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweighted_FixedPzPiZero =		new Double_t[fNBinsPt];
    fMesonTrueWidth=                                        new Double_t[fNBinsPt];
    fMesonTrueWidth_SubPiZero=                              new Double_t[fNBinsPt];
    fMesonTrueWidth_FixedPzPiZero=                          new Double_t[fNBinsPt];
    fMesonTrueWidthBackFit=                                 new Double_t[fNBinsPt];
    fMesonTrueWidthBackFit_SubPiZero=                       new Double_t[fNBinsPt];
    fMesonTrueWidthBackFit_FixedPzPiZero=                   new Double_t[fNBinsPt];
    fMesonTrueWidthReweighted =								new Double_t[fNBinsPt];
    fMesonTrueWidthReweighted_SubPiZero =					new Double_t[fNBinsPt];
    fMesonTrueWidthReweighted_FixedPzPiZero =				new Double_t[fNBinsPt];
    ...
    fMesonTrueAmplitude=                                    new Double_t[fNBinsPt];
    fMesonTrueAmplitude_SubPiZero=                          new Double_t[fNBinsPt];
    fMesonTrueAmplitude_FixedPzPiZero=                      new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFit=                             new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFit_SubPiZero=                   new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFit_FixedPzPiZero=               new Double_t[fNBinsPt];
    fMesonTrueAmplitudeReweighted =							new Double_t[fNBinsPt];
    fMesonTrueAmplitudeReweighted_SubPiZero =				new Double_t[fNBinsPt];
    fMesonTrueAmplitudeReweighted_FixedPzPiZero =			new Double_t[fNBinsPt];
    for(Int_t k = 0; k<3; k++){
    ...
    fMesonLambdaTailparError_SubPiZero=						new Double_t[fNBinsPt];
    fMesonLambdaTailparError_FixedPzPiZero=        			new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFitError=						new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFitError_SubPiZero=				new Double_t[fNBinsPt];
    fMesonLambdaTailparBackFitError_FixedPzPiZero=			new Double_t[fNBinsPt];
    ...
    fMesonAmplitudeError = 									new Double_t[fNBinsPt];
    fMesonAmplitudeError_SubPiZero = 						new Double_t[fNBinsPt];
    fMesonAmplitudeError_FixedPzPiZero =					new Double_t[fNBinsPt];
    fMesonAmplitudeBackFitError =							new Double_t[fNBinsPt];
    fMesonAmplitudeBackFitError_SubPiZero =					new Double_t[fNBinsPt];
    fMesonAmplitudeBackFitError_FixedPzPiZero =				new Double_t[fNBinsPt];
    ...
    fMesonLambdaTailparLeftError = 					new Double_t[fNBinsPt];
    fMesonLambdaTailparLeftError_SubPiZero =			new Double_t[fNBinsPt];
    fMesonLambdaTailparLeftError_FixedPzPiZero =		new Double_t[fNBinsPt];
    ...
    fMesonAmplitudeLeftError=                       		new Double_t[fNBinsPt];
    fMesonAmplitudeLeftError_SubPiZero=              		new Double_t[fNBinsPt];
    fMesonAmplitudeLeftError_FixedPzPiZero=          		new Double_t[fNBinsPt];
    ...
    fMesonTrueLambdaTailparError =                          new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparError_SubPiZero =                new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparError_FixedPzPiZero =            new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFitError =                   new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFitError_SubPiZero =         new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparBackFitError_FixedPzPiZero =     new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweightedError =                new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweightedError_SubPiZero =      new Double_t[fNBinsPt];
    fMesonTrueLambdaTailparReweightedError_FixedPzPiZero =	new Double_t[fNBinsPt];
    fMesonTrueWidthError = 									new Double_t[fNBinsPt];
    fMesonTrueWidthError_SubPiZero = 						new Double_t[fNBinsPt];
    fMesonTrueWidthError_FixedPzPiZero = 					new Double_t[fNBinsPt];
    fMesonTrueWidthBackFitError =							new Double_t[fNBinsPt];
    fMesonTrueWidthBackFitError_SubPiZero = 				new Double_t[fNBinsPt];
    fMesonTrueWidthBackFitError_FixedPzPiZero = 			new Double_t[fNBinsPt];
    fMesonTrueWidthReweightedError = 						new Double_t[fNBinsPt];
    fMesonTrueWidthReweightedError_SubPiZero = 				new Double_t[fNBinsPt];
    fMesonTrueWidthReweightedError_FixedPzPiZero =			new Double_t[fNBinsPt];
    ...
    fMesonTrueAmplitudeError = 								new Double_t[fNBinsPt];
    fMesonTrueAmplitudeError_SubPiZero = 					new Double_t[fNBinsPt];
    fMesonTrueAmplitudeError_FixedPzPiZero = 				new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFitError =						new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFitError_SubPiZero = 			new Double_t[fNBinsPt];
    fMesonTrueAmplitudeBackFitError_FixedPzPiZero = 		new Double_t[fNBinsPt];
    ...
    fHistoMapping_bck_Combinatorical =                      new TH1D*[fNBinsPt];
    ...
    fHistoMappingSignalInvMassPtBinResSubtracted =				    new TH1D*[fNBinsPt];
    fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero =		    new TH1D*[fNBinsPt];
    fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero =	    new TH1D*[fNBinsPt];
    ...
    for(Int_t k = 0; k<5; k++){
        ...
        fHistoMappingBackNormInvMassPtBinBackFit[k] = 				new TH1D*[fNBinsPt];
        fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[k] =		new TH1D*[fNBinsPt];
        fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[k] =	new TH1D*[fNBinsPt];
        ...
        for(Int_t i = 0;i<fNBinsPt; i++){
            ...
            fHistoMappingBackNormInvMassPtBinBackFit[k][i] = 						NULL;
            fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[k][i] = 						NULL;
            fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[k][i] = 						NULL;
    //      fRatio[i] =                                                 NULL;
...
//  fRatio =                                                new TH1D*[fNBinsPt];
    ...
    fBackgroundFitGaussPol = 									new TF1*[fNBinsPt];
    fBackgroundFitGaussPol_SubPiZero = 							new TF1*[fNBinsPt];
    fBackgroundFitGaussPol_FixedPzPiZero =						new TF1*[fNBinsPt];
    ...
    fHistoBckFitWithGaussConfidence =                                new TH1D*[fNBinsPt];
    fHistoBckFitWithGaussConfidence_SubPiZero =                      new TH1D*[fNBinsPt];
    fHistoBckFitWithGaussConfidence_FixedPzPiZero =                  new TH1D*[fNBinsPt];
    ...
    for(Int_t i = 0;i<fNBinsPt; i++){
        ...
        fHistoMappingSignalInvMassPtBinResSubtracted[i] =                NULL;
        fHistoMappingSignalInvMassPtBinResSubtracted_SubPiZero[i] =      NULL;
        fHistoMappingSignalInvMassPtBinResSubtracted_FixedPzPiZero[i] =  NULL;
...
void CalculateFWHM(TF1 * fFunc, Double_t* InputMesonFitRange, Bool_t useGaussOnly){
// Default function
    TF1* fFunc_def;
...
void Delete(){
    ...
    if (fBGFitRange_ContamintationFit) delete fBGFitRange_ContamintationFit;
    if (fBGFitRange_SubPiZero_ContamintationFit) delete fBGFitRange_SubPiZero_ContamintationFit;
    if (fBGFitRange_FixedPzPiZero_ContamintationFit) delete fBGFitRange_FixedPzPiZero_ContamintationFit;
    if (fBGFitRangeLeft_ContamintationFit) delete fBGFitRangeLeft_ContamintationFit;
    if (fBGFitRangeLeft_SubPiZero_ContamintationFit) delete fBGFitRangeLeft_SubPiZero_ContamintationFit;
    if (fBGFitRangeLeft_FixedPzPiZero_ContamintationFit) delete fBGFitRangeLeft_FixedPzPiZero_ContamintationFit;
    ...
    for (Int_t k = 0; k< 6; k++){
        ...
        if (fBckYieldsBackFit[k])                        delete fBckYieldsBackFit[k];
        if (fBckYieldsBackFit_SubPiZero[k])              delete fBckYieldsBackFit_SubPiZero[k];
        if (fBckYieldsBackFit_FixedPzPiZero[k])          delete fBckYieldsBackFit_FixedPzPiZero[k];
        if (fBckYieldsBackFitError[k])                   delete fBckYieldsBackFitError[k];
        if (fBckYieldsBackFitError_SubPiZero[k])         delete fBckYieldsBackFitError_SubPiZero[k];
        if (fBckYieldsBackFitError_FixedPzPiZero[k])     delete fBckYieldsBackFitError_FixedPzPiZero[k];
    ...
    if (fMesonYieldsBackFitFromFit)                              delete fMesonYieldsBackFitFromFit;
    if (fMesonYieldsBackFitFromFit_SubPiZero)                    delete fMesonYieldsBackFitFromFit_SubPiZero;
    if (fMesonYieldsBackFitFromFit_FixedPzPiZero)                delete fMesonYieldsBackFitFromFit_FixedPzPiZero;
    if (DebugOutputLevel>=1){cout << "Debug Output; ExtractSignalPiPlPiMiNDM.C; Delete(); Line: " << __LINE__ << endl;}
    for (Int_t k = 0; k< 3; k++){
    ...
    for (Int_t iRanges=0; iRanges<3; iRanges++){
        for (Int_t j=0; j<2; j++){
            if (fMesonIntDeltaRangeByFit[iRanges][j])        delete fMesonIntDeltaRangeByFit[iRanges][j];
        }
    }
    ...
    if (fHistoMapping_bck_Combinatorical)                       delete fHistoMapping_bck_Combinatorical;
    ...
    for (Int_t k = 0; k< 5; k++){
        ...
        if (fHistoMappingBackNormInvMassPtBinBackFit[k]) delete fHistoMappingBackNormInvMassPtBinBackFit[k];
        if (fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[k]) delete fHistoMappingBackNormInvMassPtBinBackFit_SubPiZero[k];
        if (fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[k]) delete fHistoMappingBackNormInvMassPtBinBackFit_FixedPzPiZero[k];
...
Int_t SetMesonIntDeltaRange(Int_t ptBinNumber, Int_t FitFunctionNumber, Int_t ParameterNumber, Int_t iDebugLevel){
    ...
    Double_t        PeakRangeByFit_Normal[2];
    Double_t        PeakRangeByFit_Narrow[2];
    Double_t        PeakRangeByFit_Wide[2];
    ...
    PeakRangeByFit_Normal[0]                            =
            fMesonMassExpect-IntegrationValueByFit_Normal;
    PeakRangeByFit_Normal[1]                            =
            fMesonMassExpect+IntegrationValueByFit_Normal;
    PeakRangeByFit_Narrow[0]                            =
            fMesonMassExpect-IntegrationValueByFit_Narrow;
    PeakRangeByFit_Narrow[1]                            =
            fMesonMassExpect+IntegrationValueByFit_Narrow;
    PeakRangeByFit_Wide[0]                            =
    ...
    if (fPeakRange[1]<PeakRangeByFit_Normal[1]){
    ...
    fMesonWidthFitBinValues[ptBinNumber]                = fMesonWidthFitValue;
    fMesonIntDeltaRangeByFit[0][0][ptBinNumber]         = fMesonIntDeltaRange[0];
    fMesonIntDeltaRangeByFit[0][1][ptBinNumber]         = fMesonIntDeltaRange[1];
    fMesonIntDeltaRangeByFit[1][0][ptBinNumber]         = fMesonIntDeltaRangeWide[0];
    fMesonIntDeltaRangeByFit[1][1][ptBinNumber]         = fMesonIntDeltaRangeWide[1];
    fMesonIntDeltaRangeByFit[2][0][ptBinNumber]         = fMesonIntDeltaRangeNarrow[0];
    fMesonIntDeltaRangeByFit[2][1][ptBinNumber]         = fMesonIntDeltaRangeNarrow[1];

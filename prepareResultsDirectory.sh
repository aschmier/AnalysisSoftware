if [ $1 = "fbock" ]; then
    PHOTONCONVDIR=/home/fbock/ALICE/Software/PCGSoftware
    ...
    PHOTONCONVDIR=/home/joshua/PCG_Software/AnalysisSoftware
...
elif [ $1 = "aschmier" ]; then
    PHOTONCONVDIR=/home/austin/alice/AnalysisSoftware
fi

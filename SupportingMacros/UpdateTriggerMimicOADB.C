 ...
 void UpdateTriggerMimicOADB(const char *fileNameOADBAli="$ALICE_DATA/OADB/PWGGA/EMCalTriggerMimicOADB.root", Bool_t addOldMaps = kTRUE)
{
    ...
    if(addOldMaps){
        ...
        // updateFile(fileNameOADB,"16i-k_1",  "data/EDCTriggerThreshold_13TeV.root",   255539,   258882,   2.20,   0.20,   8.50,   0.00,   3.75,   0.30,   0.00,   0.00);
        // updateFile(fileNameOADB,"16l_1",    "",   258883,   260215,   2.20,   0.20,   5.50,   1.00,   3.80,   0.30,   0.00,   0.00);
        // updateFile(fileNameOADB,"16m-p_1",  "data/EDCTriggerThreshold_13TeV.root",   260216,   265014,   2.50,   0.10,   8.50,   0.70,   3.75,   0.30,   0.00,   0.00);
        ...
        // updateFile(fileNameOADB,"17c-o_1",  "data/EDCTriggerThreshold_13TeV.root",   270531,   282024,   2.50,   0.10,   8.50,   0.70,   3.75,   0.30,   0.00,   0.00);
        // updateFile(fileNameOADB,"17pq_1",   "",   282025,   282503,   2.50,   0.10,   8.80,   1.00,   3.90,   0.30,   0.00,   0.00);
        // updateFile(fileNameOADB,"17r_1",    "data/EDCTriggerThreshold_13TeV.root",   282504,   295231,   2.50,   0.10,   8.50,   0.70,   3.75,   0.30,   0.00,   0.00);
        // updateFile(fileNameOADB,"18bp_1",   "data/EDCTriggerThreshold_13TeV.root",   295232,   295273,   2.50,   0.10,   8.50,   0.70,   3.75,   0.30,   0.00,   0.00);
